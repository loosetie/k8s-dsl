...
https://www.rfc-editor.org/rfc/rfc9113.html#name-starting-http-2-with-prior- `*` 'kubernetes.io/ws' - WebSocket over
cleartext as described in https://www.rfc-editor.org/rfc/rfc6455 `*` 'kubernetes.io/wss' - WebSocket over TLS as
described in https://www.rfc-editor.org/rfc/rfc6455 `*` Other protocols should use implementation-defined prefixed names
...
derived from a Kubernetes service, this corresponds to the Service.ports[].name. Name must either be an empty string or
