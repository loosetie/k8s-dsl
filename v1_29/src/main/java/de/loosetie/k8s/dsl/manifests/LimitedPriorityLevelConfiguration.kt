...
@K8sDslMarker
interface LimitedPriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1: K8sManifest {
...
LendableCL(i) = round( NominalCL(i) `*` lendablePercent(i)/100.0 ) */
  ...
  val limitResponse: LimitResponse_flowcontrol_apiserver_k8s_io_v1?
...
nominal concurrency limit, at the expense of every other priority level. If not specified, this field defaults to a
value of 30. Setting this field to zero supports the construction of a "jail" for this priority level that is used to
hold some request(s) */
