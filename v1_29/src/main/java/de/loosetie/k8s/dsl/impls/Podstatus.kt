...
open class Podstatus_core_v1Impl(
  @JsonIgnore
...
: Podstatus_core_v1, HasParent {
  ...
  override var containerStatuses: List<Containerstatus_core_v1>? = null
  override var ephemeralContainerStatuses: List<Containerstatus_core_v1>? = null
  override var hostIP: String? = null
  override var hostIPs: List<HostIP_core_v1>? = null
  override var initContainerStatuses: List<Containerstatus_core_v1>? = null
  override var message: String? = null
  override var nominatedNodeName: String? = null
  override var phase: String? = null
  override var podIP: String? = null
  override var podIPs: List<PodIP_core_v1>? = null
  override var qosClass: String? = null
  override var reason: String? = null
  override var resize: String? = null
  override var resourceClaimStatuses: List<Any>? = null
