...
@K8sDslMarker
interface ReplicationController_core_v1: K8sTopLevel, HasMetadata {
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
  val spec: Replicationcontrollerspec_core_v1
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
  val status: Replicationcontrollerstatus_core_v1?
}