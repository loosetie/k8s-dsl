...
@K8sDslMarker
interface Apiservicespec_apiregistration_k8s_io_v1: K8sManifest {
...
GroupPriorityMinimum values such that the whole group gets a higher priority. The primary sort is based on
...
normal handler chain to be fulfilled. */
  val service: ServiceReference_apiregistration_k8s_io_v1?
