...
@K8sDslMarker
interface Validatingadmissionpolicybindingspec_admissionregistration_k8s_io_v1beta1: K8sManifest {
...
that this is differs from ValidatingAdmissionPolicy matchConstraints, where resourceRules are required. */
  val matchResources: MatchResources_admissionregistration_k8s_io_v1beta1?
...
are evaluated without a param. */
  val paramRef: ParamRef_admissionregistration_k8s_io_v1beta1?
