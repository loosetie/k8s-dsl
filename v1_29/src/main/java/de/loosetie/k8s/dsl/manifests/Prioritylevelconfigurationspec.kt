...
@K8sDslMarker
interface Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1: K8sManifest {
...
values for `ExemptPriorityLevelConfiguration` apply. */
  val exempt: ExemptPriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1?
  /** `limited` specifies how requests are handled for a Limited priority level. This field must be non-empty if and only if
`type` is `"Limited"`. */
  val limited: LimitedPriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1?
