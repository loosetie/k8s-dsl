...
@K8sDslMarker
interface CSIVolumeSource_core_v1: K8sManifest {
...
registered in the cluster. */
  ...
  /** fsType to mount. Ex. "ext4", "xfs", "ntfs". If not provided, the empty value is passed to the associated CSI driver
...
is required. If the secret object contains more than one secret, all secret references are passed. */
  val nodePublishSecretRef: LocalObjectReference_core_v1?
