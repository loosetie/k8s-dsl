...
the Condition will be set to 'ResizeStarted'. */
  ...
  /** currentVolumeAttributesClassName is the current name of the VolumeAttributesClass the PVC is using. When unset, there is
no VolumeAttributeClass applied to this PersistentVolumeClaim This is an alpha field and requires enabling
VolumeAttributesClass feature. */
  @K8sDslMarker var currentVolumeAttributesClassName: String?
...
ModifyVolume operation being attempted. This is an alpha field and requires enabling VolumeAttributesClass feature. */
  val modifyVolumeStatus: ModifyVolumeStatus_core_v1?
