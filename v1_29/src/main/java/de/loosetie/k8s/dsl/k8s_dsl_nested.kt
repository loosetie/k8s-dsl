...
@K8sDslMarker
fun APIService.spec(init: Apiservicespec_apiregistration_k8s_io_v1.() -> Unit) {
  this as APIService_apiregistration_k8s_io_v1Impl
...
@K8sDslMarker
fun APIService.status(init: Apiservicestatus_apiregistration_k8s_io_v1.() -> Unit) {
  this as APIService_apiregistration_k8s_io_v1Impl
...
/** This field will get set by the resource driver after it has allocated the resource to inform the scheduler where it can
schedule Pods using the ResourceClaim. Setting this field is optional. If null, the resource is available everywhere. */
@K8sDslMarker
fun AllocationResult.availableOnNodes(init: NodeSelector.() -> Unit) {
  this as AllocationResult_resource_k8s_io_v1alpha2Impl
  NodeSelector_core_v1Impl(this)
    .also { availableOnNodes = it }
    .apply(init)
}

/** ResourceHandles contain the state associated with an allocation that should be maintained throughout the lifetime of a
claim. Each ResourceHandle contains data that should be passed to a specific kubelet plugin once it lands on a node.
This data is returned by the driver after a successful allocation and is opaque to Kubernetes. Driver documentation may
explain to users how to interpret this data if needed. Setting this field is optional. It has a maximum size of 32
entries. If null (or empty), it is assumed this allocation will be processed by a single kubelet plugin with no
...
@K8sDslMarker
fun AllocationResult.resourceHandles(init: ResourceHandle.() -> Unit) {
  this as AllocationResult_resource_k8s_io_v1alpha2Impl
  ResourceHandle_resource_k8s_io_v1alpha2Impl(this)
    .also { resourceHandles = resourceHandles?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
@K8sDslMarker
fun CSIDriver.spec(init: Csidriverspec_storage_k8s_io_v1.() -> Unit) {
  this as CSIDriver_storage_k8s_io_v1Impl
...
@K8sDslMarker
fun CSINode.spec(init: Csinodespec_storage_k8s_io_v1.() -> Unit) {
  this as CSINode_storage_k8s_io_v1Impl
...
to complete the CSI ControllerExpandVolume call. This field is optional, and may be empty if no secret is required. If
...
/** nodeExpandSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to
complete the CSI NodeExpandVolume call. This field is optional, may be omitted if no secret is required. If the secret
object contains more than one secret, all secrets are passed. */
@K8sDslMarker
fun CSIPersistentVolumeSource.nodeExpandSecretRef(init: SecretReference.() -> Unit) {
  this as CSIPersistentVolumeSource_core_v1Impl
  SecretReference_core_v1Impl(this)
    .also { nodeExpandSecretRef = it }
    .apply(init)
}
...
@K8sDslMarker
fun CertificateSigningRequest.spec(init: Certificatesigningrequestspec_certificates_k8s_io_v1.() -> Unit) {
  this as CertificateSigningRequest_certificates_k8s_io_v1Impl
...
@K8sDslMarker
fun CertificateSigningRequest.status(init: Certificatesigningrequeststatus_certificates_k8s_io_v1.() -> Unit) {
  this as CertificateSigningRequest_certificates_k8s_io_v1Impl
...
@K8sDslMarker
fun ClusterTrustBundleProjection.labelSelector(init: LabelSelector.() -> Unit) {
  this as ClusterTrustBundleProjection_core_v1Impl
  LabelSelector_meta_v1Impl(this)
...
@K8sDslMarker
fun ClusterTrustBundle.metadata(init: ObjectMeta.() -> Unit) {
  this as ClusterTrustBundle_certificates_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun ClusterTrustBundle.spec(init: Clustertrustbundlespec_certificates_k8s_io_v1alpha1.() -> Unit) {
  this as ClusterTrustBundle_certificates_k8s_io_v1alpha1Impl
  Clustertrustbundlespec_certificates_k8s_io_v1alpha1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
@K8sDslMarker
fun Container.resizePolicy(init: ContainerResizePolicy.() -> Unit) {
  this as Container_core_v1Impl
  ContainerResizePolicy_core_v1Impl(this)
    .also { resizePolicy = resizePolicy?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
@K8sDslMarker
fun CronJob.spec(init: Cronjobspec_batch_v1.() -> Unit) {
  this as CronJob_batch_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun CronJob.status(init: Cronjobstatus_batch_v1.() -> Unit) {
  this as CronJob_batch_v1Impl
...
@K8sDslMarker
fun CustomResourceDefinition.spec(init: Customresourcedefinitionspec_apiextensions_k8s_io_v1.() -> Unit) {
  this as CustomResourceDefinition_apiextensions_k8s_io_v1Impl
...
@K8sDslMarker
fun CustomResourceDefinition.status(init: Customresourcedefinitionstatus_apiextensions_k8s_io_v1.() -> Unit) {
  this as CustomResourceDefinition_apiextensions_k8s_io_v1Impl
...
@K8sDslMarker
fun DaemonSetUpdateStrategy.rollingUpdate(init: Rollingupdatedaemonset_apps_v1.() -> Unit) {
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun DaemonSet.spec(init: Daemonsetspec_apps_v1.() -> Unit) {
  this as DaemonSet_apps_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun DaemonSet.status(init: Daemonsetstatus_apps_v1.() -> Unit) {
  this as DaemonSet_apps_v1Impl
...
@K8sDslMarker
fun Deployment.spec(init: Deploymentspec_apps_v1.() -> Unit) {
  this as Deployment_apps_v1Impl
...
@K8sDslMarker
fun Deployment.status(init: Deploymentstatus_apps_v1.() -> Unit) {
  this as Deployment_apps_v1Impl
...
/** Resources resize policy for the container. */
@K8sDslMarker
fun EphemeralContainer.resizePolicy(init: ContainerResizePolicy.() -> Unit) {
  this as EphemeralContainer_core_v1Impl
  ContainerResizePolicy_core_v1Impl(this)
    .also { resizePolicy = resizePolicy?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
...
fun FlowSchemaCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as FlowSchemaCondition_flowcontrol_apiserver_k8s_io_v1Impl
  Time_meta_v1Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun FlowSchema.metadata(init: ObjectMeta.() -> Unit) {
  this as FlowSchema_flowcontrol_apiserver_k8s_io_v1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun FlowSchema.spec(init: Flowschemaspec_flowcontrol_apiserver_k8s_io_v1.() -> Unit) {
  this as FlowSchema_flowcontrol_apiserver_k8s_io_v1Impl
  Flowschemaspec_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun FlowSchema.status(init: Flowschemastatus_flowcontrol_apiserver_k8s_io_v1.() -> Unit) {
  this as FlowSchema_flowcontrol_apiserver_k8s_io_v1Impl
  Flowschemastatus_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { status = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status. */
@K8sDslMarker
fun HorizontalPodAutoscaler.spec(init: Horizontalpodautoscalerspec_autoscaling_v2.() -> Unit) {
  this as HorizontalPodAutoscaler_autoscaling_v2Impl
...
@K8sDslMarker
fun HorizontalPodAutoscaler.status(init: Horizontalpodautoscalerstatus_autoscaling_v2.() -> Unit) {
  this as HorizontalPodAutoscaler_autoscaling_v2Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
@K8sDslMarker
fun IPAddress.metadata(init: ObjectMeta.() -> Unit) {
  this as IPAddress_networking_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun IPAddress.spec(init: Ipaddressspec_networking_k8s_io_v1alpha1.() -> Unit) {
  this as IPAddress_networking_k8s_io_v1alpha1Impl
  Ipaddressspec_networking_k8s_io_v1alpha1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun IngressClass.spec(init: Ingressclassspec_networking_k8s_io_v1.() -> Unit) {
  this as IngressClass_networking_k8s_io_v1Impl
...
@K8sDslMarker
fun IngressLoadBalancerIngress.ports(init: IngressPortStatus.() -> Unit) {
  this as IngressLoadBalancerIngress_networking_k8s_io_v1Impl
  IngressPortStatus_networking_k8s_io_v1Impl(this)
    .also { ports = ports?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
@K8sDslMarker
fun IngressLoadBalancerStatus.ingress(init: IngressLoadBalancerIngress.() -> Unit) {
  this as IngressLoadBalancerStatus_networking_k8s_io_v1Impl
  IngressLoadBalancerIngress_networking_k8s_io_v1Impl(this)
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Ingress.spec(init: Ingressspec_networking_k8s_io_v1.() -> Unit) {
  this as Ingress_networking_k8s_io_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Ingress.status(init: Ingressstatus_networking_k8s_io_v1.() -> Unit) {
  this as Ingress_networking_k8s_io_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun JobTemplateSpec.spec(init: Jobspec_batch_v1.() -> Unit) {
  this as JobTemplateSpec_batch_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Job.spec(init: Jobspec_batch_v1.() -> Unit) {
  this as Job_batch_v1Impl
  Jobspec_batch_v1Impl(this)
    .also { spec = it }
    .apply(init)
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Job.status(init: Jobstatus_batch_v1.() -> Unit) {
  this as Job_batch_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Lease.spec(init: Leasespec_coordination_k8s_io_v1.() -> Unit) {
  this as Lease_coordination_k8s_io_v1Impl
...
@K8sDslMarker
fun LifecycleHandler.sleep(init: SleepAction.() -> Unit) {
  this as LifecycleHandler_core_v1Impl
  SleepAction_core_v1Impl(this)
    .also { sleep = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun LimitRange.spec(init: Limitrangespec_core_v1.() -> Unit) {
  this as LimitRange_core_v1Impl
...
fun LimitResponse.queuing(init: QueuingConfiguration.() -> Unit) {
  this as LimitResponse_flowcontrol_apiserver_k8s_io_v1Impl
  QueuingConfiguration_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { queuing = it }
    .apply(init)
}
...
fun LimitedPriorityLevelConfiguration.limitResponse(init: LimitResponse.() -> Unit) {
  this as LimitedPriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1Impl
  LimitResponse_flowcontrol_apiserver_k8s_io_v1Impl(this)
...
@K8sDslMarker
fun LocalSubjectAccessReview.spec(init: Subjectaccessreviewspec_authorization_k8s_io_v1.() -> Unit) {
  this as LocalSubjectAccessReview_authorization_k8s_io_v1Impl
...
@K8sDslMarker
fun LocalSubjectAccessReview.status(init: Subjectaccessreviewstatus_authorization_k8s_io_v1.() -> Unit) {
  this as LocalSubjectAccessReview_authorization_k8s_io_v1Impl
...
/** ExcludeResourceRules describes what operations on what resources/subresources the ValidatingAdmissionPolicy should not
care about. The exclude rules take precedence over include rules (if a resource matches both, it is excluded) */
@K8sDslMarker
fun MatchResources.excludeResourceRules(init: NamedRuleWithOperations.() -> Unit) {
  this as MatchResources_admissionregistration_k8s_io_v1beta1Impl
  NamedRuleWithOperations_admissionregistration_k8s_io_v1beta1Impl(this)
    .also { excludeResourceRules = excludeResourceRules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}

/** NamespaceSelector decides whether to run the admission control policy on an object based on whether the namespace for
that object matches the selector. If the object itself is a namespace, the matching is performed on
object.metadata.labels. If the object is another cluster scoped resource, it never skips the policy. For example, to run
the webhook on any objects whose namespace is not associated with "runlevel" of "0" or "1"; you will set the selector as
follows: "namespaceSelector": { "matchExpressions": [ { "key": "runlevel", "operator": "NotIn", "values": [ "0", "1" ] }
] } If instead you want to only run the policy on any objects whose namespace is associated with the "environment" of
"prod" or "staging"; you will set the selector as follows: "namespaceSelector": { "matchExpressions": [ { "key":
"environment", "operator": "In", "values": [ "prod", "staging" ] } ] } See
https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more examples of label selectors. Default
to the empty LabelSelector, which matches everything. */
@K8sDslMarker
fun MatchResources.namespaceSelector(init: LabelSelector.() -> Unit) {
  this as MatchResources_admissionregistration_k8s_io_v1beta1Impl
  LabelSelector_meta_v1Impl(this)
...
/** ObjectSelector decides whether to run the validation based on if the object has matching labels. objectSelector is
evaluated against both the oldObject and newObject that would be sent to the cel validation, and is considered to match
if either object matches the selector. A null object (oldObject in the case of create, or newObject in the case of
delete) or an object that cannot have labels (like a DeploymentRollback or a PodProxyOptions object) is not considered
to match. Use the object selector only if the webhook is opt-in, because end users may skip the admission webhook by
setting the labels. Default to the empty LabelSelector, which matches everything. */
@K8sDslMarker
fun MatchResources.objectSelector(init: LabelSelector.() -> Unit) {
  this as MatchResources_admissionregistration_k8s_io_v1beta1Impl
  LabelSelector_meta_v1Impl(this)
...
/** ResourceRules describes what operations on what resources/subresources the ValidatingAdmissionPolicy matches. The policy
cares about an operation if it matches _any_ Rule. */
@K8sDslMarker
fun MatchResources.resourceRules(init: NamedRuleWithOperations.() -> Unit) {
  this as MatchResources_admissionregistration_k8s_io_v1beta1Impl
  NamedRuleWithOperations_admissionregistration_k8s_io_v1beta1Impl(this)
...
/** MatchConditions is a list of conditions that must be met for a request to be sent to this webhook. Match conditions
filter requests that have already been matched by the rules, namespaceSelector, and objectSelector. An empty list of
matchConditions matches all requests. There are a maximum of 64 match conditions allowed. The exact matching logic is
(in order): 1. If ANY matchCondition evaluates to FALSE, the webhook is skipped. 2. If ALL matchConditions evaluate to
TRUE, the webhook is called. 3. If any matchCondition evaluates to an error (but none are FALSE): - If
failurePolicy=Fail, reject the request - If failurePolicy=Ignore, the error is ignored and the webhook is skipped This
is a beta feature and managed by the AdmissionWebhookMatchConditions feature gate. */
@K8sDslMarker
fun MutatingWebhook.matchConditions(init: MatchCondition.() -> Unit) {
  this as MutatingWebhook_admissionregistration_k8s_io_v1Impl
  MatchCondition_admissionregistration_k8s_io_v1Impl(this)
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Namespace.spec(init: Namespacespec_core_v1.() -> Unit) {
  this as Namespace_core_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Namespace.status(init: Namespacestatus_core_v1.() -> Unit) {
  this as Namespace_core_v1Impl
...
/** ports is a list of destination ports for outgoing traffic. Each item in this list is combined using a logical OR. If
this field is empty or missing, this rule matches all ports (traffic not restricted by port). If this field is present
and contains at least one item, then this rule allows traffic only if the traffic matches at least one port in the list. */
@K8sDslMarker
...
/** to is a list of destinations for outgoing traffic of pods selected for this rule. Items in this list are combined using
a logical OR operation. If this field is empty or missing, this rule matches all destinations (traffic not restricted by
...
/** from is a list of sources which should be able to access the pods selected for this rule. Items in this list are
combined using a logical OR operation. If this field is empty or missing, this rule matches all sources (traffic not
restricted by source). If this field is present and contains at least one item, this rule allows traffic only if the
...
/** ports is a list of ports which should be made accessible on the pods selected for this rule. Each item in this list is
combined using a logical OR. If this field is empty or missing, this rule matches all ports (traffic not restricted by
port). If this field is present and contains at least one item, then this rule allows traffic only if the traffic
...
@K8sDslMarker
fun NetworkPolicy.spec(init: Networkpolicyspec_networking_k8s_io_v1.() -> Unit) {
  this as NetworkPolicy_networking_k8s_io_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Node.spec(init: Nodespec_core_v1.() -> Unit) {
  this as Node_core_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Node.status(init: Nodestatus_core_v1.() -> Unit) {
  this as Node_core_v1Impl
...
@K8sDslMarker
fun ParamRef.selector(init: LabelSelector.() -> Unit) {
  this as ParamRef_admissionregistration_k8s_io_v1beta1Impl
  LabelSelector_meta_v1Impl(this)
    .also { selector = it }
    .apply(init)
}
...
@K8sDslMarker
fun PersistentVolumeClaimTemplate.spec(init: Persistentvolumeclaimspec_core_v1.() -> Unit) {
  this as PersistentVolumeClaimTemplate_core_v1Impl
...
@K8sDslMarker
fun PersistentVolumeClaim.spec(init: Persistentvolumeclaimspec_core_v1.() -> Unit) {
  this as PersistentVolumeClaim_core_v1Impl
  Persistentvolumeclaimspec_core_v1Impl(this)
    .also { spec = it }
    .apply(init)
...
https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims */
@K8sDslMarker
fun PersistentVolumeClaim.status(init: Persistentvolumeclaimstatus_core_v1.() -> Unit) {
  this as PersistentVolumeClaim_core_v1Impl
...
@K8sDslMarker
fun PersistentVolume.spec(init: Persistentvolumespec_core_v1.() -> Unit) {
  this as PersistentVolume_core_v1Impl
...
@K8sDslMarker
fun PersistentVolume.status(init: Persistentvolumestatus_core_v1.() -> Unit) {
  this as PersistentVolume_core_v1Impl
...
@K8sDslMarker
fun PodDisruptionBudget.spec(init: Poddisruptionbudgetspec_policy_v1.() -> Unit) {
  this as PodDisruptionBudget_policy_v1Impl
...
@K8sDslMarker
fun PodDisruptionBudget.status(init: Poddisruptionbudgetstatus_policy_v1.() -> Unit) {
  this as PodDisruptionBudget_policy_v1Impl
...
@K8sDslMarker
fun PodFailurePolicyRule.onExitCodes(init: PodFailurePolicyOnExitCodesRequirement.() -> Unit) {
  this as PodFailurePolicyRule_batch_v1Impl
  PodFailurePolicyOnExitCodesRequirement_batch_v1Impl(this)
    .also { onExitCodes = it }
    .apply(init)
}
...
@K8sDslMarker
fun PodFailurePolicyRule.onPodConditions(init: PodFailurePolicyOnPodConditionsPattern.() -> Unit) {
  this as PodFailurePolicyRule_batch_v1Impl
  PodFailurePolicyOnPodConditionsPattern_batch_v1Impl(this)
    .also { onPodConditions = onPodConditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
@K8sDslMarker
fun PodFailurePolicy.rules(init: PodFailurePolicyRule.() -> Unit) {
  this as PodFailurePolicy_batch_v1Impl
  PodFailurePolicyRule_batch_v1Impl(this)
    .also { rules = rules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
@K8sDslMarker
fun PodResourceClaim.source(init: ClaimSource.() -> Unit) {
  this as PodResourceClaim_core_v1Impl
  ClaimSource_core_v1Impl(this)
    .also { source = it }
    .apply(init)
}
...
@K8sDslMarker
fun PodSchedulingContext.metadata(init: ObjectMeta.() -> Unit) {
  this as PodSchedulingContext_resource_k8s_io_v1alpha2Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun PodSchedulingContext.spec(init: Podschedulingcontextspec_resource_k8s_io_v1alpha2.() -> Unit) {
  this as PodSchedulingContext_resource_k8s_io_v1alpha2Impl
  Podschedulingcontextspec_resource_k8s_io_v1alpha2Impl(this)
    .also { spec = it }
    .apply(init)
}
...
@K8sDslMarker
fun PodSchedulingContext.status(init: Podschedulingcontextstatus_resource_k8s_io_v1alpha2.() -> Unit) {
  this as PodSchedulingContext_resource_k8s_io_v1alpha2Impl
  Podschedulingcontextstatus_resource_k8s_io_v1alpha2Impl(this)
    .also { status = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun PodTemplate.template(init: Podtemplatespec_core_v1.() -> Unit) {
  this as PodTemplate_core_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Pod.spec(init: Podspec_core_v1.() -> Unit) {
  this as Pod_core_v1Impl
...
@K8sDslMarker
fun Pod.status(init: Podstatus_core_v1.() -> Unit) {
  this as Pod_core_v1Impl
...
fun PolicyRulesWithSubjects.nonResourceRules(init: NonResourcePolicyRule.() -> Unit) {
  this as PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1Impl
  NonResourcePolicyRule_flowcontrol_apiserver_k8s_io_v1Impl(this)
...
fun PolicyRulesWithSubjects.resourceRules(init: ResourcePolicyRule.() -> Unit) {
  this as PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1Impl
  ResourcePolicyRule_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { resourceRules = resourceRules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun PolicyRulesWithSubjects.subjects(init: Subject.() -> Unit) {
  this as PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1Impl
  Subject_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { subjects = subjects?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun PriorityLevelConfigurationCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as PriorityLevelConfigurationCondition_flowcontrol_apiserver_k8s_io_v1Impl
  Time_meta_v1Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun PriorityLevelConfiguration.metadata(init: ObjectMeta.() -> Unit) {
  this as PriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun PriorityLevelConfiguration.spec(init: Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1.() -> Unit) {
  this as PriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1Impl
  Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun PriorityLevelConfiguration.status(init: Prioritylevelconfigurationstatus_flowcontrol_apiserver_k8s_io_v1.() -> Unit) {
  this as PriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1Impl
  Prioritylevelconfigurationstatus_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { status = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun ReplicaSet.spec(init: Replicasetspec_apps_v1.() -> Unit) {
  this as ReplicaSet_apps_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun ReplicaSet.status(init: Replicasetstatus_apps_v1.() -> Unit) {
  this as ReplicaSet_apps_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun ReplicationController.spec(init: Replicationcontrollerspec_core_v1.() -> Unit) {
  this as ReplicationController_core_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun ReplicationController.status(init: Replicationcontrollerstatus_core_v1.() -> Unit) {
  this as ReplicationController_core_v1Impl
...
/** Standard object metadata */
@K8sDslMarker
fun ResourceClaimTemplate.metadata(init: ObjectMeta.() -> Unit) {
  this as ResourceClaimTemplate_resource_k8s_io_v1alpha2Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}

/** Describes the ResourceClaim that is to be generated. This field is immutable. A ResourceClaim will get created by the
control plane for a Pod when needed and then not get updated anymore. */
@K8sDslMarker
fun ResourceClaimTemplate.spec(init: Resourceclaimtemplatespec_resource_k8s_io_v1alpha2.() -> Unit) {
  this as ResourceClaimTemplate_resource_k8s_io_v1alpha2Impl
  Resourceclaimtemplatespec_resource_k8s_io_v1alpha2Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun ResourceClass.metadata(init: ObjectMeta.() -> Unit) {
  this as ResourceClass_resource_k8s_io_v1alpha2Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun ResourceClass.parametersRef(init: ResourceClassParametersReference.() -> Unit) {
  this as ResourceClass_resource_k8s_io_v1alpha2Impl
  ResourceClassParametersReference_resource_k8s_io_v1alpha2Impl(this)
...
candidates. */
@K8sDslMarker
fun ResourceClass.suitableNodes(init: NodeSelector.() -> Unit) {
  this as ResourceClass_resource_k8s_io_v1alpha2Impl
  NodeSelector_core_v1Impl(this)
    .also { suitableNodes = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun ResourceQuota.spec(init: Resourcequotaspec_core_v1.() -> Unit) {
  this as ResourceQuota_core_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun ResourceQuota.status(init: Resourcequotastatus_core_v1.() -> Unit) {
  this as ResourceQuota_core_v1Impl
...
@K8sDslMarker
fun SelfSubjectAccessReview.spec(init: Selfsubjectaccessreviewspec_authorization_k8s_io_v1.() -> Unit) {
  this as SelfSubjectAccessReview_authorization_k8s_io_v1Impl
...
/** Status is filled in by the server and indicates whether the request is allowed or not */
@K8sDslMarker
fun SelfSubjectAccessReview.status(init: Subjectaccessreviewstatus_authorization_k8s_io_v1.() -> Unit) {
  this as SelfSubjectAccessReview_authorization_k8s_io_v1Impl
  Subjectaccessreviewstatus_authorization_k8s_io_v1Impl(this)
    .also { status = it }
    .apply(init)
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
@K8sDslMarker
fun SelfSubjectReview.metadata(init: ObjectMeta.() -> Unit) {
  this as SelfSubjectReview_authentication_k8s_io_v1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun SelfSubjectReview.status(init: Selfsubjectreviewstatus_authentication_k8s_io_v1.() -> Unit) {
  this as SelfSubjectReview_authentication_k8s_io_v1Impl
  Selfsubjectreviewstatus_authentication_k8s_io_v1Impl(this)
    .also { status = it }
    .apply(init)
}
...
@K8sDslMarker
fun SelfSubjectRulesReview.spec(init: Selfsubjectrulesreviewspec_authorization_k8s_io_v1.() -> Unit) {
  this as SelfSubjectRulesReview_authorization_k8s_io_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
@K8sDslMarker
fun ServiceCIDR.metadata(init: ObjectMeta.() -> Unit) {
  this as ServiceCIDR_networking_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun ServiceCIDR.spec(init: Servicecidrspec_networking_k8s_io_v1alpha1.() -> Unit) {
  this as ServiceCIDR_networking_k8s_io_v1alpha1Impl
  Servicecidrspec_networking_k8s_io_v1alpha1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun ServiceCIDR.status(init: Servicecidrstatus_networking_k8s_io_v1alpha1.() -> Unit) {
  this as ServiceCIDR_networking_k8s_io_v1alpha1Impl
  Servicecidrstatus_networking_k8s_io_v1alpha1Impl(this)
    .also { status = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Service.spec(init: Servicespec_core_v1.() -> Unit) {
  this as Service_core_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun Service.status(init: Servicestatus_core_v1.() -> Unit) {
  this as Service_core_v1Impl
...
@K8sDslMarker
fun StatefulSet.spec(init: Statefulsetspec_apps_v1.() -> Unit) {
  this as StatefulSet_apps_v1Impl
...
@K8sDslMarker
fun StatefulSet.status(init: Statefulsetstatus_apps_v1.() -> Unit) {
  this as StatefulSet_apps_v1Impl
...
@K8sDslMarker
fun StorageVersion.spec(init: Storageversionspec_internal_apiserver_k8s_io_v1alpha1.() -> Unit) {
  this as StorageVersion_internal_apiserver_k8s_io_v1alpha1Impl
...
in the backend. */
@K8sDslMarker
fun StorageVersion.status(init: Storageversionstatus_internal_apiserver_k8s_io_v1alpha1.() -> Unit) {
  this as StorageVersion_internal_apiserver_k8s_io_v1alpha1Impl
...
/** Spec holds information about the request being evaluated */
@K8sDslMarker
fun SubjectAccessReview.spec(init: Subjectaccessreviewspec_authorization_k8s_io_v1.() -> Unit) {
  this as SubjectAccessReview_authorization_k8s_io_v1Impl
  Subjectaccessreviewspec_authorization_k8s_io_v1Impl(this)
    .also { spec = it }
    .apply(init)
...
/** Status is filled in by the server and indicates whether the request is allowed or not */
@K8sDslMarker
fun SubjectAccessReview.status(init: Subjectaccessreviewstatus_authorization_k8s_io_v1.() -> Unit) {
  this as SubjectAccessReview_authorization_k8s_io_v1Impl
  Subjectaccessreviewstatus_authorization_k8s_io_v1Impl(this)
    .also { status = it }
    .apply(init)
...
fun Subject.group(init: GroupSubject.() -> Unit) {
  this as Subject_flowcontrol_apiserver_k8s_io_v1Impl
  GroupSubject_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { group = it }
    .apply(init)
}
...
fun Subject.serviceAccount(init: ServiceAccountSubject.() -> Unit) {
  this as Subject_flowcontrol_apiserver_k8s_io_v1Impl
  ServiceAccountSubject_flowcontrol_apiserver_k8s_io_v1Impl(this)
...
fun Subject.user(init: UserSubject.() -> Unit) {
  this as Subject_flowcontrol_apiserver_k8s_io_v1Impl
  UserSubject_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { user = it }
    .apply(init)
}
...
/** Spec holds information about the request being evaluated */
@K8sDslMarker
fun TokenRequest.spec(init: Tokenrequestspec_authentication_k8s_io_v1.() -> Unit) {
  this as TokenRequest_authentication_k8s_io_v1Impl
...
@K8sDslMarker
fun TokenRequest.status(init: Tokenrequeststatus_authentication_k8s_io_v1.() -> Unit) {
  this as TokenRequest_authentication_k8s_io_v1Impl
...
/** Spec holds information about the request being evaluated */
@K8sDslMarker
fun TokenReview.spec(init: Tokenreviewspec_authentication_k8s_io_v1.() -> Unit) {
  this as TokenReview_authentication_k8s_io_v1Impl
...
@K8sDslMarker
fun TokenReview.status(init: Tokenreviewstatus_authentication_k8s_io_v1.() -> Unit) {
  this as TokenReview_authentication_k8s_io_v1Impl
...
@K8sDslMarker
fun TypeChecking.expressionWarnings(init: ExpressionWarning.() -> Unit) {
  this as TypeChecking_admissionregistration_k8s_io_v1beta1Impl
  ExpressionWarning_admissionregistration_k8s_io_v1beta1Impl(this)
    .also { expressionWarnings = expressionWarnings?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata. */
@K8sDslMarker
fun ValidatingAdmissionPolicyBinding.metadata(init: ObjectMeta.() -> Unit) {
  this as ValidatingAdmissionPolicyBinding_admissionregistration_k8s_io_v1beta1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun ValidatingAdmissionPolicyBinding.spec(init: Validatingadmissionpolicybindingspec_admissionregistration_k8s_io_v1beta1.() -> Unit) {
  this as ValidatingAdmissionPolicyBinding_admissionregistration_k8s_io_v1beta1Impl
  Validatingadmissionpolicybindingspec_admissionregistration_k8s_io_v1beta1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata. */
@K8sDslMarker
fun ValidatingAdmissionPolicy.metadata(init: ObjectMeta.() -> Unit) {
  this as ValidatingAdmissionPolicy_admissionregistration_k8s_io_v1beta1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun ValidatingAdmissionPolicy.spec(init: Validatingadmissionpolicyspec_admissionregistration_k8s_io_v1beta1.() -> Unit) {
  this as ValidatingAdmissionPolicy_admissionregistration_k8s_io_v1beta1Impl
  Validatingadmissionpolicyspec_admissionregistration_k8s_io_v1beta1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
@K8sDslMarker
fun ValidatingAdmissionPolicy.status(init: Validatingadmissionpolicystatus_admissionregistration_k8s_io_v1beta1.() -> Unit) {
  this as ValidatingAdmissionPolicy_admissionregistration_k8s_io_v1beta1Impl
  Validatingadmissionpolicystatus_admissionregistration_k8s_io_v1beta1Impl(this)
    .also { status = it }
    .apply(init)
}
...
is a beta feature and managed by the AdmissionWebhookMatchConditions feature gate. */
@K8sDslMarker
fun ValidatingWebhook.matchConditions(init: MatchCondition.() -> Unit) {
  this as ValidatingWebhook_admissionregistration_k8s_io_v1Impl
  MatchCondition_admissionregistration_k8s_io_v1Impl(this)
    .also { matchConditions = matchConditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
...
@K8sDslMarker
fun VolumeAttachmentSource.inlineVolumeSpec(init: Persistentvolumespec_core_v1.() -> Unit) {
...
@K8sDslMarker
fun VolumeAttachment.spec(init: Volumeattachmentspec_storage_k8s_io_v1.() -> Unit) {
  this as VolumeAttachment_storage_k8s_io_v1Impl
...
/** status represents status of the VolumeAttachment request. Populated by the entity completing the attach or detach
operation, i.e. the external-attacher. */
@K8sDslMarker
fun VolumeAttachment.status(init: Volumeattachmentstatus_storage_k8s_io_v1.() -> Unit) {
  this as VolumeAttachment_storage_k8s_io_v1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
@K8sDslMarker
fun VolumeAttributesClass.metadata(init: ObjectMeta.() -> Unit) {
  this as VolumeAttributesClass_storage_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun VolumeProjection.clusterTrustBundle(init: ClusterTrustBundleProjection.() -> Unit) {
  this as VolumeProjection_core_v1Impl
  ClusterTrustBundleProjection_core_v1Impl(this)
    .also { clusterTrustBundle = it }
    .apply(init)
}
...
https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/ */
@K8sDslMarker
fun VolumeResourceRequirements.limits(init: de.loosetie.k8s.dsl.types.LimitsAndRequests.() -> Unit) {
  this as VolumeResourceRequirements_core_v1Impl
  de.loosetie.k8s.dsl.types.LimitsAndRequests(this)
    .also { limits = it }
    .apply(init)
}
...
More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/ */
@K8sDslMarker
fun VolumeResourceRequirements.requests(init: de.loosetie.k8s.dsl.types.LimitsAndRequests.() -> Unit) {
  this as VolumeResourceRequirements_core_v1Impl
  de.loosetie.k8s.dsl.types.LimitsAndRequests(this)
    .also { requests = it }
    .apply(init)
...
@K8sDslMarker
fun Flowschemaspec_flowcontrol_apiserver_k8s_io_v1.distinguisherMethod(init: FlowDistinguisherMethod.() -> Unit) {
  this as Flowschemaspec_flowcontrol_apiserver_k8s_io_v1Impl
  FlowDistinguisherMethod_flowcontrol_apiserver_k8s_io_v1Impl(this)
...
@K8sDslMarker
fun Flowschemaspec_flowcontrol_apiserver_k8s_io_v1.priorityLevelConfiguration(init: PriorityLevelConfigurationReference.() -> Unit) {
  this as Flowschemaspec_flowcontrol_apiserver_k8s_io_v1Impl
  PriorityLevelConfigurationReference_flowcontrol_apiserver_k8s_io_v1Impl(this)
...
@K8sDslMarker
fun Flowschemaspec_flowcontrol_apiserver_k8s_io_v1.rules(init: PolicyRulesWithSubjects.() -> Unit) {
  this as Flowschemaspec_flowcontrol_apiserver_k8s_io_v1Impl
  PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { rules = rules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
@K8sDslMarker
fun Flowschemastatus_flowcontrol_apiserver_k8s_io_v1.conditions(init: FlowSchemaCondition.() -> Unit) {
  this as Flowschemastatus_flowcontrol_apiserver_k8s_io_v1Impl
  FlowSchemaCondition_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
@K8sDslMarker
fun Persistentvolumeclaimspec_core_v1.resources(init: VolumeResourceRequirements.() -> Unit) {
  this as Persistentvolumeclaimspec_core_v1Impl
  VolumeResourceRequirements_core_v1Impl(this)
    .also { resources = it }
    .apply(init)
}
...
ModifyVolume operation being attempted. This is an alpha field and requires enabling VolumeAttributesClass feature. */
@K8sDslMarker
fun Persistentvolumeclaimstatus_core_v1.modifyVolumeStatus(init: ModifyVolumeStatus.() -> Unit) {
  this as Persistentvolumeclaimstatus_core_v1Impl
  ModifyVolumeStatus_core_v1Impl(this)
    .also { modifyVolumeStatus = it }
    .apply(init)
}
...
@K8sDslMarker
fun Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1.exempt(init: ExemptPriorityLevelConfiguration.() -> Unit) {
  this as Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1Impl
  ExemptPriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { exempt = it }
    .apply(init)
}
...
`type` is `"Limited"`. */
@K8sDslMarker
fun Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1.limited(init: LimitedPriorityLevelConfiguration.() -> Unit) {
  this as Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1Impl
  LimitedPriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { limited = it }
    .apply(init)
}
...
@K8sDslMarker
fun Prioritylevelconfigurationstatus_flowcontrol_apiserver_k8s_io_v1.conditions(init: PriorityLevelConfigurationCondition.() -> Unit) {
  this as Prioritylevelconfigurationstatus_flowcontrol_apiserver_k8s_io_v1Impl
  PriorityLevelConfigurationCondition_flowcontrol_apiserver_k8s_io_v1Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
@K8sDslMarker
fun Servicecidrstatus_networking_k8s_io_v1alpha1.conditions(init: Condition.() -> Unit) {
  this as Servicecidrstatus_networking_k8s_io_v1alpha1Impl
  Condition_meta_v1Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
