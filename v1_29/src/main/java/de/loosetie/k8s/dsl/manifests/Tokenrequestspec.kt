...
@K8sDslMarker
interface Tokenrequestspec_authentication_k8s_io_v1: K8sManifest {
  /** Audiences are the intendend audiences of the token. A recipient of a token must identify themself with an identifier in
...
audiences may not. Keep ExpirationSeconds small if you want prompt revocation. */
  val boundObjectRef: BoundObjectReference_authentication_k8s_io_v1?
