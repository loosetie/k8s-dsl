...
fun EndpointSlice.endpoints(init: Endpoint.() -> Unit) {
  this as EndpointSlice_v1alpha1_discovery_k8s_ioImpl
  Endpoint_v1alpha1_discovery_k8s_ioImpl(this)
...
@K8sDslMarker
fun EndpointSlice.ports(init: EndpointPort_v1alpha1_discovery_k8s_io.() -> Unit) {
  this as EndpointSlice_v1alpha1_discovery_k8s_ioImpl
  EndpointPort_v1alpha1_discovery_k8s_ioImpl(this)
    .also { ports = ports?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun CSINode.metadata(init: ObjectMeta.() -> Unit) {
  this as CSINode_v1beta1_storage_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CSINode.spec(init: Csinodespec.() -> Unit) {
  this as CSINode_v1beta1_storage_k8s_ioImpl
  Csinodespec_v1beta1_storage_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun CSINodeDriver.allocatable(init: VolumeNodeResources.() -> Unit) {
  this as CSINodeDriver_v1beta1_storage_k8s_ioImpl
  VolumeNodeResources_v1beta1_storage_k8s_ioImpl(this)
    .also { allocatable = it }
    .apply(init)
}
...
fun Endpoint.conditions(init: EndpointConditions.() -> Unit) {
  this as Endpoint_v1alpha1_discovery_k8s_ioImpl
  EndpointConditions_v1alpha1_discovery_k8s_ioImpl(this)
    .also { conditions = it }
    .apply(init)
}
...
fun Csinodespec.drivers(init: CSINodeDriver.() -> Unit) {
  this as Csinodespec_v1beta1_storage_k8s_ioImpl
  CSINodeDriver_v1beta1_storage_k8s_ioImpl(this)
