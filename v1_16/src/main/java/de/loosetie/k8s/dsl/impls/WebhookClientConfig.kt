...
@JsonPropertyOrder("caBundle", "service", "url")
class WebhookClientConfig_auditregistration_k8s_io_v1alpha1Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: WebhookClientConfig_auditregistration_k8s_io_v1alpha1, HasParent {
  override var caBundle: String? = null
  override var service: ServiceReference_auditregistration_k8s_io_v1alpha1? = null
  override var url: String? = null
}