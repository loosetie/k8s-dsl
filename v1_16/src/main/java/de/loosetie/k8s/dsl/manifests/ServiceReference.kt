...
@K8sDslMarker
interface ServiceReference_admissionregistration_k8s_io_v1: K8sManifest {
...
@K8sDslMarker
interface ServiceReference_apiextensions_k8s_io_v1: K8sManifest {
  /** namespace is the namespace of the service. Required */
  @K8sDslMarker var namespace: String?
  /** name is the name of the service. Required */
  @K8sDslMarker var name: String?
...
@Deprecated(message="Old api version")
@K8sDslMarker
interface ServiceReference_apiregistration_k8s_io_v1: K8sManifest {
...
@Deprecated(message="Old api version")
@K8sDslMarker
interface ServiceReference_auditregistration_k8s_io_v1alpha1: K8sManifest {
  /** `namespace` is the namespace of the service. Required */
  @K8sDslMarker var namespace: String?
  /** `name` is the name of the service. Required */
  @K8sDslMarker var name: String?
