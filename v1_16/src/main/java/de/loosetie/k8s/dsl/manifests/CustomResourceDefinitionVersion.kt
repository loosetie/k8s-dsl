...
@K8sDslMarker
interface CustomResourceDefinitionVersion_apiextensions_k8s_io_v1: K8sManifest {
...
are specified, a single column displaying the age of the custom resource is used. */
  val additionalPrinterColumns: List<CustomResourceColumnDefinition_apiextensions_k8s_io_v1>?
  /** schema describes the schema used for validation, pruning, and defaulting of this version of the custom resource. */
  val schema: CustomResourceValidation_apiextensions_k8s_io_v1?
...
version with storage=true. */
  ...
  val subresources: CustomResourceSubresources_apiextensions_k8s_io_v1?
}