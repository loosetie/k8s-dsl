...
fun Container.env(init: EnvVar.() -> Unit) {
  this as Container_v1_coreImpl
  EnvVar_v1_coreImpl(this)
...
fun Container.envFrom(init: EnvFromSource.() -> Unit) {
  this as Container_v1_coreImpl
  EnvFromSource_v1_coreImpl(this)
...
fun Container.ports(init: ContainerPort.() -> Unit) {
  this as Container_v1_coreImpl
  ContainerPort_v1_coreImpl(this)
...
fun Container.resources(init: ResourceRequirements.() -> Unit) {
  this as Container_v1_coreImpl
  ResourceRequirements_v1_coreImpl(this)
    .also { resources = it }
    .apply(init)
}
...
fun Container.securityContext(init: SecurityContext.() -> Unit) {
  this as Container_v1_coreImpl
  SecurityContext_v1_coreImpl(this)
...
fun CronJob.metadata(init: ObjectMeta.() -> Unit) {
  this as CronJob_v1beta1_batchImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CronJob.spec(init: Cronjobspec.() -> Unit) {
  this as CronJob_v1beta1_batchImpl
  Cronjobspec_v1beta1_batchImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun CronJob.status(init: Cronjobstatus.() -> Unit) {
  this as CronJob_v1beta1_batchImpl
  Cronjobstatus_v1beta1_batchImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun DaemonSet.spec(init: Daemonsetspec.() -> Unit) {
  this as DaemonSet_v1_appsImpl
  Daemonsetspec_v1_appsImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun DaemonSet.status(init: Daemonsetstatus.() -> Unit) {
  this as DaemonSet_v1_appsImpl
  Daemonsetstatus_v1_appsImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun Deployment.metadata(init: ObjectMeta.() -> Unit) {
  this as Deployment_v1_appsImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Deployment.spec(init: Deploymentspec.() -> Unit) {
  this as Deployment_v1_appsImpl
  Deploymentspec_v1_appsImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Deployment.status(init: Deploymentstatus.() -> Unit) {
  this as Deployment_v1_appsImpl
  Deploymentstatus_v1_appsImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun ReplicaSet.metadata(init: ObjectMeta.() -> Unit) {
  this as ReplicaSet_v1_appsImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ReplicaSet.spec(init: Replicasetspec.() -> Unit) {
  this as ReplicaSet_v1_appsImpl
  Replicasetspec_v1_appsImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun ReplicaSet.status(init: Replicasetstatus.() -> Unit) {
  this as ReplicaSet_v1_appsImpl
  Replicasetstatus_v1_appsImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun ReplicationController.metadata(init: ObjectMeta.() -> Unit) {
  this as ReplicationController_v1_coreImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ReplicationController.spec(init: Replicationcontrollerspec.() -> Unit) {
  this as ReplicationController_v1_coreImpl
  Replicationcontrollerspec_v1_coreImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun ReplicationController.status(init: Replicationcontrollerstatus.() -> Unit) {
  this as ReplicationController_v1_coreImpl
  Replicationcontrollerstatus_v1_coreImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun StatefulSet.metadata(init: ObjectMeta.() -> Unit) {
  this as StatefulSet_v1_appsImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun StatefulSet.spec(init: Statefulsetspec.() -> Unit) {
  this as StatefulSet_v1_appsImpl
  Statefulsetspec_v1_appsImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun StatefulSet.status(init: Statefulsetstatus.() -> Unit) {
  this as StatefulSet_v1_appsImpl
  Statefulsetstatus_v1_appsImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun Endpoints.subsets(init: EndpointSubset.() -> Unit) {
  this as Endpoints_v1_coreImpl
  EndpointSubset_v1_coreImpl(this)
...
fun EndpointSlice.endpoints(init: Endpoint.() -> Unit) {
  this as EndpointSlice_v1beta1_discovery_k8s_ioImpl
  Endpoint_v1beta1_discovery_k8s_ioImpl(this)
...
@K8sDslMarker
fun EndpointSlice.ports(init: EndpointPort_v1beta1_discovery_k8s_io.() -> Unit) {
  this as EndpointSlice_v1beta1_discovery_k8s_ioImpl
  EndpointPort_v1beta1_discovery_k8s_ioImpl(this)
    .also { ports = ports?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Ingress.metadata(init: ObjectMeta.() -> Unit) {
  this as Ingress_v1beta1_networking_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Ingress.spec(init: Ingressspec.() -> Unit) {
  this as Ingress_v1beta1_networking_k8s_ioImpl
  Ingressspec_v1beta1_networking_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Ingress.status(init: Ingressstatus.() -> Unit) {
  this as Ingress_v1beta1_networking_k8s_ioImpl
  Ingressstatus_v1beta1_networking_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun Service.status(init: Servicestatus.() -> Unit) {
  this as Service_v1_coreImpl
  Servicestatus_v1_coreImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun CSIDriver.metadata(init: ObjectMeta.() -> Unit) {
  this as CSIDriver_v1beta1_storage_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CSIDriver.spec(init: Csidriverspec.() -> Unit) {
  this as CSIDriver_v1beta1_storage_k8s_ioImpl
  Csidriverspec_v1beta1_storage_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun CSINode.metadata(init: ObjectMeta.() -> Unit) {
  this as CSINode_v1_storage_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CSINode.spec(init: Csinodespec.() -> Unit) {
  this as CSINode_v1_storage_k8s_ioImpl
  Csinodespec_v1_storage_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun PersistentVolumeClaim.metadata(init: ObjectMeta.() -> Unit) {
  this as PersistentVolumeClaim_v1_coreImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PersistentVolumeClaim.spec(init: Persistentvolumeclaimspec.() -> Unit) {
  this as PersistentVolumeClaim_v1_coreImpl
  Persistentvolumeclaimspec_v1_coreImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun PersistentVolumeClaim.status(init: Persistentvolumeclaimstatus.() -> Unit) {
  this as PersistentVolumeClaim_v1_coreImpl
  Persistentvolumeclaimstatus_v1_coreImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun StorageClass.allowedTopologies(init: TopologySelectorTerm.() -> Unit) {
  this as StorageClass_v1_storage_k8s_ioImpl
  TopologySelectorTerm_v1_coreImpl(this)
...
fun Volume.awsElasticBlockStore(init: AWSElasticBlockStoreVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  AWSElasticBlockStoreVolumeSource_v1_coreImpl(this)
...
fun Volume.azureDisk(init: AzureDiskVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  AzureDiskVolumeSource_v1_coreImpl(this)
    .also { azureDisk = it }
    .apply(init)
}
...
fun Volume.azureFile(init: AzureFileVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  AzureFileVolumeSource_v1_coreImpl(this)
    .also { azureFile = it }
    .apply(init)
}
...
fun Volume.cephfs(init: CephFSVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  CephFSVolumeSource_v1_coreImpl(this)
    .also { cephfs = it }
    .apply(init)
}
...
fun Volume.cinder(init: CinderVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  CinderVolumeSource_v1_coreImpl(this)
    .also { cinder = it }
    .apply(init)
}
...
fun Volume.configMap(init: ConfigMapVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  ConfigMapVolumeSource_v1_coreImpl(this)
    .also { configMap = it }
    .apply(init)
}
...
fun Volume.csi(init: CSIVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  CSIVolumeSource_v1_coreImpl(this)
    .also { csi = it }
    .apply(init)
}
...
fun Volume.downwardAPI(init: DownwardAPIVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  DownwardAPIVolumeSource_v1_coreImpl(this)
    .also { downwardAPI = it }
    .apply(init)
}
...
fun Volume.emptyDir(init: EmptyDirVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  EmptyDirVolumeSource_v1_coreImpl(this)
    .also { emptyDir = it }
    .apply(init)
}
...
fun Volume.fc(init: FCVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  FCVolumeSource_v1_coreImpl(this)
    .also { fc = it }
    .apply(init)
}
...
fun Volume.flexVolume(init: FlexVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  FlexVolumeSource_v1_coreImpl(this)
    .also { flexVolume = it }
    .apply(init)
}
...
fun Volume.flocker(init: FlockerVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  FlockerVolumeSource_v1_coreImpl(this)
    .also { flocker = it }
    .apply(init)
}
...
fun Volume.gcePersistentDisk(init: GCEPersistentDiskVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  GCEPersistentDiskVolumeSource_v1_coreImpl(this)
...
fun Volume.gitRepo(init: GitRepoVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  GitRepoVolumeSource_v1_coreImpl(this)
    .also { gitRepo = it }
    .apply(init)
}
...
fun Volume.glusterfs(init: GlusterfsVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  GlusterfsVolumeSource_v1_coreImpl(this)
    .also { glusterfs = it }
    .apply(init)
}
...
fun Volume.hostPath(init: HostPathVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  HostPathVolumeSource_v1_coreImpl(this)
    .also { hostPath = it }
    .apply(init)
}
...
fun Volume.iscsi(init: ISCSIVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  ISCSIVolumeSource_v1_coreImpl(this)
    .also { iscsi = it }
    .apply(init)
}
...
fun Volume.nfs(init: NFSVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  NFSVolumeSource_v1_coreImpl(this)
    .also { nfs = it }
    .apply(init)
}
...
fun Volume.persistentVolumeClaim(init: PersistentVolumeClaimVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  PersistentVolumeClaimVolumeSource_v1_coreImpl(this)
...
fun Volume.photonPersistentDisk(init: PhotonPersistentDiskVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  PhotonPersistentDiskVolumeSource_v1_coreImpl(this)
...
fun Volume.portworxVolume(init: PortworxVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  PortworxVolumeSource_v1_coreImpl(this)
...
fun Volume.projected(init: ProjectedVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  ProjectedVolumeSource_v1_coreImpl(this)
    .also { projected = it }
    .apply(init)
}
...
fun Volume.quobyte(init: QuobyteVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  QuobyteVolumeSource_v1_coreImpl(this)
    .also { quobyte = it }
    .apply(init)
}
...
fun Volume.rbd(init: RBDVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  RBDVolumeSource_v1_coreImpl(this)
    .also { rbd = it }
    .apply(init)
}
...
fun Volume.scaleIO(init: ScaleIOVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  ScaleIOVolumeSource_v1_coreImpl(this)
    .also { scaleIO = it }
    .apply(init)
}
...
fun Volume.secret(init: SecretVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  SecretVolumeSource_v1_coreImpl(this)
    .also { secret = it }
    .apply(init)
}
...
fun Volume.storageos(init: StorageOSVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  StorageOSVolumeSource_v1_coreImpl(this)
    .also { storageos = it }
    .apply(init)
}
...
fun Volume.vsphereVolume(init: VsphereVirtualDiskVolumeSource.() -> Unit) {
  this as Volume_v1_coreImpl
  VsphereVirtualDiskVolumeSource_v1_coreImpl(this)
...
fun VolumeAttachment.metadata(init: ObjectMeta.() -> Unit) {
  this as VolumeAttachment_v1_storage_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun VolumeAttachment.spec(init: Volumeattachmentspec.() -> Unit) {
  this as VolumeAttachment_v1_storage_k8s_ioImpl
  Volumeattachmentspec_v1_storage_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun VolumeAttachment.status(init: Volumeattachmentstatus.() -> Unit) {
  this as VolumeAttachment_v1_storage_k8s_ioImpl
  Volumeattachmentstatus_v1_storage_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun ControllerRevision.metadata(init: ObjectMeta.() -> Unit) {
  this as ControllerRevision_v1_appsImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CustomResourceDefinition.metadata(init: ObjectMeta.() -> Unit) {
  this as CustomResourceDefinition_v1_apiextensions_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CustomResourceDefinition.spec(init: Customresourcedefinitionspec.() -> Unit) {
  this as CustomResourceDefinition_v1_apiextensions_k8s_ioImpl
  Customresourcedefinitionspec_v1_apiextensions_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun CustomResourceDefinition.status(init: Customresourcedefinitionstatus.() -> Unit) {
  this as CustomResourceDefinition_v1_apiextensions_k8s_ioImpl
  Customresourcedefinitionstatus_v1_apiextensions_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun Event.eventTime(init: MicroTime.() -> Unit) {
  this as Event_v1_coreImpl
  MicroTime_v1_metaImpl(this)
    .also { eventTime = it }
    .apply(init)
}
...
fun Event.involvedObject(init: ObjectReference.() -> Unit) {
  this as Event_v1_coreImpl
  ObjectReference_v1_coreImpl(this)
...
fun LimitRange.metadata(init: ObjectMeta.() -> Unit) {
  this as LimitRange_v1_coreImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun LimitRange.spec(init: Limitrangespec.() -> Unit) {
  this as LimitRange_v1_coreImpl
  Limitrangespec_v1_coreImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun HorizontalPodAutoscaler.metadata(init: ObjectMeta.() -> Unit) {
  this as HorizontalPodAutoscaler_v1_autoscalingImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun HorizontalPodAutoscaler.spec(init: Horizontalpodautoscalerspec.() -> Unit) {
  this as HorizontalPodAutoscaler_v1_autoscalingImpl
  Horizontalpodautoscalerspec_v1_autoscalingImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun HorizontalPodAutoscaler.status(init: Horizontalpodautoscalerstatus.() -> Unit) {
  this as HorizontalPodAutoscaler_v1_autoscalingImpl
  Horizontalpodautoscalerstatus_v1_autoscalingImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun MutatingWebhookConfiguration.metadata(init: ObjectMeta.() -> Unit) {
  this as MutatingWebhookConfiguration_v1_admissionregistration_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun MutatingWebhookConfiguration.webhooks(init: MutatingWebhook.() -> Unit) {
  this as MutatingWebhookConfiguration_v1_admissionregistration_k8s_ioImpl
  MutatingWebhook_v1_admissionregistration_k8s_ioImpl(this)
...
fun ValidatingWebhookConfiguration.metadata(init: ObjectMeta.() -> Unit) {
  this as ValidatingWebhookConfiguration_v1_admissionregistration_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ValidatingWebhookConfiguration.webhooks(init: ValidatingWebhook.() -> Unit) {
  this as ValidatingWebhookConfiguration_v1_admissionregistration_k8s_ioImpl
  ValidatingWebhook_v1_admissionregistration_k8s_ioImpl(this)
    .also { webhooks = webhooks?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun PodTemplate.metadata(init: ObjectMeta.() -> Unit) {
  this as PodTemplate_v1_coreImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PodTemplate.template(init: Podtemplatespec.() -> Unit) {
  this as PodTemplate_v1_coreImpl
  Podtemplatespec_v1_coreImpl(this)
    .also { template = it }
    .apply(init)
}
...
fun PodDisruptionBudget.metadata(init: ObjectMeta.() -> Unit) {
  this as PodDisruptionBudget_v1beta1_policyImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PodDisruptionBudget.spec(init: Poddisruptionbudgetspec.() -> Unit) {
  this as PodDisruptionBudget_v1beta1_policyImpl
  Poddisruptionbudgetspec_v1beta1_policyImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun PodDisruptionBudget.status(init: Poddisruptionbudgetstatus.() -> Unit) {
  this as PodDisruptionBudget_v1beta1_policyImpl
  Poddisruptionbudgetstatus_v1beta1_policyImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun PriorityClass.metadata(init: ObjectMeta.() -> Unit) {
  this as PriorityClass_v1_scheduling_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PodPreset.metadata(init: ObjectMeta.() -> Unit) {
  this as PodPreset_v1alpha1_settings_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PodPreset.spec(init: Podpresetspec.() -> Unit) {
  this as PodPreset_v1alpha1_settings_k8s_ioImpl
  Podpresetspec_v1alpha1_settings_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun PodSecurityPolicy.metadata(init: ObjectMeta.() -> Unit) {
  this as PodSecurityPolicy_v1beta1_policyImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PodSecurityPolicy.spec(init: Podsecuritypolicyspec.() -> Unit) {
  this as PodSecurityPolicy_v1beta1_policyImpl
  Podsecuritypolicyspec_v1beta1_policyImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun APIService.metadata(init: ObjectMeta.() -> Unit) {
  this as APIService_v1_apiregistration_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun APIService.spec(init: Apiservicespec.() -> Unit) {
  this as APIService_v1_apiregistration_k8s_ioImpl
  Apiservicespec_v1_apiregistration_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun APIService.status(init: Apiservicestatus.() -> Unit) {
  this as APIService_v1_apiregistration_k8s_ioImpl
  Apiservicestatus_v1_apiregistration_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun AuditSink.metadata(init: ObjectMeta.() -> Unit) {
  this as AuditSink_v1alpha1_auditregistration_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun AuditSink.spec(init: Auditsinkspec.() -> Unit) {
  this as AuditSink_v1alpha1_auditregistration_k8s_ioImpl
  Auditsinkspec_v1alpha1_auditregistration_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun CertificateSigningRequest.metadata(init: ObjectMeta.() -> Unit) {
  this as CertificateSigningRequest_v1beta1_certificates_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CertificateSigningRequest.spec(init: Certificatesigningrequestspec.() -> Unit) {
  this as CertificateSigningRequest_v1beta1_certificates_k8s_ioImpl
  Certificatesigningrequestspec_v1beta1_certificates_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun CertificateSigningRequest.status(init: Certificatesigningrequeststatus.() -> Unit) {
  this as CertificateSigningRequest_v1beta1_certificates_k8s_ioImpl
  Certificatesigningrequeststatus_v1beta1_certificates_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun ClusterRole.aggregationRule(init: AggregationRule.() -> Unit) {
  this as ClusterRole_v1_rbac_authorization_k8s_ioImpl
  AggregationRule_v1_rbac_authorization_k8s_ioImpl(this)
...
fun ClusterRole.rules(init: PolicyRule.() -> Unit) {
  this as ClusterRole_v1_rbac_authorization_k8s_ioImpl
  PolicyRule_v1_rbac_authorization_k8s_ioImpl(this)
...
fun ClusterRoleBinding.metadata(init: ObjectMeta.() -> Unit) {
  this as ClusterRoleBinding_v1_rbac_authorization_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ClusterRoleBinding.roleRef(init: RoleRef.() -> Unit) {
  this as ClusterRoleBinding_v1_rbac_authorization_k8s_ioImpl
  RoleRef_v1_rbac_authorization_k8s_ioImpl(this)
    .also { roleRef = it }
    .apply(init)
}
...
@K8sDslMarker
fun ClusterRoleBinding.subjects(init: Subject_v1_rbac_authorization_k8s_io.() -> Unit) {
  this as ClusterRoleBinding_v1_rbac_authorization_k8s_ioImpl
  Subject_v1_rbac_authorization_k8s_ioImpl(this)
...
fun ComponentStatus.conditions(init: ComponentCondition.() -> Unit) {
  this as ComponentStatus_v1_coreImpl
  ComponentCondition_v1_coreImpl(this)
...
fun FlowSchema.metadata(init: ObjectMeta.() -> Unit) {
  this as FlowSchema_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun FlowSchema.spec(init: Flowschemaspec.() -> Unit) {
  this as FlowSchema_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  Flowschemaspec_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun FlowSchema.status(init: Flowschemastatus.() -> Unit) {
  this as FlowSchema_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  Flowschemastatus_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun Lease.metadata(init: ObjectMeta.() -> Unit) {
  this as Lease_v1_coordination_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Lease.spec(init: Leasespec.() -> Unit) {
  this as Lease_v1_coordination_k8s_ioImpl
  Leasespec_v1_coordination_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun LocalSubjectAccessReview.metadata(init: ObjectMeta.() -> Unit) {
  this as LocalSubjectAccessReview_v1_authorization_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun LocalSubjectAccessReview.spec(init: Subjectaccessreviewspec.() -> Unit) {
  this as LocalSubjectAccessReview_v1_authorization_k8s_ioImpl
  Subjectaccessreviewspec_v1_authorization_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun LocalSubjectAccessReview.status(init: Subjectaccessreviewstatus.() -> Unit) {
  this as LocalSubjectAccessReview_v1_authorization_k8s_ioImpl
  Subjectaccessreviewstatus_v1_authorization_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun Namespace.spec(init: Namespacespec.() -> Unit) {
  this as Namespace_v1_coreImpl
  Namespacespec_v1_coreImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Namespace.status(init: Namespacestatus.() -> Unit) {
  this as Namespace_v1_coreImpl
  Namespacestatus_v1_coreImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun PersistentVolume.metadata(init: ObjectMeta.() -> Unit) {
  this as PersistentVolume_v1_coreImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PersistentVolume.spec(init: Persistentvolumespec.() -> Unit) {
  this as PersistentVolume_v1_coreImpl
  Persistentvolumespec_v1_coreImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun PersistentVolume.status(init: Persistentvolumestatus.() -> Unit) {
  this as PersistentVolume_v1_coreImpl
  Persistentvolumestatus_v1_coreImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun PriorityLevelConfiguration.metadata(init: ObjectMeta.() -> Unit) {
  this as PriorityLevelConfiguration_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PriorityLevelConfiguration.spec(init: Prioritylevelconfigurationspec.() -> Unit) {
  this as PriorityLevelConfiguration_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  Prioritylevelconfigurationspec_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun PriorityLevelConfiguration.status(init: Prioritylevelconfigurationstatus.() -> Unit) {
  this as PriorityLevelConfiguration_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  Prioritylevelconfigurationstatus_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun ResourceQuota.metadata(init: ObjectMeta.() -> Unit) {
  this as ResourceQuota_v1_coreImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ResourceQuota.spec(init: Resourcequotaspec.() -> Unit) {
  this as ResourceQuota_v1_coreImpl
  Resourcequotaspec_v1_coreImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun ResourceQuota.status(init: Resourcequotastatus.() -> Unit) {
  this as ResourceQuota_v1_coreImpl
  Resourcequotastatus_v1_coreImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun Role.metadata(init: ObjectMeta.() -> Unit) {
  this as Role_v1_rbac_authorization_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun RoleBinding.metadata(init: ObjectMeta.() -> Unit) {
  this as RoleBinding_v1_rbac_authorization_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
/** Subjects holds references to the objects the role applies to. */
@K8sDslMarker
fun RoleBinding.subjects(init: Subject_v1_rbac_authorization_k8s_io.() -> Unit) {
  this as RoleBinding_v1_rbac_authorization_k8s_ioImpl
  Subject_v1_rbac_authorization_k8s_ioImpl(this)
    .also { subjects = subjects?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
...
fun RuntimeClass.metadata(init: ObjectMeta.() -> Unit) {
  this as RuntimeClass_v1beta1_node_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun RuntimeClass.overhead(init: Overhead.() -> Unit) {
  this as RuntimeClass_v1beta1_node_k8s_ioImpl
  Overhead_v1beta1_node_k8s_ioImpl(this)
    .also { overhead = it }
    .apply(init)
}
...
fun RuntimeClass.scheduling(init: Scheduling.() -> Unit) {
  this as RuntimeClass_v1beta1_node_k8s_ioImpl
  Scheduling_v1beta1_node_k8s_ioImpl(this)
    .also { scheduling = it }
    .apply(init)
}
...
fun SelfSubjectAccessReview.metadata(init: ObjectMeta.() -> Unit) {
  this as SelfSubjectAccessReview_v1_authorization_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun SelfSubjectAccessReview.spec(init: Selfsubjectaccessreviewspec.() -> Unit) {
  this as SelfSubjectAccessReview_v1_authorization_k8s_ioImpl
  Selfsubjectaccessreviewspec_v1_authorization_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun SelfSubjectRulesReview.metadata(init: ObjectMeta.() -> Unit) {
  this as SelfSubjectRulesReview_v1_authorization_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun SelfSubjectRulesReview.spec(init: Selfsubjectrulesreviewspec.() -> Unit) {
  this as SelfSubjectRulesReview_v1_authorization_k8s_ioImpl
  Selfsubjectrulesreviewspec_v1_authorization_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun SelfSubjectRulesReview.status(init: SubjectRulesReviewStatus.() -> Unit) {
  this as SelfSubjectRulesReview_v1_authorization_k8s_ioImpl
  SubjectRulesReviewStatus_v1_authorization_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun ServiceAccount.imagePullSecrets(init: LocalObjectReference.() -> Unit) {
  this as ServiceAccount_v1_coreImpl
  LocalObjectReference_v1_coreImpl(this)
...
fun SubjectAccessReview.metadata(init: ObjectMeta.() -> Unit) {
  this as SubjectAccessReview_v1_authorization_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun TokenRequest.metadata(init: ObjectMeta.() -> Unit) {
  this as TokenRequest_v1_authentication_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun TokenRequest.spec(init: Tokenrequestspec.() -> Unit) {
  this as TokenRequest_v1_authentication_k8s_ioImpl
  Tokenrequestspec_v1_authentication_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun TokenRequest.status(init: Tokenrequeststatus.() -> Unit) {
  this as TokenRequest_v1_authentication_k8s_ioImpl
  Tokenrequeststatus_v1_authentication_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun TokenReview.metadata(init: ObjectMeta.() -> Unit) {
  this as TokenReview_v1_authentication_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun TokenReview.spec(init: Tokenreviewspec.() -> Unit) {
  this as TokenReview_v1_authentication_k8s_ioImpl
  Tokenreviewspec_v1_authentication_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun TokenReview.status(init: Tokenreviewstatus.() -> Unit) {
  this as TokenReview_v1_authentication_k8s_ioImpl
  Tokenreviewstatus_v1_authentication_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun NetworkPolicy.metadata(init: ObjectMeta.() -> Unit) {
  this as NetworkPolicy_v1_networking_k8s_ioImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun NetworkPolicy.spec(init: Networkpolicyspec.() -> Unit) {
  this as NetworkPolicy_v1_networking_k8s_ioImpl
  Networkpolicyspec_v1_networking_k8s_ioImpl(this)
    .also { spec = it }
    .apply(init)
}
...
fun APIGroup.preferredVersion(init: GroupVersionForDiscovery.() -> Unit) {
  this as APIGroup_v1_metaImpl
  GroupVersionForDiscovery_v1_metaImpl(this)
...
fun APIGroup.serverAddressByClientCIDRs(init: ServerAddressByClientCIDR.() -> Unit) {
  this as APIGroup_v1_metaImpl
  ServerAddressByClientCIDR_v1_metaImpl(this)
...
fun APIServiceCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as APIServiceCondition_v1_apiregistration_k8s_ioImpl
  Time_v1_metaImpl(this)
...
fun APIVersions.serverAddressByClientCIDRs(init: ServerAddressByClientCIDR.() -> Unit) {
  this as APIVersions_v1_metaImpl
  ServerAddressByClientCIDR_v1_metaImpl(this)
    .also { serverAddressByClientCIDRs = serverAddressByClientCIDRs?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Affinity.nodeAffinity(init: NodeAffinity.() -> Unit) {
  this as Affinity_v1_coreImpl
  NodeAffinity_v1_coreImpl(this)
...
fun Affinity.podAntiAffinity(init: PodAntiAffinity.() -> Unit) {
  this as Affinity_v1_coreImpl
  PodAntiAffinity_v1_coreImpl(this)
...
fun AggregationRule.clusterRoleSelectors(init: LabelSelector.() -> Unit) {
  this as AggregationRule_v1_rbac_authorization_k8s_ioImpl
  LabelSelector_v1_metaImpl(this)
...
fun CSINodeDriver.allocatable(init: VolumeNodeResources.() -> Unit) {
  this as CSINodeDriver_v1_storage_k8s_ioImpl
  VolumeNodeResources_v1_storage_k8s_ioImpl(this)
    .also { allocatable = it }
    .apply(init)
}
...
fun CSIPersistentVolumeSource.controllerExpandSecretRef(init: SecretReference.() -> Unit) {
  this as CSIPersistentVolumeSource_v1_coreImpl
  SecretReference_v1_coreImpl(this)
...
fun CSIVolumeSource.nodePublishSecretRef(init: LocalObjectReference.() -> Unit) {
  this as CSIVolumeSource_v1_coreImpl
  LocalObjectReference_v1_coreImpl(this)
    .also { nodePublishSecretRef = it }
    .apply(init)
}
...
fun CephFSPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as CephFSPersistentVolumeSource_v1_coreImpl
  SecretReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun CephFSVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as CephFSVolumeSource_v1_coreImpl
  LocalObjectReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun CertificateSigningRequestCondition.lastUpdateTime(init: Time.() -> Unit) {
  this as CertificateSigningRequestCondition_v1beta1_certificates_k8s_ioImpl
  Time_v1_metaImpl(this)
...
fun CinderPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as CinderPersistentVolumeSource_v1_coreImpl
  SecretReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun CinderVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as CinderVolumeSource_v1_coreImpl
  LocalObjectReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun ConfigMapProjection.items(init: KeyToPath.() -> Unit) {
  this as ConfigMapProjection_v1_coreImpl
  KeyToPath_v1_coreImpl(this)
...
fun ConfigMapVolumeSource.items(init: KeyToPath.() -> Unit) {
  this as ConfigMapVolumeSource_v1_coreImpl
  KeyToPath_v1_coreImpl(this)
    .also { items = items?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun ContainerState.running(init: ContainerStateRunning.() -> Unit) {
  this as ContainerState_v1_coreImpl
  ContainerStateRunning_v1_coreImpl(this)
    .also { running = it }
    .apply(init)
}
...
fun ContainerState.terminated(init: ContainerStateTerminated.() -> Unit) {
  this as ContainerState_v1_coreImpl
  ContainerStateTerminated_v1_coreImpl(this)
    .also { terminated = it }
    .apply(init)
}
...
fun ContainerState.waiting(init: ContainerStateWaiting.() -> Unit) {
  this as ContainerState_v1_coreImpl
  ContainerStateWaiting_v1_coreImpl(this)
    .also { waiting = it }
    .apply(init)
}
...
fun ContainerStateRunning.startedAt(init: Time.() -> Unit) {
  this as ContainerStateRunning_v1_coreImpl
  Time_v1_metaImpl(this)
    .also { startedAt = it }
    .apply(init)
}
...
fun ContainerStateTerminated.finishedAt(init: Time.() -> Unit) {
  this as ContainerStateTerminated_v1_coreImpl
  Time_v1_metaImpl(this)
    .also { finishedAt = it }
    .apply(init)
}
...
fun CustomResourceConversion.webhook(init: WebhookConversion.() -> Unit) {
  this as CustomResourceConversion_v1_apiextensions_k8s_ioImpl
  WebhookConversion_v1_apiextensions_k8s_ioImpl(this)
    .also { webhook = it }
    .apply(init)
}
...
fun CustomResourceDefinitionCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as CustomResourceDefinitionCondition_v1_apiextensions_k8s_ioImpl
  Time_v1_metaImpl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun CustomResourceDefinitionVersion.additionalPrinterColumns(init: CustomResourceColumnDefinition.() -> Unit) {
  this as CustomResourceDefinitionVersion_v1_apiextensions_k8s_ioImpl
  CustomResourceColumnDefinition_v1_apiextensions_k8s_ioImpl(this)
...
fun CustomResourceDefinitionVersion.schema(init: CustomResourceValidation.() -> Unit) {
  this as CustomResourceDefinitionVersion_v1_apiextensions_k8s_ioImpl
  CustomResourceValidation_v1_apiextensions_k8s_ioImpl(this)
    .also { schema = it }
    .apply(init)
}
...
fun CustomResourceDefinitionVersion.subresources(init: CustomResourceSubresources.() -> Unit) {
  this as CustomResourceDefinitionVersion_v1_apiextensions_k8s_ioImpl
  CustomResourceSubresources_v1_apiextensions_k8s_ioImpl(this)
...
fun CustomResourceSubresources.scale(init: CustomResourceSubresourceScale.() -> Unit) {
  this as CustomResourceSubresources_v1_apiextensions_k8s_ioImpl
  CustomResourceSubresourceScale_v1_apiextensions_k8s_ioImpl(this)
    .also { scale = it }
    .apply(init)
}
...
fun CustomResourceSubresources.status(init: CustomResourceSubresourceStatus.() -> Unit) {
  this as CustomResourceSubresources_v1_apiextensions_k8s_ioImpl
  CustomResourceSubresourceStatus_v1_apiextensions_k8s_ioImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun CustomResourceValidation.openAPIV3Schema(init: JSONSchemaProps.() -> Unit) {
  this as CustomResourceValidation_v1_apiextensions_k8s_ioImpl
  JSONSchemaProps_v1_apiextensions_k8s_ioImpl(this)
...
fun DaemonSetCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as DaemonSetCondition_v1_appsImpl
  Time_v1_metaImpl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun DaemonSetUpdateStrategy.rollingUpdate(init: Rollingupdatedaemonset.() -> Unit) {
  this as DaemonSetUpdateStrategy_v1_appsImpl
  Rollingupdatedaemonset_v1_appsImpl(this)
...
fun DeleteOptions.preconditions(init: Preconditions.() -> Unit) {
  this as DeleteOptions_v1_metaImpl
  Preconditions_v1_metaImpl(this)
...
fun DeploymentCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as DeploymentCondition_v1_appsImpl
  Time_v1_metaImpl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun DownwardAPIProjection.items(init: DownwardAPIVolumeFile.() -> Unit) {
  this as DownwardAPIProjection_v1_coreImpl
  DownwardAPIVolumeFile_v1_coreImpl(this)
    .also { items = items?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun DownwardAPIVolumeFile.fieldRef(init: ObjectFieldSelector.() -> Unit) {
  this as DownwardAPIVolumeFile_v1_coreImpl
  ObjectFieldSelector_v1_coreImpl(this)
    .also { fieldRef = it }
    .apply(init)
}
...
fun DownwardAPIVolumeFile.resourceFieldRef(init: ResourceFieldSelector.() -> Unit) {
  this as DownwardAPIVolumeFile_v1_coreImpl
  ResourceFieldSelector_v1_coreImpl(this)
...
fun DownwardAPIVolumeSource.items(init: DownwardAPIVolumeFile.() -> Unit) {
  this as DownwardAPIVolumeSource_v1_coreImpl
  DownwardAPIVolumeFile_v1_coreImpl(this)
    .also { items = items?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun EmptyDirVolumeSource.sizeLimit(init: Quantity.() -> Unit) {
  this as EmptyDirVolumeSource_v1_coreImpl
  Quantity_resource_coreImpl(this)
    .also { sizeLimit = it }
    .apply(init)
}
...
fun Endpoint.conditions(init: EndpointConditions.() -> Unit) {
  this as Endpoint_v1beta1_discovery_k8s_ioImpl
  EndpointConditions_v1beta1_discovery_k8s_ioImpl(this)
    .also { conditions = it }
    .apply(init)
}
...
fun EndpointAddress.targetRef(init: ObjectReference.() -> Unit) {
  this as EndpointAddress_v1_coreImpl
  ObjectReference_v1_coreImpl(this)
    .also { targetRef = it }
    .apply(init)
}
...
fun EndpointSubset.addresses(init: EndpointAddress.() -> Unit) {
  this as EndpointSubset_v1_coreImpl
  EndpointAddress_v1_coreImpl(this)
...
fun EnvFromSource.configMapRef(init: ConfigMapEnvSource.() -> Unit) {
  this as EnvFromSource_v1_coreImpl
  ConfigMapEnvSource_v1_coreImpl(this)
...
fun EnvFromSource.secretRef(init: SecretEnvSource.() -> Unit) {
  this as EnvFromSource_v1_coreImpl
  SecretEnvSource_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun EnvVar.valueFrom(init: EnvVarSource.() -> Unit) {
  this as EnvVar_v1_coreImpl
  EnvVarSource_v1_coreImpl(this)
    .also { valueFrom = it }
    .apply(init)
}
...
fun EnvVarSource.configMapKeyRef(init: ConfigMapKeySelector.() -> Unit) {
  this as EnvVarSource_v1_coreImpl
  ConfigMapKeySelector_v1_coreImpl(this)
...
fun EnvVarSource.secretKeyRef(init: SecretKeySelector.() -> Unit) {
  this as EnvVarSource_v1_coreImpl
  SecretKeySelector_v1_coreImpl(this)
...
fun EphemeralContainer.env(init: EnvVar.() -> Unit) {
  this as EphemeralContainer_v1_coreImpl
  EnvVar_v1_coreImpl(this)
    .also { env = env?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun EventSeries.lastObservedTime(init: MicroTime.() -> Unit) {
  this as EventSeries_v1_coreImpl
  MicroTime_v1_metaImpl(this)
...
fun Eviction.deleteOptions(init: DeleteOptions.() -> Unit) {
  this as Eviction_v1beta1_policyImpl
  DeleteOptions_v1_metaImpl(this)
...
fun ExternalMetricSource.metric(init: MetricIdentifier.() -> Unit) {
  this as ExternalMetricSource_v2beta2_autoscalingImpl
  MetricIdentifier_v2beta2_autoscalingImpl(this)
    .also { metric = it }
    .apply(init)
}
...
fun ExternalMetricSource.target(init: MetricTarget.() -> Unit) {
  this as ExternalMetricSource_v2beta2_autoscalingImpl
  MetricTarget_v2beta2_autoscalingImpl(this)
    .also { target = it }
    .apply(init)
}
...
fun ExternalMetricStatus.current(init: MetricValueStatus.() -> Unit) {
  this as ExternalMetricStatus_v2beta2_autoscalingImpl
  MetricValueStatus_v2beta2_autoscalingImpl(this)
    .also { current = it }
    .apply(init)
}
...
fun FSGroupStrategyOptions.ranges(init: IDRange.() -> Unit) {
  this as FSGroupStrategyOptions_v1beta1_policyImpl
  IDRange_v1beta1_policyImpl(this)
...
fun FlexPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as FlexPersistentVolumeSource_v1_coreImpl
  SecretReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun FlexVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as FlexVolumeSource_v1_coreImpl
  LocalObjectReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun FlowSchemaCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as FlowSchemaCondition_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  Time_v1_metaImpl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun HTTPGetAction.httpHeaders(init: HTTPHeader.() -> Unit) {
  this as HTTPGetAction_v1_coreImpl
  HTTPHeader_v1_coreImpl(this)
...
fun HTTPIngressPath.backend(init: IngressBackend.() -> Unit) {
  this as HTTPIngressPath_v1beta1_networking_k8s_ioImpl
  IngressBackend_v1beta1_networking_k8s_ioImpl(this)
    .also { backend = it }
    .apply(init)
}
...
fun HTTPIngressRuleValue.paths(init: HTTPIngressPath.() -> Unit) {
  this as HTTPIngressRuleValue_v1beta1_networking_k8s_ioImpl
  HTTPIngressPath_v1beta1_networking_k8s_ioImpl(this)
...
fun Handler.exec(init: ExecAction.() -> Unit) {
  this as Handler_v1_coreImpl
  ExecAction_v1_coreImpl(this)
    .also { exec = it }
    .apply(init)
}
...
fun Handler.httpGet(init: HTTPGetAction.() -> Unit) {
  this as Handler_v1_coreImpl
  HTTPGetAction_v1_coreImpl(this)
    .also { httpGet = it }
    .apply(init)
}
...
fun Handler.tcpSocket(init: TCPSocketAction.() -> Unit) {
  this as Handler_v1_coreImpl
  TCPSocketAction_v1_coreImpl(this)
    .also { tcpSocket = it }
    .apply(init)
}
...
fun HorizontalPodAutoscalerCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as HorizontalPodAutoscalerCondition_v2beta2_autoscalingImpl
  Time_v1_metaImpl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun ISCSIPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as ISCSIPersistentVolumeSource_v1_coreImpl
  SecretReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun ISCSIVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as ISCSIVolumeSource_v1_coreImpl
  LocalObjectReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun IngressBackend.servicePort(string: String) {
  this as IngressBackend_v1beta1_networking_k8s_ioImpl
  de.loosetie.k8s.dsl.types.IntOrString(string)
    .also { servicePort = it }
}
...
fun IngressRule.http(init: HTTPIngressRuleValue.() -> Unit) {
  this as IngressRule_v1beta1_networking_k8s_ioImpl
  HTTPIngressRuleValue_v1beta1_networking_k8s_ioImpl(this)
    .also { http = it }
    .apply(init)
}
...
fun JSONSchemaProps.additionalItems(init: JSONSchemaPropsOrBool.() -> Unit) {
  this as JSONSchemaProps_v1_apiextensions_k8s_ioImpl
  JSONSchemaPropsOrBool_v1_apiextensions_k8s_ioImpl(this)
...
fun JSONSchemaProps.default(init: JSON.() -> Unit) {
  this as JSONSchemaProps_v1_apiextensions_k8s_ioImpl
  JSON_v1_apiextensions_k8s_ioImpl(this)
    .also { default = it }
    .apply(init)
}
...
fun JSONSchemaProps.externalDocs(init: ExternalDocumentation.() -> Unit) {
  this as JSONSchemaProps_v1_apiextensions_k8s_ioImpl
  ExternalDocumentation_v1_apiextensions_k8s_ioImpl(this)
...
fun JSONSchemaProps.items(init: JSONSchemaPropsOrArray.() -> Unit) {
  this as JSONSchemaProps_v1_apiextensions_k8s_ioImpl
  JSONSchemaPropsOrArray_v1_apiextensions_k8s_ioImpl(this)
    .also { items = it }
    .apply(init)
}
...
fun JobCondition.lastProbeTime(init: Time.() -> Unit) {
  this as JobCondition_v1_batchImpl
  Time_v1_metaImpl(this)
...
fun JobTemplateSpec.metadata(init: ObjectMeta.() -> Unit) {
  this as JobTemplateSpec_v1beta1_batchImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun LabelSelector.matchExpressions(init: LabelSelectorRequirement.() -> Unit) {
  this as LabelSelector_v1_metaImpl
  LabelSelectorRequirement_v1_metaImpl(this)
...
fun Lifecycle.postStart(init: Handler.() -> Unit) {
  this as Lifecycle_v1_coreImpl
  Handler_v1_coreImpl(this)
    .also { postStart = it }
    .apply(init)
}
...
fun LimitRangeItem.default(init: de.loosetie.k8s.dsl.types.CpuMem.() -> Unit) {
  this as LimitRangeItem_v1_coreImpl
...
fun LimitResponse.queuing(init: QueuingConfiguration.() -> Unit) {
  this as LimitResponse_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  QueuingConfiguration_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { queuing = it }
    .apply(init)
}
...
fun LimitedPriorityLevelConfiguration.limitResponse(init: LimitResponse.() -> Unit) {
  this as LimitedPriorityLevelConfiguration_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  LimitResponse_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
...
fun LoadBalancerStatus.ingress(init: LoadBalancerIngress.() -> Unit) {
  this as LoadBalancerStatus_v1_coreImpl
  LoadBalancerIngress_v1_coreImpl(this)
...
fun ManagedFieldsEntry.fieldsV1(init: FieldsV1.() -> Unit) {
  this as ManagedFieldsEntry_v1_metaImpl
  FieldsV1_v1_metaImpl(this)
    .also { fieldsV1 = it }
    .apply(init)
}
...
fun MetricIdentifier.selector(init: LabelSelector.() -> Unit) {
  this as MetricIdentifier_v2beta2_autoscalingImpl
  LabelSelector_v1_metaImpl(this)
    .also { selector = it }
    .apply(init)
}
...
fun MetricSpec.external(init: ExternalMetricSource.() -> Unit) {
  this as MetricSpec_v2beta2_autoscalingImpl
  ExternalMetricSource_v2beta2_autoscalingImpl(this)
    .also { external = it }
    .apply(init)
}
...
fun MetricSpec.`object`(init: ObjectMetricSource.() -> Unit) {
  this as MetricSpec_v2beta2_autoscalingImpl
  ObjectMetricSource_v2beta2_autoscalingImpl(this)
    .also { `object` = it }
    .apply(init)
}
...
fun MetricSpec.pods(init: PodsMetricSource.() -> Unit) {
  this as MetricSpec_v2beta2_autoscalingImpl
  PodsMetricSource_v2beta2_autoscalingImpl(this)
    .also { pods = it }
    .apply(init)
}
...
fun MetricSpec.resource(init: ResourceMetricSource.() -> Unit) {
  this as MetricSpec_v2beta2_autoscalingImpl
  ResourceMetricSource_v2beta2_autoscalingImpl(this)
    .also { resource = it }
    .apply(init)
}
...
fun MetricStatus.external(init: ExternalMetricStatus.() -> Unit) {
  this as MetricStatus_v2beta2_autoscalingImpl
  ExternalMetricStatus_v2beta2_autoscalingImpl(this)
    .also { external = it }
    .apply(init)
}
...
fun MetricStatus.`object`(init: ObjectMetricStatus.() -> Unit) {
  this as MetricStatus_v2beta2_autoscalingImpl
  ObjectMetricStatus_v2beta2_autoscalingImpl(this)
    .also { `object` = it }
    .apply(init)
}
...
fun MetricStatus.pods(init: PodsMetricStatus.() -> Unit) {
  this as MetricStatus_v2beta2_autoscalingImpl
  PodsMetricStatus_v2beta2_autoscalingImpl(this)
    .also { pods = it }
    .apply(init)
}
...
fun MetricStatus.resource(init: ResourceMetricStatus.() -> Unit) {
  this as MetricStatus_v2beta2_autoscalingImpl
  ResourceMetricStatus_v2beta2_autoscalingImpl(this)
    .also { resource = it }
    .apply(init)
}
...
fun MetricTarget.averageValue(init: Quantity.() -> Unit) {
  this as MetricTarget_v2beta2_autoscalingImpl
  Quantity_resource_coreImpl(this)
...
fun MetricValueStatus.averageValue(init: Quantity.() -> Unit) {
  this as MetricValueStatus_v2beta2_autoscalingImpl
  Quantity_resource_coreImpl(this)
    .also { averageValue = it }
    .apply(init)
}
...
fun MutatingWebhook.clientConfig(init: WebhookClientConfig.() -> Unit) {
  this as MutatingWebhook_v1_admissionregistration_k8s_ioImpl
  WebhookClientConfig_v1_admissionregistration_k8s_ioImpl(this)
...
fun MutatingWebhook.rules(init: RuleWithOperations.() -> Unit) {
  this as MutatingWebhook_v1_admissionregistration_k8s_ioImpl
  RuleWithOperations_v1_admissionregistration_k8s_ioImpl(this)
    .also { rules = rules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun NamespaceCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as NamespaceCondition_v1_coreImpl
  Time_v1_metaImpl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun NetworkPolicyEgressRule.ports(init: NetworkPolicyPort.() -> Unit) {
  this as NetworkPolicyEgressRule_v1_networking_k8s_ioImpl
  NetworkPolicyPort_v1_networking_k8s_ioImpl(this)
    .also { ports = ports?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun NetworkPolicyEgressRule.to(init: NetworkPolicyPeer.() -> Unit) {
  this as NetworkPolicyEgressRule_v1_networking_k8s_ioImpl
  NetworkPolicyPeer_v1_networking_k8s_ioImpl(this)
...
fun NetworkPolicyIngressRule.from(init: NetworkPolicyPeer.() -> Unit) {
  this as NetworkPolicyIngressRule_v1_networking_k8s_ioImpl
  NetworkPolicyPeer_v1_networking_k8s_ioImpl(this)
...
fun NetworkPolicyPeer.ipBlock(init: IPBlock.() -> Unit) {
  this as NetworkPolicyPeer_v1_networking_k8s_ioImpl
  IPBlock_v1_networking_k8s_ioImpl(this)
    .also { ipBlock = it }
    .apply(init)
}
...
fun NetworkPolicyPort.port(string: String) {
  this as NetworkPolicyPort_v1_networking_k8s_ioImpl
  de.loosetie.k8s.dsl.types.IntOrString(string)
    .also { port = it }
}
...
fun NodeAffinity.preferredDuringSchedulingIgnoredDuringExecution(init: PreferredSchedulingTerm.() -> Unit) {
  this as NodeAffinity_v1_coreImpl
  PreferredSchedulingTerm_v1_coreImpl(this)
...
fun NodeCondition.lastHeartbeatTime(init: Time.() -> Unit) {
  this as NodeCondition_v1_coreImpl
  Time_v1_metaImpl(this)
...
fun NodeConfigSource.configMap(init: ConfigMapNodeConfigSource.() -> Unit) {
  this as NodeConfigSource_v1_coreImpl
  ConfigMapNodeConfigSource_v1_coreImpl(this)
    .also { configMap = it }
    .apply(init)
}
...
fun NodeConfigStatus.active(init: NodeConfigSource.() -> Unit) {
  this as NodeConfigStatus_v1_coreImpl
  NodeConfigSource_v1_coreImpl(this)
    .also { active = it }
    .apply(init)
}
...
fun NodeDaemonEndpoints.kubeletEndpoint(init: DaemonEndpoint.() -> Unit) {
  this as NodeDaemonEndpoints_v1_coreImpl
  DaemonEndpoint_v1_coreImpl(this)
...
fun NodeSelector.nodeSelectorTerms(init: NodeSelectorTerm.() -> Unit) {
  this as NodeSelector_v1_coreImpl
  NodeSelectorTerm_v1_coreImpl(this)
...
fun NodeSelectorTerm.matchExpressions(init: NodeSelectorRequirement.() -> Unit) {
  this as NodeSelectorTerm_v1_coreImpl
  NodeSelectorRequirement_v1_coreImpl(this)
    .also { matchExpressions = matchExpressions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun ObjectMeta.creationTimestamp(init: Time.() -> Unit) {
  this as ObjectMeta_v1_metaImpl
  Time_v1_metaImpl(this)
...
fun ObjectMeta.managedFields(init: ManagedFieldsEntry.() -> Unit) {
  this as ObjectMeta_v1_metaImpl
  ManagedFieldsEntry_v1_metaImpl(this)
...
fun ObjectMeta.ownerReferences(init: OwnerReference.() -> Unit) {
  this as ObjectMeta_v1_metaImpl
  OwnerReference_v1_metaImpl(this)
...
/**  */
@K8sDslMarker
fun ObjectMetricSource.describedObject(init: CrossVersionObjectReference_v2beta2_autoscaling.() -> Unit) {
  this as ObjectMetricSource_v2beta2_autoscalingImpl
  CrossVersionObjectReference_v2beta2_autoscalingImpl(this)
...
fun ObjectMetricStatus.current(init: MetricValueStatus.() -> Unit) {
  this as ObjectMetricStatus_v2beta2_autoscalingImpl
  MetricValueStatus_v2beta2_autoscalingImpl(this)
    .also { current = it }
    .apply(init)
}
...
/**  */
@K8sDslMarker
fun ObjectMetricStatus.describedObject(init: CrossVersionObjectReference_v2beta2_autoscaling.() -> Unit) {
  this as ObjectMetricStatus_v2beta2_autoscalingImpl
  CrossVersionObjectReference_v2beta2_autoscalingImpl(this)
    .also { describedObject = it }
    .apply(init)
...
fun Overhead.podFixed(init: de.loosetie.k8s.dsl.types.LimitsAndRequests.() -> Unit) {
  this as Overhead_v1beta1_node_k8s_ioImpl
...
fun PersistentVolumeClaimCondition.lastProbeTime(init: Time.() -> Unit) {
  this as PersistentVolumeClaimCondition_v1_coreImpl
  Time_v1_metaImpl(this)
    .also { lastProbeTime = it }
    .apply(init)
}
...
fun PodAffinity.preferredDuringSchedulingIgnoredDuringExecution(init: WeightedPodAffinityTerm.() -> Unit) {
  this as PodAffinity_v1_coreImpl
  WeightedPodAffinityTerm_v1_coreImpl(this)
    .also { preferredDuringSchedulingIgnoredDuringExecution = preferredDuringSchedulingIgnoredDuringExecution?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun PodAffinity.requiredDuringSchedulingIgnoredDuringExecution(init: PodAffinityTerm.() -> Unit) {
  this as PodAffinity_v1_coreImpl
  PodAffinityTerm_v1_coreImpl(this)
...
fun PodAffinityTerm.labelSelector(init: LabelSelector.() -> Unit) {
  this as PodAffinityTerm_v1_coreImpl
  LabelSelector_v1_metaImpl(this)
...
fun PodAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution(init: WeightedPodAffinityTerm.() -> Unit) {
  this as PodAntiAffinity_v1_coreImpl
  WeightedPodAffinityTerm_v1_coreImpl(this)
    .also { preferredDuringSchedulingIgnoredDuringExecution = preferredDuringSchedulingIgnoredDuringExecution?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun PodCondition.lastProbeTime(init: Time.() -> Unit) {
  this as PodCondition_v1_coreImpl
  Time_v1_metaImpl(this)
    .also { lastProbeTime = it }
    .apply(init)
}
...
fun PodDNSConfig.options(init: PodDNSConfigOption.() -> Unit) {
  this as PodDNSConfig_v1_coreImpl
  PodDNSConfigOption_v1_coreImpl(this)
...
fun PodSecurityContext.seLinuxOptions(init: SELinuxOptions.() -> Unit) {
  this as PodSecurityContext_v1_coreImpl
  SELinuxOptions_v1_coreImpl(this)
...
fun PodSecurityContext.windowsOptions(init: WindowsSecurityContextOptions.() -> Unit) {
  this as PodSecurityContext_v1_coreImpl
  WindowsSecurityContextOptions_v1_coreImpl(this)
...
fun PodsMetricSource.metric(init: MetricIdentifier.() -> Unit) {
  this as PodsMetricSource_v2beta2_autoscalingImpl
  MetricIdentifier_v2beta2_autoscalingImpl(this)
    .also { metric = it }
    .apply(init)
}
...
fun PodsMetricStatus.current(init: MetricValueStatus.() -> Unit) {
  this as PodsMetricStatus_v2beta2_autoscalingImpl
  MetricValueStatus_v2beta2_autoscalingImpl(this)
    .also { current = it }
    .apply(init)
}
...
fun PolicyRulesWithSubjects.nonResourceRules(init: NonResourcePolicyRule.() -> Unit) {
  this as PolicyRulesWithSubjects_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  NonResourcePolicyRule_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
...
fun PolicyRulesWithSubjects.resourceRules(init: ResourcePolicyRule.() -> Unit) {
  this as PolicyRulesWithSubjects_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  ResourcePolicyRule_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
...
fun PolicyRulesWithSubjects.subjects(init: Subject.() -> Unit) {
  this as PolicyRulesWithSubjects_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  Subject_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { subjects = subjects?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun PreferredSchedulingTerm.preference(init: NodeSelectorTerm.() -> Unit) {
  this as PreferredSchedulingTerm_v1_coreImpl
  NodeSelectorTerm_v1_coreImpl(this)
    .also { preference = it }
    .apply(init)
}
...
fun PriorityLevelConfigurationCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as PriorityLevelConfigurationCondition_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  Time_v1_metaImpl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun ProjectedVolumeSource.sources(init: VolumeProjection.() -> Unit) {
  this as ProjectedVolumeSource_v1_coreImpl
  VolumeProjection_v1_coreImpl(this)
...
fun RBDPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as RBDPersistentVolumeSource_v1_coreImpl
  SecretReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun RBDVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as RBDVolumeSource_v1_coreImpl
  LocalObjectReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun ReplicaSetCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as ReplicaSetCondition_v1_appsImpl
  Time_v1_metaImpl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun ReplicationControllerCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as ReplicationControllerCondition_v1_coreImpl
  Time_v1_metaImpl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun ResourceFieldSelector.divisor(init: Quantity.() -> Unit) {
  this as ResourceFieldSelector_v1_coreImpl
  Quantity_resource_coreImpl(this)
    .also { divisor = it }
    .apply(init)
}
...
fun ResourceMetricSource.target(init: MetricTarget.() -> Unit) {
  this as ResourceMetricSource_v2beta2_autoscalingImpl
  MetricTarget_v2beta2_autoscalingImpl(this)
    .also { target = it }
    .apply(init)
}
...
fun ResourceMetricStatus.current(init: MetricValueStatus.() -> Unit) {
  this as ResourceMetricStatus_v2beta2_autoscalingImpl
  MetricValueStatus_v2beta2_autoscalingImpl(this)
    .also { current = it }
    .apply(init)
}
...
fun ResourceRequirements.limits(init: de.loosetie.k8s.dsl.types.LimitsAndRequests.() -> Unit) {
  this as ResourceRequirements_v1_coreImpl
  de.loosetie.k8s.dsl.types.LimitsAndRequests(this)
    .also { limits = it }
    .apply(init)
}
...
fun RunAsGroupStrategyOptions.ranges(init: IDRange.() -> Unit) {
  this as RunAsGroupStrategyOptions_v1beta1_policyImpl
  IDRange_v1beta1_policyImpl(this)
    .also { ranges = ranges?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun RunAsUserStrategyOptions.ranges(init: IDRange.() -> Unit) {
  this as RunAsUserStrategyOptions_v1beta1_policyImpl
  IDRange_v1beta1_policyImpl(this)
    .also { ranges = ranges?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun SELinuxStrategyOptions.seLinuxOptions(init: SELinuxOptions.() -> Unit) {
  this as SELinuxStrategyOptions_v1beta1_policyImpl
  SELinuxOptions_v1_coreImpl(this)
    .also { seLinuxOptions = it }
    .apply(init)
}
...
fun Scale.metadata(init: ObjectMeta.() -> Unit) {
  this as Scale_v1beta2_appsImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status. */
@K8sDslMarker
fun Scale.spec(init: Scalespec_v1beta1_apps.() -> Unit) {
  this as Scale_v1beta2_appsImpl
  Scalespec_v1beta1_appsImpl(this)
    .also { spec = it }
    .apply(init)
}
...
@K8sDslMarker
fun Scale.status(init: Scalestatus_v1beta1_apps.() -> Unit) {
  this as Scale_v1beta2_appsImpl
  Scalestatus_v1beta1_appsImpl(this)
    .also { status = it }
    .apply(init)
}
...
fun ScaleIOPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as ScaleIOPersistentVolumeSource_v1_coreImpl
  SecretReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun ScaleIOVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as ScaleIOVolumeSource_v1_coreImpl
  LocalObjectReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun Scheduling.tolerations(init: Toleration.() -> Unit) {
  this as Scheduling_v1beta1_node_k8s_ioImpl
  Toleration_v1_coreImpl(this)
...
fun ScopeSelector.matchExpressions(init: ScopedResourceSelectorRequirement.() -> Unit) {
  this as ScopeSelector_v1_coreImpl
  ScopedResourceSelectorRequirement_v1_coreImpl(this)
    .also { matchExpressions = matchExpressions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun SecretProjection.items(init: KeyToPath.() -> Unit) {
  this as SecretProjection_v1_coreImpl
  KeyToPath_v1_coreImpl(this)
    .also { items = items?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun SecretVolumeSource.items(init: KeyToPath.() -> Unit) {
  this as SecretVolumeSource_v1_coreImpl
  KeyToPath_v1_coreImpl(this)
    .also { items = items?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun SecurityContext.capabilities(init: Capabilities.() -> Unit) {
  this as SecurityContext_v1_coreImpl
  Capabilities_v1_coreImpl(this)
...
fun ServicePort.targetPort(string: String) {
  this as ServicePort_v1_coreImpl
  de.loosetie.k8s.dsl.types.IntOrString(string)
    .also { targetPort = it }
}
...
fun SessionAffinityConfig.clientIP(init: ClientIPConfig.() -> Unit) {
  this as SessionAffinityConfig_v1_coreImpl
  ClientIPConfig_v1_coreImpl(this)
    .also { clientIP = it }
    .apply(init)
}
...
fun StatefulSetCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as StatefulSetCondition_v1_appsImpl
  Time_v1_metaImpl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun StatefulSetUpdateStrategy.rollingUpdate(init: RollingUpdateStatefulSetStrategy.() -> Unit) {
  this as StatefulSetUpdateStrategy_v1_appsImpl
  RollingUpdateStatefulSetStrategy_v1_appsImpl(this)
    .also { rollingUpdate = it }
    .apply(init)
}
...
fun Status.details(init: StatusDetails.() -> Unit) {
  this as Status_v1_metaImpl
  StatusDetails_v1_metaImpl(this)
    .also { details = it }
    .apply(init)
}
...
fun StatusDetails.causes(init: StatusCause.() -> Unit) {
  this as StatusDetails_v1_metaImpl
  StatusCause_v1_metaImpl(this)
...
fun StorageOSPersistentVolumeSource.secretRef(init: ObjectReference.() -> Unit) {
  this as StorageOSPersistentVolumeSource_v1_coreImpl
  ObjectReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun StorageOSVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as StorageOSVolumeSource_v1_coreImpl
  LocalObjectReference_v1_coreImpl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun Subject.group(init: GroupSubject.() -> Unit) {
  this as Subject_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  GroupSubject_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { group = it }
    .apply(init)
}
...
fun Subject.serviceAccount(init: ServiceAccountSubject.() -> Unit) {
  this as Subject_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  ServiceAccountSubject_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
...
fun Subject.user(init: UserSubject.() -> Unit) {
  this as Subject_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  UserSubject_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { user = it }
    .apply(init)
}
...
fun SubjectRulesReviewStatus.nonResourceRules(init: NonResourceRule.() -> Unit) {
  this as SubjectRulesReviewStatus_v1_authorization_k8s_ioImpl
  NonResourceRule_v1_authorization_k8s_ioImpl(this)
    .also { nonResourceRules = nonResourceRules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun SubjectRulesReviewStatus.resourceRules(init: ResourceRule.() -> Unit) {
  this as SubjectRulesReviewStatus_v1_authorization_k8s_ioImpl
  ResourceRule_v1_authorization_k8s_ioImpl(this)
    .also { resourceRules = resourceRules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun SupplementalGroupsStrategyOptions.ranges(init: IDRange.() -> Unit) {
  this as SupplementalGroupsStrategyOptions_v1beta1_policyImpl
  IDRange_v1beta1_policyImpl(this)
    .also { ranges = ranges?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun TCPSocketAction.port(string: String) {
  this as TCPSocketAction_v1_coreImpl
  de.loosetie.k8s.dsl.types.IntOrString(string)
    .also { port = it }
}
...
fun TopologySelectorTerm.matchLabelExpressions(init: TopologySelectorLabelRequirement.() -> Unit) {
  this as TopologySelectorTerm_v1_coreImpl
  TopologySelectorLabelRequirement_v1_coreImpl(this)
...
fun TopologySpreadConstraint.labelSelector(init: LabelSelector.() -> Unit) {
  this as TopologySpreadConstraint_v1_coreImpl
  LabelSelector_v1_metaImpl(this)
    .also { labelSelector = it }
    .apply(init)
}
...
fun ValidatingWebhook.clientConfig(init: WebhookClientConfig.() -> Unit) {
  this as ValidatingWebhook_v1_admissionregistration_k8s_ioImpl
  WebhookClientConfig_v1_admissionregistration_k8s_ioImpl(this)
    .also { clientConfig = it }
    .apply(init)
}
...
fun VolumeAttachmentSource.inlineVolumeSpec(init: Persistentvolumespec.() -> Unit) {
  this as VolumeAttachmentSource_v1_storage_k8s_ioImpl
  Persistentvolumespec_v1_coreImpl(this)
...
fun VolumeError.time(init: Time.() -> Unit) {
  this as VolumeError_v1_storage_k8s_ioImpl
  Time_v1_metaImpl(this)
    .also { time = it }
    .apply(init)
}
...
fun VolumeNodeAffinity.required(init: NodeSelector.() -> Unit) {
  this as VolumeNodeAffinity_v1_coreImpl
  NodeSelector_v1_coreImpl(this)
    .also { required = it }
    .apply(init)
}
...
fun VolumeProjection.configMap(init: ConfigMapProjection.() -> Unit) {
  this as VolumeProjection_v1_coreImpl
  ConfigMapProjection_v1_coreImpl(this)
    .also { configMap = it }
    .apply(init)
}
...
fun VolumeProjection.downwardAPI(init: DownwardAPIProjection.() -> Unit) {
  this as VolumeProjection_v1_coreImpl
  DownwardAPIProjection_v1_coreImpl(this)
    .also { downwardAPI = it }
    .apply(init)
}
...
fun VolumeProjection.secret(init: SecretProjection.() -> Unit) {
  this as VolumeProjection_v1_coreImpl
  SecretProjection_v1_coreImpl(this)
    .also { secret = it }
    .apply(init)
}
...
fun VolumeProjection.serviceAccountToken(init: ServiceAccountTokenProjection.() -> Unit) {
  this as VolumeProjection_v1_coreImpl
  ServiceAccountTokenProjection_v1_coreImpl(this)
...
@K8sDslMarker
fun Webhook.clientConfig(init: WebhookClientConfig_v1alpha1_auditregistration_k8s_io.() -> Unit) {
  this as Webhook_v1alpha1_auditregistration_k8s_ioImpl
  WebhookClientConfig_v1alpha1_auditregistration_k8s_ioImpl(this)
    .also { clientConfig = it }
    .apply(init)
}
...
fun Webhook.throttle(init: WebhookThrottleConfig.() -> Unit) {
  this as Webhook_v1alpha1_auditregistration_k8s_ioImpl
  WebhookThrottleConfig_v1alpha1_auditregistration_k8s_ioImpl(this)
    .also { throttle = it }
    .apply(init)
}
...
fun WebhookClientConfig.service(init: ServiceReference.() -> Unit) {
  this as WebhookClientConfig_v1_admissionregistration_k8s_ioImpl
  ServiceReference_v1_admissionregistration_k8s_ioImpl(this)
    .also { service = it }
    .apply(init)
}
...
@K8sDslMarker
fun WebhookConversion.clientConfig(init: WebhookClientConfig_v1_apiextensions_k8s_io.() -> Unit) {
  this as WebhookConversion_v1_apiextensions_k8s_ioImpl
  WebhookClientConfig_v1_apiextensions_k8s_ioImpl(this)
    .also { clientConfig = it }
    .apply(init)
}
...
fun WeightedPodAffinityTerm.podAffinityTerm(init: PodAffinityTerm.() -> Unit) {
  this as WeightedPodAffinityTerm_v1_coreImpl
  PodAffinityTerm_v1_coreImpl(this)
...
running within the cluster, then you should use `service`. */
@K8sDslMarker
fun WebhookClientConfig_v1alpha1_auditregistration_k8s_io.service(init: ServiceReference_v1alpha1_auditregistration_k8s_io.() -> Unit) {
  this as WebhookClientConfig_v1alpha1_auditregistration_k8s_ioImpl
  ServiceReference_v1alpha1_auditregistration_k8s_ioImpl(this)
    .also { service = it }
    .apply(init)
}
...
running within the cluster, then you should use `service`. */
@K8sDslMarker
fun WebhookClientConfig_v1_apiextensions_k8s_io.service(init: ServiceReference_v1_apiextensions_k8s_io.() -> Unit) {
  this as WebhookClientConfig_v1_apiextensions_k8s_ioImpl
  ServiceReference_v1_apiextensions_k8s_ioImpl(this)
    .also { service = it }
    .apply(init)
}
...
fun Cronjobspec.jobTemplate(init: JobTemplateSpec.() -> Unit) {
  this as Cronjobspec_v1beta1_batchImpl
  JobTemplateSpec_v1beta1_batchImpl(this)
    .also { jobTemplate = it }
    .apply(init)
}
...
fun Cronjobstatus.active(init: ObjectReference.() -> Unit) {
  this as Cronjobstatus_v1beta1_batchImpl
  ObjectReference_v1_coreImpl(this)
...
fun Daemonsetspec.selector(init: LabelSelector.() -> Unit) {
  this as Daemonsetspec_v1_appsImpl
  LabelSelector_v1_metaImpl(this)
    .also { selector = it }
    .apply(init)
}
...
fun Daemonsetspec.updateStrategy(init: DaemonSetUpdateStrategy.() -> Unit) {
  this as Daemonsetspec_v1_appsImpl
  DaemonSetUpdateStrategy_v1_appsImpl(this)
...
fun Daemonsetstatus.conditions(init: DaemonSetCondition.() -> Unit) {
  this as Daemonsetstatus_v1_appsImpl
  DaemonSetCondition_v1_appsImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Deploymentspec.selector(init: LabelSelector.() -> Unit) {
  this as Deploymentspec_v1_appsImpl
  LabelSelector_v1_metaImpl(this)
    .also { selector = it }
    .apply(init)
}
...
fun Deploymentspec.strategy(init: Deploymentstrategy.() -> Unit) {
  this as Deploymentspec_v1_appsImpl
  Deploymentstrategy_v1_appsImpl(this)
    .also { strategy = it }
    .apply(init)
}
...
fun Deploymentstatus.conditions(init: DeploymentCondition.() -> Unit) {
  this as Deploymentstatus_v1_appsImpl
  DeploymentCondition_v1_appsImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Jobstatus.completionTime(init: Time.() -> Unit) {
  this as Jobstatus_v1_batchImpl
  Time_v1_metaImpl(this)
...
fun Jobstatus.conditions(init: JobCondition.() -> Unit) {
  this as Jobstatus_v1_batchImpl
  JobCondition_v1_batchImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Podspec.affinity(init: Affinity.() -> Unit) {
  this as Podspec_v1_coreImpl
  Affinity_v1_coreImpl(this)
    .also { affinity = it }
    .apply(init)
}
...
fun Podspec.ephemeralContainers(init: EphemeralContainer.() -> Unit) {
  this as Podspec_v1_coreImpl
  EphemeralContainer_v1_coreImpl(this)
...
fun Podspec.readinessGates(init: PodReadinessGate.() -> Unit) {
  this as Podspec_v1_coreImpl
  PodReadinessGate_v1_coreImpl(this)
...
fun Podspec.securityContext(init: PodSecurityContext.() -> Unit) {
  this as Podspec_v1_coreImpl
  PodSecurityContext_v1_coreImpl(this)
    .also { securityContext = it }
    .apply(init)
}
...
fun Podspec.topologySpreadConstraints(init: TopologySpreadConstraint.() -> Unit) {
  this as Podspec_v1_coreImpl
  TopologySpreadConstraint_v1_coreImpl(this)
...
fun Podstatus.conditions(init: PodCondition.() -> Unit) {
  this as Podstatus_v1_coreImpl
  PodCondition_v1_coreImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Podstatus.containerStatuses(init: Containerstatus.() -> Unit) {
  this as Podstatus_v1_coreImpl
  Containerstatus_v1_coreImpl(this)
...
fun Replicasetspec.selector(init: LabelSelector.() -> Unit) {
  this as Replicasetspec_v1_appsImpl
  LabelSelector_v1_metaImpl(this)
    .also { selector = it }
    .apply(init)
}
...
fun Replicasetstatus.conditions(init: ReplicaSetCondition.() -> Unit) {
  this as Replicasetstatus_v1_appsImpl
  ReplicaSetCondition_v1_appsImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Replicationcontrollerspec.template(init: Podtemplatespec.() -> Unit) {
  this as Replicationcontrollerspec_v1_coreImpl
  Podtemplatespec_v1_coreImpl(this)
    .also { template = it }
    .apply(init)
}
...
fun Replicationcontrollerstatus.conditions(init: ReplicationControllerCondition.() -> Unit) {
  this as Replicationcontrollerstatus_v1_coreImpl
  ReplicationControllerCondition_v1_coreImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Statefulsetspec.selector(init: LabelSelector.() -> Unit) {
  this as Statefulsetspec_v1_appsImpl
  LabelSelector_v1_metaImpl(this)
    .also { selector = it }
    .apply(init)
}
...
fun Statefulsetspec.updateStrategy(init: StatefulSetUpdateStrategy.() -> Unit) {
  this as Statefulsetspec_v1_appsImpl
  StatefulSetUpdateStrategy_v1_appsImpl(this)
    .also { updateStrategy = it }
    .apply(init)
}
...
fun Statefulsetspec.volumeClaimTemplates(init: PersistentVolumeClaim.() -> Unit) {
  this as Statefulsetspec_v1_appsImpl
  PersistentVolumeClaim_v1_coreImpl(this)
...
fun Statefulsetstatus.conditions(init: StatefulSetCondition.() -> Unit) {
  this as Statefulsetstatus_v1_appsImpl
  StatefulSetCondition_v1_appsImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Ingressspec.backend(init: IngressBackend.() -> Unit) {
  this as Ingressspec_v1beta1_networking_k8s_ioImpl
  IngressBackend_v1beta1_networking_k8s_ioImpl(this)
    .also { backend = it }
    .apply(init)
}
...
fun Ingressspec.rules(init: IngressRule.() -> Unit) {
  this as Ingressspec_v1beta1_networking_k8s_ioImpl
  IngressRule_v1beta1_networking_k8s_ioImpl(this)
    .also { rules = rules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Ingressspec.tls(init: IngressTLS.() -> Unit) {
  this as Ingressspec_v1beta1_networking_k8s_ioImpl
  IngressTLS_v1beta1_networking_k8s_ioImpl(this)
...
fun Ingressstatus.loadBalancer(init: LoadBalancerStatus.() -> Unit) {
  this as Ingressstatus_v1beta1_networking_k8s_ioImpl
  LoadBalancerStatus_v1_coreImpl(this)
...
fun Servicespec.ports(init: ServicePort.() -> Unit) {
  this as Servicespec_v1_coreImpl
  ServicePort_v1_coreImpl(this)
    .also { ports = ports?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Servicespec.sessionAffinityConfig(init: SessionAffinityConfig.() -> Unit) {
  this as Servicespec_v1_coreImpl
  SessionAffinityConfig_v1_coreImpl(this)
...
fun Servicestatus.loadBalancer(init: LoadBalancerStatus.() -> Unit) {
  this as Servicestatus_v1_coreImpl
  LoadBalancerStatus_v1_coreImpl(this)
    .also { loadBalancer = it }
    .apply(init)
}
...
fun Csinodespec.drivers(init: CSINodeDriver.() -> Unit) {
  this as Csinodespec_v1_storage_k8s_ioImpl
  CSINodeDriver_v1_storage_k8s_ioImpl(this)
...
fun Persistentvolumeclaimspec.dataSource(init: TypedLocalObjectReference.() -> Unit) {
  this as Persistentvolumeclaimspec_v1_coreImpl
  TypedLocalObjectReference_v1_coreImpl(this)
    .also { dataSource = it }
    .apply(init)
}
...
fun Persistentvolumeclaimstatus.conditions(init: PersistentVolumeClaimCondition.() -> Unit) {
  this as Persistentvolumeclaimstatus_v1_coreImpl
  PersistentVolumeClaimCondition_v1_coreImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Volumeattachmentspec.source(init: VolumeAttachmentSource.() -> Unit) {
  this as Volumeattachmentspec_v1_storage_k8s_ioImpl
  VolumeAttachmentSource_v1_storage_k8s_ioImpl(this)
    .also { source = it }
    .apply(init)
}
...
fun Volumeattachmentstatus.attachError(init: VolumeError.() -> Unit) {
  this as Volumeattachmentstatus_v1_storage_k8s_ioImpl
  VolumeError_v1_storage_k8s_ioImpl(this)
    .also { attachError = it }
    .apply(init)
}
...
fun Customresourcedefinitionspec.conversion(init: CustomResourceConversion.() -> Unit) {
  this as Customresourcedefinitionspec_v1_apiextensions_k8s_ioImpl
  CustomResourceConversion_v1_apiextensions_k8s_ioImpl(this)
    .also { conversion = it }
    .apply(init)
}
...
fun Customresourcedefinitionspec.names(init: CustomResourceDefinitionNames.() -> Unit) {
  this as Customresourcedefinitionspec_v1_apiextensions_k8s_ioImpl
  CustomResourceDefinitionNames_v1_apiextensions_k8s_ioImpl(this)
    .also { names = it }
    .apply(init)
}
...
fun Customresourcedefinitionspec.versions(init: CustomResourceDefinitionVersion.() -> Unit) {
  this as Customresourcedefinitionspec_v1_apiextensions_k8s_ioImpl
  CustomResourceDefinitionVersion_v1_apiextensions_k8s_ioImpl(this)
    .also { versions = versions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Customresourcedefinitionstatus.acceptedNames(init: CustomResourceDefinitionNames.() -> Unit) {
  this as Customresourcedefinitionstatus_v1_apiextensions_k8s_ioImpl
  CustomResourceDefinitionNames_v1_apiextensions_k8s_ioImpl(this)
...
fun Customresourcedefinitionstatus.conditions(init: CustomResourceDefinitionCondition.() -> Unit) {
  this as Customresourcedefinitionstatus_v1_apiextensions_k8s_ioImpl
  CustomResourceDefinitionCondition_v1_apiextensions_k8s_ioImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Limitrangespec.limits(init: LimitRangeItem.() -> Unit) {
  this as Limitrangespec_v1_coreImpl
  LimitRangeItem_v1_coreImpl(this)
...
fun Horizontalpodautoscalerspec.scaleTargetRef(init: CrossVersionObjectReference.() -> Unit) {
  this as Horizontalpodautoscalerspec_v1_autoscalingImpl
  CrossVersionObjectReference_v1_autoscalingImpl(this)
...
fun Horizontalpodautoscalerstatus.lastScaleTime(init: Time.() -> Unit) {
  this as Horizontalpodautoscalerstatus_v1_autoscalingImpl
  Time_v1_metaImpl(this)
...
fun Podtemplatespec.metadata(init: ObjectMeta.() -> Unit) {
  this as Podtemplatespec_v1_coreImpl
  ObjectMeta_v1_metaImpl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Poddisruptionbudgetspec.selector(init: LabelSelector.() -> Unit) {
  this as Poddisruptionbudgetspec_v1beta1_policyImpl
  LabelSelector_v1_metaImpl(this)
    .also { selector = it }
    .apply(init)
}
...
fun Podpresetspec.env(init: EnvVar.() -> Unit) {
  this as Podpresetspec_v1alpha1_settings_k8s_ioImpl
  EnvVar_v1_coreImpl(this)
    .also { env = env?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Podsecuritypolicyspec.allowedCSIDrivers(init: AllowedCSIDriver.() -> Unit) {
  this as Podsecuritypolicyspec_v1beta1_policyImpl
  AllowedCSIDriver_v1beta1_policyImpl(this)
...
fun Podsecuritypolicyspec.allowedFlexVolumes(init: AllowedFlexVolume.() -> Unit) {
  this as Podsecuritypolicyspec_v1beta1_policyImpl
  AllowedFlexVolume_v1beta1_policyImpl(this)
...
fun Podsecuritypolicyspec.allowedHostPaths(init: AllowedHostPath.() -> Unit) {
  this as Podsecuritypolicyspec_v1beta1_policyImpl
  AllowedHostPath_v1beta1_policyImpl(this)
...
fun Podsecuritypolicyspec.fsGroup(init: FSGroupStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_v1beta1_policyImpl
  FSGroupStrategyOptions_v1beta1_policyImpl(this)
    .also { fsGroup = it }
    .apply(init)
}
...
fun Podsecuritypolicyspec.hostPorts(init: HostPortRange.() -> Unit) {
  this as Podsecuritypolicyspec_v1beta1_policyImpl
  HostPortRange_v1beta1_policyImpl(this)
...
fun Podsecuritypolicyspec.runAsGroup(init: RunAsGroupStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_v1beta1_policyImpl
  RunAsGroupStrategyOptions_v1beta1_policyImpl(this)
    .also { runAsGroup = it }
    .apply(init)
}
...
fun Podsecuritypolicyspec.runAsUser(init: RunAsUserStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_v1beta1_policyImpl
  RunAsUserStrategyOptions_v1beta1_policyImpl(this)
    .also { runAsUser = it }
    .apply(init)
}
...
fun Podsecuritypolicyspec.runtimeClass(init: RuntimeClassStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_v1beta1_policyImpl
  RuntimeClassStrategyOptions_v1beta1_policyImpl(this)
...
fun Podsecuritypolicyspec.seLinux(init: SELinuxStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_v1beta1_policyImpl
  SELinuxStrategyOptions_v1beta1_policyImpl(this)
    .also { seLinux = it }
    .apply(init)
}
...
fun Podsecuritypolicyspec.supplementalGroups(init: SupplementalGroupsStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_v1beta1_policyImpl
  SupplementalGroupsStrategyOptions_v1beta1_policyImpl(this)
...
@K8sDslMarker
fun Apiservicespec.service(init: ServiceReference_v1_apiregistration_k8s_io.() -> Unit) {
  this as Apiservicespec_v1_apiregistration_k8s_ioImpl
  ServiceReference_v1_apiregistration_k8s_ioImpl(this)
    .also { service = it }
    .apply(init)
}
...
fun Apiservicestatus.conditions(init: APIServiceCondition.() -> Unit) {
  this as Apiservicestatus_v1_apiregistration_k8s_ioImpl
  APIServiceCondition_v1_apiregistration_k8s_ioImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Auditsinkspec.policy(init: Policy.() -> Unit) {
  this as Auditsinkspec_v1alpha1_auditregistration_k8s_ioImpl
  Policy_v1alpha1_auditregistration_k8s_ioImpl(this)
    .also { policy = it }
    .apply(init)
}
...
fun Auditsinkspec.webhook(init: Webhook.() -> Unit) {
  this as Auditsinkspec_v1alpha1_auditregistration_k8s_ioImpl
  Webhook_v1alpha1_auditregistration_k8s_ioImpl(this)
    .also { webhook = it }
    .apply(init)
}
...
fun Certificatesigningrequeststatus.conditions(init: CertificateSigningRequestCondition.() -> Unit) {
  this as Certificatesigningrequeststatus_v1beta1_certificates_k8s_ioImpl
  CertificateSigningRequestCondition_v1beta1_certificates_k8s_ioImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Flowschemaspec.distinguisherMethod(init: FlowDistinguisherMethod.() -> Unit) {
  this as Flowschemaspec_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  FlowDistinguisherMethod_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
...
fun Flowschemaspec.priorityLevelConfiguration(init: PriorityLevelConfigurationReference.() -> Unit) {
  this as Flowschemaspec_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  PriorityLevelConfigurationReference_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
...
fun Flowschemaspec.rules(init: PolicyRulesWithSubjects.() -> Unit) {
  this as Flowschemaspec_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  PolicyRulesWithSubjects_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { rules = rules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Flowschemastatus.conditions(init: FlowSchemaCondition.() -> Unit) {
  this as Flowschemastatus_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  FlowSchemaCondition_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Leasespec.acquireTime(init: MicroTime.() -> Unit) {
  this as Leasespec_v1_coordination_k8s_ioImpl
  MicroTime_v1_metaImpl(this)
    .also { acquireTime = it }
    .apply(init)
}
...
fun Subjectaccessreviewspec.nonResourceAttributes(init: NonResourceAttributes.() -> Unit) {
  this as Subjectaccessreviewspec_v1_authorization_k8s_ioImpl
  NonResourceAttributes_v1_authorization_k8s_ioImpl(this)
...
fun Subjectaccessreviewspec.resourceAttributes(init: ResourceAttributes.() -> Unit) {
  this as Subjectaccessreviewspec_v1_authorization_k8s_ioImpl
  ResourceAttributes_v1_authorization_k8s_ioImpl(this)
...
fun Namespacestatus.conditions(init: NamespaceCondition.() -> Unit) {
  this as Namespacestatus_v1_coreImpl
  NamespaceCondition_v1_coreImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Nodestatus.addresses(init: NodeAddress.() -> Unit) {
  this as Nodestatus_v1_coreImpl
  NodeAddress_v1_coreImpl(this)
    .also { addresses = addresses?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Nodestatus.conditions(init: NodeCondition.() -> Unit) {
  this as Nodestatus_v1_coreImpl
  NodeCondition_v1_coreImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Nodestatus.config(init: NodeConfigStatus.() -> Unit) {
  this as Nodestatus_v1_coreImpl
  NodeConfigStatus_v1_coreImpl(this)
    .also { config = it }
    .apply(init)
}
...
fun Nodestatus.daemonEndpoints(init: NodeDaemonEndpoints.() -> Unit) {
  this as Nodestatus_v1_coreImpl
  NodeDaemonEndpoints_v1_coreImpl(this)
...
fun Nodestatus.images(init: ContainerImage.() -> Unit) {
  this as Nodestatus_v1_coreImpl
  ContainerImage_v1_coreImpl(this)
...
fun Nodestatus.nodeInfo(init: NodeSystemInfo.() -> Unit) {
  this as Nodestatus_v1_coreImpl
  NodeSystemInfo_v1_coreImpl(this)
    .also { nodeInfo = it }
    .apply(init)
}
...
fun Nodestatus.volumesAttached(init: AttachedVolume.() -> Unit) {
  this as Nodestatus_v1_coreImpl
  AttachedVolume_v1_coreImpl(this)
...
fun Persistentvolumespec.awsElasticBlockStore(init: AWSElasticBlockStoreVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  AWSElasticBlockStoreVolumeSource_v1_coreImpl(this)
    .also { awsElasticBlockStore = it }
    .apply(init)
}
...
fun Persistentvolumespec.azureFile(init: AzureFilePersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  AzureFilePersistentVolumeSource_v1_coreImpl(this)
    .also { azureFile = it }
    .apply(init)
}
...
fun Persistentvolumespec.cephfs(init: CephFSPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  CephFSPersistentVolumeSource_v1_coreImpl(this)
    .also { cephfs = it }
    .apply(init)
}
...
fun Persistentvolumespec.cinder(init: CinderPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  CinderPersistentVolumeSource_v1_coreImpl(this)
    .also { cinder = it }
    .apply(init)
}
...
fun Persistentvolumespec.csi(init: CSIPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  CSIPersistentVolumeSource_v1_coreImpl(this)
    .also { csi = it }
    .apply(init)
}
...
fun Persistentvolumespec.flexVolume(init: FlexPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  FlexPersistentVolumeSource_v1_coreImpl(this)
    .also { flexVolume = it }
    .apply(init)
}
...
fun Persistentvolumespec.glusterfs(init: GlusterfsPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  GlusterfsPersistentVolumeSource_v1_coreImpl(this)
    .also { glusterfs = it }
    .apply(init)
}
...
fun Persistentvolumespec.iscsi(init: ISCSIPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  ISCSIPersistentVolumeSource_v1_coreImpl(this)
    .also { iscsi = it }
    .apply(init)
}
...
fun Persistentvolumespec.local(init: LocalVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  LocalVolumeSource_v1_coreImpl(this)
    .also { local = it }
    .apply(init)
}
...
fun Persistentvolumespec.nodeAffinity(init: VolumeNodeAffinity.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  VolumeNodeAffinity_v1_coreImpl(this)
    .also { nodeAffinity = it }
    .apply(init)
}
...
fun Persistentvolumespec.rbd(init: RBDPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  RBDPersistentVolumeSource_v1_coreImpl(this)
    .also { rbd = it }
    .apply(init)
}
...
fun Persistentvolumespec.scaleIO(init: ScaleIOPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  ScaleIOPersistentVolumeSource_v1_coreImpl(this)
    .also { scaleIO = it }
    .apply(init)
}
...
fun Persistentvolumespec.storageos(init: StorageOSPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_v1_coreImpl
  StorageOSPersistentVolumeSource_v1_coreImpl(this)
    .also { storageos = it }
    .apply(init)
}
...
fun Prioritylevelconfigurationspec.limited(init: LimitedPriorityLevelConfiguration.() -> Unit) {
  this as Prioritylevelconfigurationspec_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  LimitedPriorityLevelConfiguration_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { limited = it }
    .apply(init)
}
...
fun Prioritylevelconfigurationstatus.conditions(init: PriorityLevelConfigurationCondition.() -> Unit) {
  this as Prioritylevelconfigurationstatus_v1alpha1_flowcontrol_apiserver_k8s_ioImpl
  PriorityLevelConfigurationCondition_v1alpha1_flowcontrol_apiserver_k8s_ioImpl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Resourcequotaspec.scopeSelector(init: ScopeSelector.() -> Unit) {
  this as Resourcequotaspec_v1_coreImpl
  ScopeSelector_v1_coreImpl(this)
...
fun Selfsubjectaccessreviewspec.nonResourceAttributes(init: NonResourceAttributes.() -> Unit) {
  this as Selfsubjectaccessreviewspec_v1_authorization_k8s_ioImpl
  NonResourceAttributes_v1_authorization_k8s_ioImpl(this)
    .also { nonResourceAttributes = it }
    .apply(init)
}
...
fun Tokenrequestspec.boundObjectRef(init: BoundObjectReference.() -> Unit) {
  this as Tokenrequestspec_v1_authentication_k8s_ioImpl
  BoundObjectReference_v1_authentication_k8s_ioImpl(this)
...
fun Tokenrequeststatus.expirationTimestamp(init: Time.() -> Unit) {
  this as Tokenrequeststatus_v1_authentication_k8s_ioImpl
  Time_v1_metaImpl(this)
...
fun Tokenreviewstatus.user(init: UserInfo.() -> Unit) {
  this as Tokenreviewstatus_v1_authentication_k8s_ioImpl
  UserInfo_v1_authentication_k8s_ioImpl(this)
    .also { user = it }
    .apply(init)
}
...
fun Networkpolicyspec.egress(init: NetworkPolicyEgressRule.() -> Unit) {
  this as Networkpolicyspec_v1_networking_k8s_ioImpl
  NetworkPolicyEgressRule_v1_networking_k8s_ioImpl(this)
...
fun Networkpolicyspec.ingress(init: NetworkPolicyIngressRule.() -> Unit) {
  this as Networkpolicyspec_v1_networking_k8s_ioImpl
  NetworkPolicyIngressRule_v1_networking_k8s_ioImpl(this)
    .also { ingress = ingress?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Rollingupdatedaemonset.maxUnavailable(percentage: String) {
  this as Rollingupdatedaemonset_v1_appsImpl
  de.loosetie.k8s.dsl.types.IntOrPercentage(percentage)
    .also { maxUnavailable = it }
}
...
fun Deploymentstrategy.rollingUpdate(init: Rollingupdatedeployment.() -> Unit) {
  this as Deploymentstrategy_v1_appsImpl
  Rollingupdatedeployment_v1_appsImpl(this)
    .also { rollingUpdate = it }
    .apply(init)
}
...
fun Containerstatus.lastState(init: ContainerState.() -> Unit) {
  this as Containerstatus_v1_coreImpl
  ContainerState_v1_coreImpl(this)
    .also { lastState = it }
    .apply(init)
}
...
fun Rollingupdatedeployment.maxSurge(percentage: String) {
  this as Rollingupdatedeployment_v1_appsImpl
  de.loosetie.k8s.dsl.types.IntOrPercentage(percentage)
    .also { maxSurge = it }
}
