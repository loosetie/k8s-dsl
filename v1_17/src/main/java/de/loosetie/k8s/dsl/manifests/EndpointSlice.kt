...
@K8sDslMarker
interface EndpointSlice_discovery_k8s_io_v1beta1: K8sTopLevel, HasMetadata {
...
an IPv4 Address. `*` IPv6: Represents an IPv6 Address. `*` FQDN: Represents a Fully Qualified Domain Name. */
  ...
  val endpoints: List<Endpoint_discovery_k8s_io_v1beta1>?
...
indicates "all ports". Each slice may include a maximum of 100 ports. */
  val ports: List<EndpointPort_discovery_k8s_io_v1beta1>?
}