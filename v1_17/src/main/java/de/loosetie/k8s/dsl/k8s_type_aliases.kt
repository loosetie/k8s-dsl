...
typealias AuditSink = AuditSink_auditregistration_k8s_io_v1alpha1
typealias Auditsinkspec = Auditsinkspec_auditregistration_k8s_io_v1alpha1
...
typealias CSIDriver = CSIDriver_storage_k8s_io_v1beta1
...
typealias CertificateSigningRequest = CertificateSigningRequest_certificates_k8s_io_v1beta1
typealias CertificateSigningRequestCondition = CertificateSigningRequestCondition_certificates_k8s_io_v1beta1
typealias Certificatesigningrequestspec = Certificatesigningrequestspec_certificates_k8s_io_v1beta1
typealias Certificatesigningrequeststatus = Certificatesigningrequeststatus_certificates_k8s_io_v1beta1
...
typealias CronJob = CronJob_batch_v1beta1
typealias Cronjobspec = Cronjobspec_batch_v1beta1
typealias Cronjobstatus = Cronjobstatus_batch_v1beta1
typealias CrossVersionObjectReference = CrossVersionObjectReference_autoscaling_v1
typealias Csidriverspec = Csidriverspec_storage_k8s_io_v1beta1
...
typealias Endpoint = Endpoint_discovery_k8s_io_v1beta1
typealias EndpointAddress = EndpointAddress_core_v1
typealias EndpointConditions = EndpointConditions_discovery_k8s_io_v1beta1
typealias EndpointPort = EndpointPort_core_v1
typealias EndpointSlice = EndpointSlice_discovery_k8s_io_v1beta1
...
typealias Event = Event_core_v1
typealias EventSeries = EventSeries_core_v1
typealias EventSource = EventSource_core_v1
typealias Eviction = Eviction_policy_v1beta1
typealias ExecAction = ExecAction_core_v1
typealias ExternalDocumentation = ExternalDocumentation_apiextensions_k8s_io_v1
typealias ExternalMetricSource = ExternalMetricSource_autoscaling_v2beta2
typealias ExternalMetricStatus = ExternalMetricStatus_autoscaling_v2beta2
...
typealias FlowDistinguisherMethod = FlowDistinguisherMethod_flowcontrol_apiserver_k8s_io_v1alpha1
typealias FlowSchema = FlowSchema_flowcontrol_apiserver_k8s_io_v1alpha1
typealias FlowSchemaCondition = FlowSchemaCondition_flowcontrol_apiserver_k8s_io_v1alpha1
typealias Flowschemaspec = Flowschemaspec_flowcontrol_apiserver_k8s_io_v1alpha1
typealias Flowschemastatus = Flowschemastatus_flowcontrol_apiserver_k8s_io_v1alpha1
...
typealias GroupSubject = GroupSubject_flowcontrol_apiserver_k8s_io_v1alpha1
...
typealias HTTPIngressPath = HTTPIngressPath_networking_k8s_io_v1beta1
typealias HTTPIngressRuleValue = HTTPIngressRuleValue_networking_k8s_io_v1beta1
typealias Handler = Handler_core_v1
typealias HorizontalPodAutoscaler = HorizontalPodAutoscaler_autoscaling_v1
typealias HorizontalPodAutoscalerCondition = HorizontalPodAutoscalerCondition_autoscaling_v2beta2
typealias Horizontalpodautoscalerspec = Horizontalpodautoscalerspec_autoscaling_v1
typealias Horizontalpodautoscalerstatus = Horizontalpodautoscalerstatus_autoscaling_v1
...
typealias Ingress = Ingress_networking_k8s_io_v1beta1
typealias IngressBackend = IngressBackend_networking_k8s_io_v1beta1
typealias IngressRule = IngressRule_networking_k8s_io_v1beta1
typealias IngressTLS = IngressTLS_networking_k8s_io_v1beta1
typealias Ingressspec = Ingressspec_networking_k8s_io_v1beta1
typealias Ingressstatus = Ingressstatus_networking_k8s_io_v1beta1
...
typealias JobTemplateSpec = JobTemplateSpec_batch_v1beta1
...
typealias LimitResponse = LimitResponse_flowcontrol_apiserver_k8s_io_v1alpha1
typealias LimitedPriorityLevelConfiguration = LimitedPriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1alpha1
...
typealias MetricIdentifier = MetricIdentifier_autoscaling_v2beta2
typealias MetricSpec = MetricSpec_autoscaling_v2beta2
typealias MetricStatus = MetricStatus_autoscaling_v2beta2
typealias MetricTarget = MetricTarget_autoscaling_v2beta2
typealias MetricValueStatus = MetricValueStatus_autoscaling_v2beta2
...
typealias NonResourcePolicyRule = NonResourcePolicyRule_flowcontrol_apiserver_k8s_io_v1alpha1
...
typealias ObjectMetricSource = ObjectMetricSource_autoscaling_v2beta2
typealias ObjectMetricStatus = ObjectMetricStatus_autoscaling_v2beta2
typealias ObjectReference = ObjectReference_core_v1
typealias Overhead = Overhead_node_k8s_io_v1beta1
...
typealias PodDisruptionBudget = PodDisruptionBudget_policy_v1beta1
typealias PodIP = PodIP_core_v1
typealias PodPreset = PodPreset_settings_k8s_io_v1alpha1
...
typealias Poddisruptionbudgetspec = Poddisruptionbudgetspec_policy_v1beta1
typealias Poddisruptionbudgetstatus = Poddisruptionbudgetstatus_policy_v1beta1
typealias Podpresetspec = Podpresetspec_settings_k8s_io_v1alpha1
typealias PodsMetricSource = PodsMetricSource_autoscaling_v2beta2
typealias PodsMetricStatus = PodsMetricStatus_autoscaling_v2beta2
...
typealias Policy = Policy_auditregistration_k8s_io_v1alpha1
typealias PolicyRule = PolicyRule_rbac_authorization_k8s_io_v1
typealias PolicyRulesWithSubjects = PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1alpha1
...
typealias PriorityLevelConfiguration = PriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1alpha1
typealias PriorityLevelConfigurationCondition = PriorityLevelConfigurationCondition_flowcontrol_apiserver_k8s_io_v1alpha1
typealias PriorityLevelConfigurationReference = PriorityLevelConfigurationReference_flowcontrol_apiserver_k8s_io_v1alpha1
typealias Prioritylevelconfigurationspec = Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1alpha1
typealias Prioritylevelconfigurationstatus = Prioritylevelconfigurationstatus_flowcontrol_apiserver_k8s_io_v1alpha1
...
typealias QueuingConfiguration = QueuingConfiguration_flowcontrol_apiserver_k8s_io_v1alpha1
...
typealias ResourceMetricSource = ResourceMetricSource_autoscaling_v2beta2
typealias ResourceMetricStatus = ResourceMetricStatus_autoscaling_v2beta2
typealias ResourcePolicyRule = ResourcePolicyRule_flowcontrol_apiserver_k8s_io_v1alpha1
...
typealias RollbackConfig = RollbackConfig_apps_v1beta1
...
typealias RuntimeClass = RuntimeClass_node_k8s_io_v1beta1
...
typealias Scale = Scale_apps_v1beta2
...
typealias Scheduling = Scheduling_node_k8s_io_v1beta1
...
typealias ServiceAccountSubject = ServiceAccountSubject_flowcontrol_apiserver_k8s_io_v1alpha1
...
typealias Subject = Subject_flowcontrol_apiserver_k8s_io_v1alpha1
...
typealias UserSubject = UserSubject_flowcontrol_apiserver_k8s_io_v1alpha1
...
typealias Webhook = Webhook_auditregistration_k8s_io_v1alpha1
...
typealias WebhookThrottleConfig = WebhookThrottleConfig_auditregistration_k8s_io_v1alpha1
