...
@K8sDslMarker
interface PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1alpha1: K8sManifest {
...
target non-resource URL. */
  val nonResourceRules: List<NonResourcePolicyRule_flowcontrol_apiserver_k8s_io_v1alpha1>?
...
resource. At least one of `resourceRules` and `nonResourceRules` has to be non-empty. */
  val resourceRules: List<ResourcePolicyRule_flowcontrol_apiserver_k8s_io_v1alpha1>?
...
every request. Required. */
  val subjects: List<Subject_flowcontrol_apiserver_k8s_io_v1alpha1>?
}