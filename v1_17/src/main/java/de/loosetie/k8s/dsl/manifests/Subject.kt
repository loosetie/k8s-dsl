...
@K8sDslMarker
interface Subject_flowcontrol_apiserver_k8s_io_v1alpha1: K8sManifest {
  /** Required */
  @K8sDslMarker var kind: String?
  /**  */
  val group: GroupSubject_flowcontrol_apiserver_k8s_io_v1alpha1?
  /**  */
  val serviceAccount: ServiceAccountSubject_flowcontrol_apiserver_k8s_io_v1alpha1?
  /**  */
  val user: UserSubject_flowcontrol_apiserver_k8s_io_v1alpha1?
}
