...
fun AllocationResult.availableOnNodes(init: NodeSelector.() -> Unit) {
  this as AllocationResult_resource_k8s_io_v1alpha1Impl
...
to complete the CSI ControllerExpandVolume call. This is an beta field and requires enabling ExpandCSIVolumes feature
...
complete the CSI NodeExpandVolume call. This is an alpha field and requires enabling CSINodeExpandSecret feature gate.
This field is optional, may be omitted if no secret is required. If the secret object contains more than one secret, all
secrets are passed. */
@K8sDslMarker
...
@K8sDslMarker
fun PodScheduling.metadata(init: ObjectMeta.() -> Unit) {
  this as PodScheduling_resource_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun PodScheduling.spec(init: Podschedulingspec.() -> Unit) {
  this as PodScheduling_resource_k8s_io_v1alpha1Impl
  Podschedulingspec_resource_k8s_io_v1alpha1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
@K8sDslMarker
fun PodScheduling.status(init: Podschedulingstatus.() -> Unit) {
  this as PodScheduling_resource_k8s_io_v1alpha1Impl
  Podschedulingstatus_resource_k8s_io_v1alpha1Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun ResourceClaimTemplate.metadata(init: ObjectMeta.() -> Unit) {
  this as ResourceClaimTemplate_resource_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ResourceClaimTemplate.spec(init: Resourceclaimtemplatespec.() -> Unit) {
  this as ResourceClaimTemplate_resource_k8s_io_v1alpha1Impl
  Resourceclaimtemplatespec_resource_k8s_io_v1alpha1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun ResourceClass.metadata(init: ObjectMeta.() -> Unit) {
  this as ResourceClass_resource_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ResourceClass.parametersRef(init: ResourceClassParametersReference.() -> Unit) {
  this as ResourceClass_resource_k8s_io_v1alpha1Impl
  ResourceClassParametersReference_resource_k8s_io_v1alpha1Impl(this)
...
fun SelfSubjectReview.metadata(init: ObjectMeta.() -> Unit) {
  this as SelfSubjectReview_authentication_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun SelfSubjectReview.status(init: Selfsubjectreviewstatus.() -> Unit) {
  this as SelfSubjectReview_authentication_k8s_io_v1alpha1Impl
  Selfsubjectreviewstatus_authentication_k8s_io_v1alpha1Impl(this)
    .also { status = it }
    .apply(init)
}
...
@K8sDslMarker
fun Podschedulingstatus.resourceClaims(init: ResourceClaimSchedulingStatus.() -> Unit) {
  this as Podschedulingstatus_resource_k8s_io_v1alpha1Impl
  ResourceClaimSchedulingStatus_resource_k8s_io_v1alpha1Impl(this)
...
/** SchedulingGates is an opaque list of values that if specified will block scheduling the pod. More info:
https://git.k8s.io/enhancements/keps/sig-scheduling/3521-pod-scheduling-readiness. This is an alpha-level feature
enabled by PodSchedulingReadiness feature gate. */
@K8sDslMarker
...
@K8sDslMarker
fun Resourceclaimspec_resource_k8s_io_v1alpha1.parametersRef(init: ResourceClaimParametersReference.() -> Unit) {
  this as Resourceclaimspec_resource_k8s_io_v1alpha1Impl
  ResourceClaimParametersReference_resource_k8s_io_v1alpha1Impl(this)
    .also { parametersRef = it }
    .apply(init)
}
...
fun Resourceclaimtemplatespec.metadata(init: ObjectMeta.() -> Unit) {
  this as Resourceclaimtemplatespec_resource_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun Resourceclaimtemplatespec.spec(init: Resourceclaimspec_resource_k8s_io_v1alpha1.() -> Unit) {
  this as Resourceclaimtemplatespec_resource_k8s_io_v1alpha1Impl
  Resourceclaimspec_resource_k8s_io_v1alpha1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Selfsubjectreviewstatus.userInfo(init: UserInfo.() -> Unit) {
  this as Selfsubjectreviewstatus_authentication_k8s_io_v1alpha1Impl
