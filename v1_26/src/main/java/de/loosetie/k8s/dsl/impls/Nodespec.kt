...
open class Nodespec_core_v1Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null,
  
)
: Nodespec_core_v1, HasParent {
  override var configSource: NodeConfigSource_core_v1? = null
  ...
  override var taints: List<Taint_core_v1>? = null
