...
import de.loosetie.k8s.dsl.manifests.AzureDiskVolumeSource_core_v1_k8s1_18

@JsonPropertyOrder("kind", "cachingMode", "diskName", "diskURI", "fsType", "readOnly")
class AzureDiskVolumeSource_core_v1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: AzureDiskVolumeSource_core_v1_k8s1_18, HasParent {
