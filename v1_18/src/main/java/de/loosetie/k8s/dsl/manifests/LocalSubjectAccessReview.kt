...
@K8sDslMarker
interface LocalSubjectAccessReview_authorization_k8s_io_v1_k8s1_18: K8sTopLevel, HasMetadata {
...
request against. If empty, it is defaulted. */
  val spec: Subjectaccessreviewspec_authorization_k8s_io_v1_k8s1_18
