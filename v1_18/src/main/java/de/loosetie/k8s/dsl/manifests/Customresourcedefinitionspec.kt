...
@K8sDslMarker
interface Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_18: K8sManifest {
  /** conversion defines conversion settings for the CRD. */
  val conversion: CustomResourceConversion_apiextensions_k8s_io_v1_k8s1_18?
...
match the name of the CustomResourceDefinition (in the form `<names.plural>.<group>`). */
  ...
  val names: CustomResourceDefinitionNames_apiextensions_k8s_io_v1_k8s1_18?
...
v10beta3, v3beta1, v12alpha1, v11alpha2, foo1, foo10. */
  val versions: List<CustomResourceDefinitionVersion_apiextensions_k8s_io_v1_k8s1_18>?
}