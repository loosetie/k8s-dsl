...
@K8sDslMarker
interface LimitResponse_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_18: K8sManifest {
  /** `queuing` holds the configuration parameters for queuing. This field may be non-empty only if `type` is `"Queue"`. */
  val queuing: QueuingConfiguration_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_18?
