...
@K8sDslMarker
interface Nodestatus_core_v1_k8s1_18: K8sManifest {
...
full-replacement patch. See http://pr.k8s.io/79391 for an example. */
  val addresses: List<NodeAddress_core_v1_k8s1_18>?
...
https://kubernetes.io/docs/concepts/nodes/node/#condition */
  val conditions: List<NodeCondition_core_v1_k8s1_18>?
  /** Status of the config assigned to the node via the dynamic Kubelet config feature. */
  val config: NodeConfigStatus_core_v1_k8s1_18?
  /** Endpoints of daemons running on the Node. */
  val daemonEndpoints: NodeDaemonEndpoints_core_v1_k8s1_18?
  /** List of container images on this node */
  val images: List<ContainerImage_core_v1_k8s1_18>?
  /** Set of ids/uuids to uniquely identify the node. More info: https://kubernetes.io/docs/concepts/nodes/node/#info */
  val nodeInfo: NodeSystemInfo_core_v1_k8s1_18?
...
https://kubernetes.io/docs/concepts/nodes/node/#phase The field is never populated, and now is deprecated. */
  ...
  val volumesAttached: List<AttachedVolume_core_v1_k8s1_18>?
