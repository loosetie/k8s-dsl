...
import de.loosetie.k8s.dsl.manifests.ComponentStatus_core_v1_k8s1_18
import de.loosetie.k8s.dsl.manifests.ObjectMeta_meta_v1_k8s1_18

@JsonPropertyOrder("apiVersion", "kind", "metadata", "conditions")
class ComponentStatus_core_v1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: ComponentStatus_core_v1_k8s1_18, HasParent {
  override lateinit var metadata: ObjectMeta_meta_v1_k8s1_18
  override var conditions: List<ComponentCondition_core_v1_k8s1_18>? = null
}