...
@K8sDslMarker
interface Endpoint_discovery_k8s_io_v1beta1_k8s1_18: K8sManifest {
...
must contain at least one address but no more than 100. */
  ...
  val conditions: EndpointConditions_discovery_k8s_io_v1beta1_k8s1_18?
...
values in DNS). Must pass DNS Label (RFC 1123) validation. */
  ...
  val targetRef: ObjectReference_core_v1_k8s1_18?
