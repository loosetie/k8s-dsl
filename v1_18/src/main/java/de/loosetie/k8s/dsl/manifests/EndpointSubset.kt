...
@K8sDslMarker
interface EndpointSubset_core_v1_k8s1_18: K8sManifest {
...
balancers and clients to utilize. */
  val addresses: List<EndpointAddress_core_v1_k8s1_18>?
...
starting, have recently failed a readiness check, or have recently failed a liveness check. */
  val notReadyAddresses: List<EndpointAddress_core_v1_k8s1_18>?
  /** Port numbers available on the related IP addresses. */
  val ports: List<EndpointPort_core_v1_k8s1_18>?
}