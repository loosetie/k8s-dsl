...
@K8sDslMarker
interface Podstatus_core_v1_k8s1_18: K8sManifest {
  /** Current service state of pod. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-conditions */
  val conditions: List<PodCondition_core_v1_k8s1_18>?
...
https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status */
  val containerStatuses: List<Containerstatus_core_v1_k8s1_18>?
...
servers that enable the EphemeralContainers feature. */
  val ephemeralContainerStatuses: List<Containerstatus_core_v1_k8s1_18>?
...
https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status */
  val initContainerStatuses: List<Containerstatus_core_v1_k8s1_18>?
...
yet. */
  val podIPs: List<PodIP_core_v1_k8s1_18>?
...
container image(s) for the pod. */
  val startTime: Time_meta_v1_k8s1_18?
}