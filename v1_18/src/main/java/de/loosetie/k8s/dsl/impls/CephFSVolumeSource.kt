...
import de.loosetie.k8s.dsl.manifests.CephFSVolumeSource_core_v1_k8s1_18
...
class CephFSVolumeSource_core_v1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: CephFSVolumeSource_core_v1_k8s1_18, HasParent {
