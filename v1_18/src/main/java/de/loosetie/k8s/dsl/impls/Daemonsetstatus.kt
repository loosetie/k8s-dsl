...
import de.loosetie.k8s.dsl.manifests.DaemonSetCondition_apps_v1_k8s1_18
...
class Daemonsetstatus_apps_v1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Daemonsetstatus_apps_v1_k8s1_18, HasParent {
  override var collisionCount: Int? = null
  override var conditions: List<DaemonSetCondition_apps_v1_k8s1_18>? = null
