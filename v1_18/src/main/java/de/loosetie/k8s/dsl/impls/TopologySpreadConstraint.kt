...
class TopologySpreadConstraint_core_v1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: TopologySpreadConstraint_core_v1_k8s1_18, HasParent {
  override var labelSelector: LabelSelector_meta_v1_k8s1_18? = null
