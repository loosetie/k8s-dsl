...
class Podsecuritypolicyspec_policy_v1beta1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Podsecuritypolicyspec_policy_v1beta1_k8s1_18, HasParent {
  override var allowPrivilegeEscalation: Boolean? = null
  override var allowedCSIDrivers: List<AllowedCSIDriver_policy_v1beta1_k8s1_18>? = null
  override var allowedCapabilities: List<String>? = null
  override var allowedFlexVolumes: List<AllowedFlexVolume_policy_v1beta1_k8s1_18>? = null
  override var allowedHostPaths: List<AllowedHostPath_policy_v1beta1_k8s1_18>? = null
  ...
  override var fsGroup: FSGroupStrategyOptions_policy_v1beta1_k8s1_18? = null
  override var hostIPC: Boolean? = null
  override var hostNetwork: Boolean? = null
  override var hostPID: Boolean? = null
  override var hostPorts: List<HostPortRange_policy_v1beta1_k8s1_18>? = null
  ...
  override var runAsGroup: RunAsGroupStrategyOptions_policy_v1beta1_k8s1_18? = null
  override var runAsUser: RunAsUserStrategyOptions_policy_v1beta1_k8s1_18? = null
  override var runtimeClass: RuntimeClassStrategyOptions_policy_v1beta1_k8s1_18? = null
  override var seLinux: SELinuxStrategyOptions_policy_v1beta1_k8s1_18? = null
  override var supplementalGroups: SupplementalGroupsStrategyOptions_policy_v1beta1_k8s1_18? = null
