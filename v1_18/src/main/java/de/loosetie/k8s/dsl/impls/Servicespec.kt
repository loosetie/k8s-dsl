...
class Servicespec_core_v1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Servicespec_core_v1_k8s1_18, HasParent {
  ...
  override var ports: List<ServicePort_core_v1_k8s1_18>? = null
  override var publishNotReadyAddresses: Boolean? = null
  override var selector: Any? = null
  override var sessionAffinity: String? = null
  override var sessionAffinityConfig: SessionAffinityConfig_core_v1_k8s1_18? = null
