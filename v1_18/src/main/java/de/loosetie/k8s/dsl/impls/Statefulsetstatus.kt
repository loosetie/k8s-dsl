...
class Statefulsetstatus_apps_v1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Statefulsetstatus_apps_v1_k8s1_18, HasParent {
  override var collisionCount: Int? = null
  override var conditions: List<StatefulSetCondition_apps_v1_k8s1_18>? = null
