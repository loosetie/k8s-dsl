...
@K8sDslMarker
interface Subject_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_18: K8sManifest {
  /** Required */
  @K8sDslMarker var kind: String?
  /**  */
  val group: GroupSubject_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_18?
  /**  */
  val serviceAccount: ServiceAccountSubject_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_18?
  /**  */
  val user: UserSubject_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_18?
}

@Deprecated(message="Old api version")
@K8sDslMarker
interface Subject_rbac_authorization_k8s_io_v1_k8s1_18: K8sManifest {
