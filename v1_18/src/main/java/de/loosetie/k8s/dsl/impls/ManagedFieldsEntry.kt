...
class ManagedFieldsEntry_meta_v1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: ManagedFieldsEntry_meta_v1_k8s1_18, HasParent {
  override var apiVersion: String? = null
  override var fieldsType: String? = null
  override var fieldsV1: FieldsV1_meta_v1_k8s1_18? = null
  override var manager: String? = null
  override var operation: String? = null
  override var time: Time_meta_v1_k8s1_18? = null
}