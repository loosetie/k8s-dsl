...
class Nodespec_core_v1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Nodespec_core_v1_k8s1_18, HasParent {
  override var configSource: NodeConfigSource_core_v1_k8s1_18? = null
  ...
  override var taints: List<Taint_core_v1_k8s1_18>? = null
