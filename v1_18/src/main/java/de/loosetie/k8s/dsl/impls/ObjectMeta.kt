...
class ObjectMeta_meta_v1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: ObjectMeta_meta_v1_k8s1_18, HasParent {
  override var namespace: String? = null
  override var name: String? = null
  override var labels: Any? = null
  override var annotations: Any? = null
  override var clusterName: String? = null
  override var creationTimestamp: Time_meta_v1_k8s1_18? = null
  override var deletionGracePeriodSeconds: Int? = null
  override var deletionTimestamp: Time_meta_v1_k8s1_18? = null
  override var finalizers: List<String>? = null
  override var generateName: String? = null
  override var generation: Int? = null
  override var managedFields: List<ManagedFieldsEntry_meta_v1_k8s1_18>? = null
  override var ownerReferences: List<OwnerReference_meta_v1_k8s1_18>? = null
