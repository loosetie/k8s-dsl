...
@K8sDslMarker
interface MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_16: K8sManifest {
...
typealias MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_17 = MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_16       
typealias MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_18 = MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_17       
typealias MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_19 = MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_18       
typealias MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_20 = MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_19       
@K8sDslMarker
interface MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_21: MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_20 {
  /** SideEffects states whether this webhook has side effects. Acceptable values are: None, NoneOnDryRun (webhooks created
via v1beta1 may also specify Some or Unknown). Webhooks with side effects MUST implement a reconciliation system, since
