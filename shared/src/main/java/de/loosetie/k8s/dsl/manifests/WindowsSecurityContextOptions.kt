...
@K8sDslMarker
interface WindowsSecurityContextOptions_core_v1_k8s1_16: K8sManifest {
...
@K8sDslMarker
interface WindowsSecurityContextOptions_core_v1_k8s1_17: WindowsSecurityContextOptions_core_v1_k8s1_16 {
  /** The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata
if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value
...
WindowsRunAsUserName feature flag. */
  override var runAsUserName: String?
}      
@K8sDslMarker
interface WindowsSecurityContextOptions_core_v1_k8s1_18: WindowsSecurityContextOptions_core_v1_k8s1_17 {
  /** GMSACredentialSpec is where the GMSA admission webhook (https://github.com/kubernetes-sigs/windows-gmsa) inlines the
contents of the GMSA credential spec named by the GMSACredentialSpecName field. */
  override var gmsaCredentialSpec: String?
  /** GMSACredentialSpecName is the name of the GMSA credential spec to use. */
  override var gmsaCredentialSpecName: String?
  /** The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata
if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value
specified in SecurityContext takes precedence. */
  override var runAsUserName: String?
}      
typealias WindowsSecurityContextOptions_core_v1_k8s1_19 = WindowsSecurityContextOptions_core_v1_k8s1_18       
typealias WindowsSecurityContextOptions_core_v1_k8s1_20 = WindowsSecurityContextOptions_core_v1_k8s1_19       
typealias WindowsSecurityContextOptions_core_v1_k8s1_21 = WindowsSecurityContextOptions_core_v1_k8s1_20 