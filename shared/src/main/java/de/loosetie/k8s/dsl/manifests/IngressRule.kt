...
@K8sDslMarker
interface IngressRule_networking_k8s_io_v1beta1_k8s1_16: K8sManifest {
...
routes all traffic based on the specified IngressRuleValue. */
  ...
  /**  */
  val http: HTTPIngressRuleValue_networking_k8s_io_v1beta1_k8s1_16?
}      
typealias IngressRule_networking_k8s_io_v1beta1_k8s1_17 = IngressRule_networking_k8s_io_v1beta1_k8s1_16       
@K8sDslMarker
interface IngressRule_networking_k8s_io_v1beta1_k8s1_18: IngressRule_networking_k8s_io_v1beta1_k8s1_17 {
  /** Host is the fully qualified domain name of a network host, as defined by RFC 3986. Note the following deviations from
