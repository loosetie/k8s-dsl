...
@K8sDslMarker
interface Certificatesigningrequeststatus_certificates_k8s_io_v1beta1_k8s1_16: K8sManifest {
  /** If request was approved, the controller will place the issued certificate here. */
  @K8sDslMarker var certificate: String?
  /** Conditions applied to the request, such as approval or denial. */
  val conditions: List<CertificateSigningRequestCondition_certificates_k8s_io_v1beta1_k8s1_16>?
}      
typealias Certificatesigningrequeststatus_certificates_k8s_io_v1beta1_k8s1_17 = Certificatesigningrequeststatus_certificates_k8s_io_v1beta1_k8s1_16       
typealias Certificatesigningrequeststatus_certificates_k8s_io_v1beta1_k8s1_18 = Certificatesigningrequeststatus_certificates_k8s_io_v1beta1_k8s1_17       
@K8sDslMarker
