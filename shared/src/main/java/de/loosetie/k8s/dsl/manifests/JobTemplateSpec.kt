...
@K8sDslMarker
interface JobTemplateSpec_batch_v1beta1_k8s1_16: K8sManifest, HasMetadata {
...
@K8sDslMarker
interface JobTemplateSpec_batch_v1beta1_k8s1_17: K8sManifest, HasMetadata {
  /** Standard object's metadata of the jobs created from this template. More info:
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
...
@K8sDslMarker
interface JobTemplateSpec_batch_v1beta1_k8s1_18: K8sManifest, HasMetadata {
  /** Standard object's metadata of the jobs created from this template. More info:
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
...
@K8sDslMarker
interface JobTemplateSpec_batch_v1beta1_k8s1_19: K8sManifest, HasMetadata {
  /** Standard object's metadata of the jobs created from this template. More info:
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
...
@K8sDslMarker
interface JobTemplateSpec_batch_v1_k8s1_21: K8sManifest, HasMetadata {
  /** Standard object's metadata of the jobs created from this template. More info:
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
