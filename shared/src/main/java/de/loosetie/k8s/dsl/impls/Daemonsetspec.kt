...
class Daemonsetspec_apps_v1_k8s1_16Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Daemonsetspec_apps_v1_k8s1_16, HasParent {
  ...
  override var updateStrategy: DaemonSetUpdateStrategy_apps_v1_k8s1_16? = null
}
@JsonPropertyOrder("minReadySeconds", "revisionHistoryLimit", "selector", "template", "updateStrategy")
class Daemonsetspec_apps_v1_k8s1_17Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Daemonsetspec_apps_v1_k8s1_17, HasParent {
  override var minReadySeconds: Int? = null
  override var revisionHistoryLimit: Int? = null
  override var selector: LabelSelector_meta_v1_k8s1_17? = null
  override var template: Podtemplatespec_core_v1_k8s1_17? = null
  override var updateStrategy: DaemonSetUpdateStrategy_apps_v1_k8s1_17? = null
}
@JsonPropertyOrder("minReadySeconds", "revisionHistoryLimit", "selector", "template", "updateStrategy")
...
@JsonPropertyOrder("minReadySeconds", "revisionHistoryLimit", "selector", "template", "updateStrategy")
class Daemonsetspec_apps_v1_k8s1_19Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Daemonsetspec_apps_v1_k8s1_19, HasParent {
  override var minReadySeconds: Int? = null
  override var revisionHistoryLimit: Int? = null
  override var selector: LabelSelector_meta_v1_k8s1_19? = null
  override var template: Podtemplatespec_core_v1_k8s1_19? = null
  override var updateStrategy: DaemonSetUpdateStrategy_apps_v1_k8s1_19? = null
}
@JsonPropertyOrder("minReadySeconds", "revisionHistoryLimit", "selector", "template", "updateStrategy")
...
@JsonPropertyOrder("minReadySeconds", "revisionHistoryLimit", "selector", "template", "updateStrategy")
class Daemonsetspec_apps_v1_k8s1_21Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Daemonsetspec_apps_v1_k8s1_21, HasParent {
  override var minReadySeconds: Int? = null
  override var revisionHistoryLimit: Int? = null
  override var selector: LabelSelector_meta_v1_k8s1_21? = null
  override var template: Podtemplatespec_core_v1_k8s1_21? = null
  override var updateStrategy: DaemonSetUpdateStrategy_apps_v1_k8s1_21? = null
}