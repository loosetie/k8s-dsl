...
@K8sDslMarker
interface Jobspec_batch_v1_k8s1_16: K8sManifest {
...
@K8sDslMarker
interface Jobspec_batch_v1_k8s1_17: K8sManifest {
  /** Specifies the duration in seconds relative to the startTime that the job may be active before the system tries to
terminate it; value must be positive integer */
  @K8sDslMarker var activeDeadlineSeconds: Int?
  /** Specifies the number of retries before marking this job failed. Defaults to 6 */
...
@K8sDslMarker
interface Jobspec_batch_v1_k8s1_18: K8sManifest {
  /** Specifies the duration in seconds relative to the startTime that the job may be active before the system tries to
terminate it; value must be positive integer */
  @K8sDslMarker var activeDeadlineSeconds: Int?
  /** Specifies the number of retries before marking this job failed. Defaults to 6 */
...
@K8sDslMarker
interface Jobspec_batch_v1_k8s1_19: K8sManifest {
  /** Specifies the duration in seconds relative to the startTime that the job may be active before the system tries to
terminate it; value must be positive integer */
  @K8sDslMarker var activeDeadlineSeconds: Int?
  /** Specifies the number of retries before marking this job failed. Defaults to 6 */
...
@K8sDslMarker
interface Jobspec_batch_v1_k8s1_21: K8sManifest {
...
specified and `.spec.parallelism` must be less than or equal to 10^5. This field is alpha-level and is only honored by
servers that enable the IndexedJob feature gate. More completion modes can be added in the future. If the Job controller
...
timer too. This is an alpha field and requires the SuspendJob feature gate to be enabled; otherwise this field may not
