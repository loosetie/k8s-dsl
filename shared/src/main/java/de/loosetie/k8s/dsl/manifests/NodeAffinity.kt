...
@K8sDslMarker
interface NodeAffinity_core_v1_k8s1_16: K8sManifest {
...
the most preferred. */
  val preferredDuringSchedulingIgnoredDuringExecution: List<PreferredSchedulingTerm_core_v1_k8s1_16>?
...
due to an update), the system may or may not try to eventually evict the pod from its node. */
  val requiredDuringSchedulingIgnoredDuringExecution: NodeSelector_core_v1_k8s1_16?
}      
typealias NodeAffinity_core_v1_k8s1_17 = NodeAffinity_core_v1_k8s1_16       
typealias NodeAffinity_core_v1_k8s1_18 = NodeAffinity_core_v1_k8s1_17       
typealias NodeAffinity_core_v1_k8s1_19 = NodeAffinity_core_v1_k8s1_18       
typealias NodeAffinity_core_v1_k8s1_20 = NodeAffinity_core_v1_k8s1_19       
typealias NodeAffinity_core_v1_k8s1_21 = NodeAffinity_core_v1_k8s1_20 