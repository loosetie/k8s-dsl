...
@K8sDslMarker
interface Apiservicespec_apiregistration_k8s_io_v1_k8s1_16: K8sManifest {
...
normal handler chain to be fulfilled. */
  val service: ServiceReference_apiregistration_k8s_io_v1_k8s1_16?
...
typealias Apiservicespec_apiregistration_k8s_io_v1_k8s1_17 = Apiservicespec_apiregistration_k8s_io_v1_k8s1_16       
typealias Apiservicespec_apiregistration_k8s_io_v1_k8s1_18 = Apiservicespec_apiregistration_k8s_io_v1_k8s1_17       
@K8sDslMarker
interface Apiservicespec_apiregistration_k8s_io_v1_k8s1_19: K8sManifest {
  /** CABundle is a PEM encoded CA bundle which will be used to validate an API server's serving certificate. If unspecified,
system trust roots on the apiserver are used. */
  @K8sDslMarker var caBundle: String?
  /** Group is the API group name this server hosts */
...
means the handling for the API groupversion is handled locally on this server. The call will simply delegate to the
normal handler chain to be fulfilled. */
  val service: ServiceReference_apiregistration_k8s_io_v1_k8s1_19?
  /** Version is the API version this server hosts. For example, "v1" */
  @K8sDslMarker var version: String?
  /** VersionPriority controls the ordering of this API version inside of its group. Must be greater than zero. The primary
sort is based on VersionPriority, ordered highest to lowest (20 before 10). Since it's inside of a group, the number can
...
typealias Apiservicespec_apiregistration_k8s_io_v1_k8s1_20 = Apiservicespec_apiregistration_k8s_io_v1_k8s1_19       
typealias Apiservicespec_apiregistration_k8s_io_v1_k8s1_21 = Apiservicespec_apiregistration_k8s_io_v1_k8s1_20 