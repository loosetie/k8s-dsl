...
@K8sDslMarker
interface VolumeMount_core_v1_k8s1_16: K8sManifest {
...
@K8sDslMarker
interface VolumeMount_core_v1_k8s1_17: VolumeMount_core_v1_k8s1_16 {
  /** Expanded path within the volume from which the container's volume should be mounted. Behaves similarly to SubPath but
environment variable references $(VAR_NAME) are expanded using the container's environment. Defaults to "" (volume's
root). SubPathExpr and SubPath are mutually exclusive. */
  override var subPathExpr: String?
}      
typealias VolumeMount_core_v1_k8s1_18 = VolumeMount_core_v1_k8s1_17       
typealias VolumeMount_core_v1_k8s1_19 = VolumeMount_core_v1_k8s1_18       
typealias VolumeMount_core_v1_k8s1_20 = VolumeMount_core_v1_k8s1_19       
typealias VolumeMount_core_v1_k8s1_21 = VolumeMount_core_v1_k8s1_20 