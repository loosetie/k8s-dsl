...
@K8sDslMarker
interface Endpoints_core_v1_k8s1_16: K8sTopLevel, HasMetadata {
...
comprise a service. */
  val subsets: List<EndpointSubset_core_v1_k8s1_16>?
}      
@K8sDslMarker
interface Endpoints_core_v1_k8s1_17: K8sTopLevel, HasMetadata {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas
to the latest internal value, and may reject unrecognized values. More info:
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  override val apiVersion: String
...
address will appear in both Addresses and NotReadyAddresses in the same subset. Sets of addresses and ports that
comprise a service. */
  val subsets: List<EndpointSubset_core_v1_k8s1_17>?
}      
typealias Endpoints_core_v1_k8s1_18 = Endpoints_core_v1_k8s1_17       
typealias Endpoints_core_v1_k8s1_19 = Endpoints_core_v1_k8s1_18       
typealias Endpoints_core_v1_k8s1_20 = Endpoints_core_v1_k8s1_19       
typealias Endpoints_core_v1_k8s1_21 = Endpoints_core_v1_k8s1_20 