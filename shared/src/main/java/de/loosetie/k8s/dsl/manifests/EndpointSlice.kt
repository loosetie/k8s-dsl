...
@K8sDslMarker
interface EndpointSlice_discovery_k8s_io_v1alpha1_k8s1_16: K8sTopLevel, HasMetadata {
...
type. Default is IP */
  ...
  val endpoints: List<Endpoint_discovery_k8s_io_v1alpha1_k8s1_16>?
...
an IPv4 Address. `*` IPv6: Represents an IPv6 Address. `*` FQDN: Represents a Fully Qualified Domain Name. */
  @K8sDslMarker var addressType: String?
  /** endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints. */
  val endpoints: List<Endpoint_discovery_k8s_io_v1beta1_k8s1_17>?
  /** ports specifies the list of network ports exposed by each endpoint in this slice. Each port must have a unique name.
When ports is empty, it indicates that there are no defined ports. When a port is defined with a nil port value, it
indicates "all ports". Each slice may include a maximum of 100 ports. */
...
an IPv4 Address. `*` IPv6: Represents an IPv6 Address. `*` FQDN: Represents a Fully Qualified Domain Name. */
  @K8sDslMarker var addressType: String?
  /** endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints. */
  val endpoints: List<Endpoint_discovery_k8s_io_v1_k8s1_21>?
  /** ports specifies the list of network ports exposed by each endpoint in this slice. Each port must have a unique name.
When ports is empty, it indicates that there are no defined ports. When a port is defined with a nil port value, it
indicates "all ports". Each slice may include a maximum of 100 ports. */
