...
@K8sDslMarker
interface ConfigMap_core_v1_k8s1_16: K8sTopLevel, HasMetadata {
...
typealias ConfigMap_core_v1_k8s1_17 = ConfigMap_core_v1_k8s1_16       
@K8sDslMarker
interface ConfigMap_core_v1_k8s1_18: ConfigMap_core_v1_k8s1_17 {
...
@K8sDslMarker
interface ConfigMap_core_v1_k8s1_19: ConfigMap_core_v1_k8s1_18 {
  /** Immutable, if set to true, ensures that data stored in the ConfigMap cannot be updated (only object metadata can be
...
typealias ConfigMap_core_v1_k8s1_20 = ConfigMap_core_v1_k8s1_19       
@K8sDslMarker
interface ConfigMap_core_v1_k8s1_21: ConfigMap_core_v1_k8s1_20 {
  /** Immutable, if set to true, ensures that data stored in the ConfigMap cannot be updated (only object metadata can be
