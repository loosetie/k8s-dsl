...
@K8sDslMarker
interface CSIPersistentVolumeSource_core_v1_k8s1_16: K8sManifest {
...
secret, all secrets are passed. */
  val controllerExpandSecretRef: SecretReference_core_v1_k8s1_16?
...
be empty if no secret is required. If the secret object contains more than one secret, all secrets are passed. */
  val controllerPublishSecretRef: SecretReference_core_v1_k8s1_16?
...
is required. If the secret object contains more than one secret, all secrets are passed. */
  val nodePublishSecretRef: SecretReference_core_v1_k8s1_16?
...
empty if no secret is required. If the secret object contains more than one secret, all secrets are passed. */
  val nodeStageSecretRef: SecretReference_core_v1_k8s1_16?
...
typealias CSIPersistentVolumeSource_core_v1_k8s1_17 = CSIPersistentVolumeSource_core_v1_k8s1_16       
typealias CSIPersistentVolumeSource_core_v1_k8s1_18 = CSIPersistentVolumeSource_core_v1_k8s1_17       
typealias CSIPersistentVolumeSource_core_v1_k8s1_19 = CSIPersistentVolumeSource_core_v1_k8s1_18       
typealias CSIPersistentVolumeSource_core_v1_k8s1_20 = CSIPersistentVolumeSource_core_v1_k8s1_19       
typealias CSIPersistentVolumeSource_core_v1_k8s1_21 = CSIPersistentVolumeSource_core_v1_k8s1_20 