...
@K8sDslMarker
interface Flowschemaspec_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_17: K8sManifest {
...
that the distinguisher is disabled and thus will always be the empty string. */
  val distinguisherMethod: FlowDistinguisherMethod_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_17?
...
resolved, the FlowSchema will be ignored and marked as invalid in its status. Required. */
  val priorityLevelConfiguration: PriorityLevelConfigurationReference_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_17?
...
one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema. */
  val rules: List<PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_17>?
}      
@K8sDslMarker
interface Flowschemaspec_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_18: Flowschemaspec_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_17 {
  /** `matchingPrecedence` is used to choose among the FlowSchemas that match a given request. The chosen FlowSchema is among
those with the numerically lowest (which we take to be logically highest) MatchingPrecedence. Each MatchingPrecedence
