...
@K8sDslMarker
interface Deploymentspec_apps_v1_k8s1_16: K8sManifest {
...
deployment. It must match the pod template's labels. */
  ...
  val strategy: Deploymentstrategy_apps_v1_k8s1_16?
  /** Template describes the pods that will be created. */
  val template: Podtemplatespec_core_v1_k8s1_16?
}      
@K8sDslMarker
interface Deploymentspec_apps_v1_k8s1_17: K8sManifest {
  /** Minimum number of seconds for which a newly created pod should be ready without any of its container crashing, for it to
be considered available. Defaults to 0 (pod will be considered available as soon as it is ready) */
  @K8sDslMarker var minReadySeconds: Int?
  /** Indicates that the deployment is paused. */
...
deployment. It must match the pod template's labels. */
  ...
  /** The deployment strategy to use to replace existing pods with new ones. */
  val strategy: Deploymentstrategy_apps_v1_k8s1_17?
  /** Template describes the pods that will be created. */
  val template: Podtemplatespec_core_v1_k8s1_17?
}      
@K8sDslMarker
interface Deploymentspec_apps_v1_k8s1_18: K8sManifest {
  /** Minimum number of seconds for which a newly created pod should be ready without any of its container crashing, for it to
be considered available. Defaults to 0 (pod will be considered available as soon as it is ready) */
  @K8sDslMarker var minReadySeconds: Int?
  /** Indicates that the deployment is paused. */
...
deployment. It must match the pod template's labels. */
  ...
  /** The deployment strategy to use to replace existing pods with new ones. */
  val strategy: Deploymentstrategy_apps_v1_k8s1_18?
  /** Template describes the pods that will be created. */
  val template: Podtemplatespec_core_v1_k8s1_18?
}      
@K8sDslMarker
interface Deploymentspec_apps_v1_k8s1_19: K8sManifest {
  /** Minimum number of seconds for which a newly created pod should be ready without any of its container crashing, for it to
be considered available. Defaults to 0 (pod will be considered available as soon as it is ready) */
  @K8sDslMarker var minReadySeconds: Int?
  /** Indicates that the deployment is paused. */
...
deployment. It must match the pod template's labels. */
  ...
  /** The deployment strategy to use to replace existing pods with new ones. */
  val strategy: Deploymentstrategy_apps_v1_k8s1_19?
  /** Template describes the pods that will be created. */
  val template: Podtemplatespec_core_v1_k8s1_19?
}      
@K8sDslMarker
interface Deploymentspec_apps_v1_k8s1_20: K8sManifest {
  /** Minimum number of seconds for which a newly created pod should be ready without any of its container crashing, for it to
be considered available. Defaults to 0 (pod will be considered available as soon as it is ready) */
  @K8sDslMarker var minReadySeconds: Int?
  /** Indicates that the deployment is paused. */
...
deployment. It must match the pod template's labels. */
  ...
  /** The deployment strategy to use to replace existing pods with new ones. */
  val strategy: Deploymentstrategy_apps_v1_k8s1_20?
  /** Template describes the pods that will be created. */
  val template: Podtemplatespec_core_v1_k8s1_20?
}      
@K8sDslMarker
interface Deploymentspec_apps_v1_k8s1_21: K8sManifest {
  /** Minimum number of seconds for which a newly created pod should be ready without any of its container crashing, for it to
be considered available. Defaults to 0 (pod will be considered available as soon as it is ready) */
  @K8sDslMarker var minReadySeconds: Int?
  /** Indicates that the deployment is paused. */
...
deployment. It must match the pod template's labels. */
  ...
  /** The deployment strategy to use to replace existing pods with new ones. */
  val strategy: Deploymentstrategy_apps_v1_k8s1_21?
  /** Template describes the pods that will be created. */
