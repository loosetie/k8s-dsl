...
@K8sDslMarker
interface MetricStatus_autoscaling_v2beta2_k8s1_16: K8sManifest {
...
or QPS from loadbalancer running outside of cluster). */
  val external: ExternalMetricStatus_autoscaling_v2beta2_k8s1_16?
  /** object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object). */
  val `object`: ObjectMetricStatus_autoscaling_v2beta2_k8s1_16?
...
transactions-processed-per-second). The values will be averaged together before being compared to the target value. */
  val pods: PodsMetricStatus_autoscaling_v2beta2_k8s1_16?
...
scaling options on top of those available to normal per-pod metrics using the "pods" source. */
  val resource: ResourceMetricStatus_autoscaling_v2beta2_k8s1_16?
  /** type is the type of metric source. It will be one of "Object", "Pods" or "Resource", each corresponds to a matching
field in the object. */
  @K8sDslMarker var type: String?
}      
typealias MetricStatus_autoscaling_v2beta2_k8s1_17 = MetricStatus_autoscaling_v2beta2_k8s1_16       
typealias MetricStatus_autoscaling_v2beta2_k8s1_18 = MetricStatus_autoscaling_v2beta2_k8s1_17       
typealias MetricStatus_autoscaling_v2beta2_k8s1_19 = MetricStatus_autoscaling_v2beta2_k8s1_18       
@K8sDslMarker
interface MetricStatus_autoscaling_v2beta2_k8s1_20: MetricStatus_autoscaling_v2beta2_k8s1_19 {
...
source. */
  val containerResource: ContainerResourceMetricStatus_autoscaling_v2beta2_k8s1_20?
...
typealias MetricStatus_autoscaling_v2beta2_k8s1_21 = MetricStatus_autoscaling_v2beta2_k8s1_20 