...
class Replicasetspec_apps_v1_k8s1_16Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Replicasetspec_apps_v1_k8s1_16, HasParent {
...
@JsonPropertyOrder("minReadySeconds", "replicas", "selector", "template")
class Replicasetspec_apps_v1_k8s1_17Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Replicasetspec_apps_v1_k8s1_17, HasParent {
  override var minReadySeconds: Int? = null
  override var replicas: Int? = null
...
@JsonPropertyOrder("minReadySeconds", "replicas", "selector", "template")
class Replicasetspec_apps_v1_k8s1_19Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Replicasetspec_apps_v1_k8s1_19, HasParent {
  override var minReadySeconds: Int? = null
  override var replicas: Int? = null
...
@JsonPropertyOrder("minReadySeconds", "replicas", "selector", "template")
class Replicasetspec_apps_v1_k8s1_21Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Replicasetspec_apps_v1_k8s1_21, HasParent {
  override var minReadySeconds: Int? = null
  override var replicas: Int? = null
