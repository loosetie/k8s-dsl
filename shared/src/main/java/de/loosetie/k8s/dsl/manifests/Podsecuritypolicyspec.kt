...
@K8sDslMarker
interface Podsecuritypolicyspec_policy_v1beta1_k8s1_16: K8sManifest {
...
honored if the API server enables the CSIInlineVolume feature gate. */
  val allowedCSIDrivers: List<AllowedCSIDriver_policy_v1beta1_k8s1_16>?
...
parameter is effective only when the usage of the Flexvolumes is allowed in the "volumes" field. */
  val allowedFlexVolumes: List<AllowedFlexVolume_policy_v1beta1_k8s1_16>?
  /** allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used. */
  val allowedHostPaths: List<AllowedHostPath_policy_v1beta1_k8s1_16>?
...
forbidden. Examples: e.g. "foo/`*`" forbids "foo/bar", "foo/baz", etc. e.g. "foo.`*`" forbids "foo.bar", "foo.baz", etc. */
  ...
  val fsGroup: FSGroupStrategyOptions_policy_v1beta1_k8s1_16?
  ...
  val hostPorts: List<HostPortRange_policy_v1beta1_k8s1_16>?
...
the pod's RunAsGroup can take any value. This field requires the RunAsGroup feature gate to be enabled. */
  val runAsGroup: RunAsGroupStrategyOptions_policy_v1beta1_k8s1_16?
  /** runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set. */
  val runAsUser: RunAsUserStrategyOptions_policy_v1beta1_k8s1_16?
...
enabled. */
  val runtimeClass: RuntimeClassStrategyOptions_policy_v1beta1_k8s1_16?
  /** seLinux is the strategy that will dictate the allowable labels that may be set. */
  val seLinux: SELinuxStrategyOptions_policy_v1beta1_k8s1_16?
  /** supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext. */
  val supplementalGroups: SupplementalGroupsStrategyOptions_policy_v1beta1_k8s1_16?
...
typealias Podsecuritypolicyspec_policy_v1beta1_k8s1_17 = Podsecuritypolicyspec_policy_v1beta1_k8s1_16       
typealias Podsecuritypolicyspec_policy_v1beta1_k8s1_18 = Podsecuritypolicyspec_policy_v1beta1_k8s1_17       
@K8sDslMarker
interface Podsecuritypolicyspec_policy_v1beta1_k8s1_19: K8sManifest {
  /** allowPrivilegeEscalation determines if a pod can request to allow privilege escalation. If unspecified, defaults to
true. */
  @K8sDslMarker var allowPrivilegeEscalation: Boolean?
...
honored if the API server enables the CSIInlineVolume feature gate. */
  val allowedCSIDrivers: List<AllowedCSIDriver_policy_v1beta1_k8s1_19>?
  /** allowedCapabilities is a list of capabilities that can be requested to add to the container. Capabilities in this field
may be added at the pod author's discretion. You must not list a capability in both allowedCapabilities and
requiredDropCapabilities. */
  @K8sDslMarker var allowedCapabilities: List<String>?
...
parameter is effective only when the usage of the Flexvolumes is allowed in the "volumes" field. */
  val allowedFlexVolumes: List<AllowedFlexVolume_policy_v1beta1_k8s1_19>?
  /** allowedHostPaths is an allowlist of host paths. Empty indicates that all host paths may be used. */
  val allowedHostPaths: List<AllowedHostPath_policy_v1beta1_k8s1_19>?
...
forbidden. Examples: e.g. "foo/`*`" forbids "foo/bar", "foo/baz", etc. e.g. "foo.`*`" forbids "foo.bar", "foo.baz", etc. */
  @K8sDslMarker var forbiddenSysctls: List<String>?
  /** fsGroup is the strategy that will dictate what fs group is used by the SecurityContext. */
  val fsGroup: FSGroupStrategyOptions_policy_v1beta1_k8s1_19?
  /** hostIPC determines if the policy allows the use of HostIPC in the pod spec. */
  @K8sDslMarker var hostIPC: Boolean?
  /** hostNetwork determines if the policy allows the use of HostNetwork in the pod spec. */
  @K8sDslMarker var hostNetwork: Boolean?
  ...
  @K8sDslMarker var hostPID: Boolean?
  /** hostPorts determines which host port ranges are allowed to be exposed. */
  val hostPorts: List<HostPortRange_policy_v1beta1_k8s1_19>?
  /** privileged determines if a pod can request to be run as privileged. */
  @K8sDslMarker var privileged: Boolean?
  /** readOnlyRootFilesystem when set to true will force containers to run with a read only root file system. If the container
specifically requests to run with a non-read only root file system the PSP should deny the pod. If set to false the
...
and cannot be added. */
  ...
  /** RunAsGroup is the strategy that will dictate the allowable RunAsGroup values that may be set. If this field is omitted,
the pod's RunAsGroup can take any value. This field requires the RunAsGroup feature gate to be enabled. */
  val runAsGroup: RunAsGroupStrategyOptions_policy_v1beta1_k8s1_19?
  /** runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set. */
  val runAsUser: RunAsUserStrategyOptions_policy_v1beta1_k8s1_19?
  /** runtimeClass is the strategy that will dictate the allowable RuntimeClasses for a pod. If this field is omitted, the
pod's runtimeClassName field is unrestricted. Enforcement of this field depends on the RuntimeClass feature gate being
enabled. */
  val runtimeClass: RuntimeClassStrategyOptions_policy_v1beta1_k8s1_19?
  /** seLinux is the strategy that will dictate the allowable labels that may be set. */
  val seLinux: SELinuxStrategyOptions_policy_v1beta1_k8s1_19?
  /** supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext. */
  val supplementalGroups: SupplementalGroupsStrategyOptions_policy_v1beta1_k8s1_19?
  /** volumes is an allowlist of volume plugins. Empty indicates that no volumes may be used. To allow all volumes you may use
'\`*`'. */
  @K8sDslMarker var volumes: List<String>?
}      
typealias Podsecuritypolicyspec_policy_v1beta1_k8s1_20 = Podsecuritypolicyspec_policy_v1beta1_k8s1_19       
typealias Podsecuritypolicyspec_policy_v1beta1_k8s1_21 = Podsecuritypolicyspec_policy_v1beta1_k8s1_20 