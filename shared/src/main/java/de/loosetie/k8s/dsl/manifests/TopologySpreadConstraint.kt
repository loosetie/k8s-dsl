...
@K8sDslMarker
interface TopologySpreadConstraint_core_v1_k8s1_16: K8sManifest {
...
pods in their corresponding topology domain. */
  val labelSelector: LabelSelector_meta_v1_k8s1_16?
...
typealias TopologySpreadConstraint_core_v1_k8s1_17 = TopologySpreadConstraint_core_v1_k8s1_16       
typealias TopologySpreadConstraint_core_v1_k8s1_18 = TopologySpreadConstraint_core_v1_k8s1_17       
@K8sDslMarker
interface TopologySpreadConstraint_core_v1_k8s1_19: TopologySpreadConstraint_core_v1_k8s1_18 {
...
scheduled onto any zone. When `whenUnsatisfiable=ScheduleAnyway`, it is used to give higher precedence to topologies
that satisfy it. It's a required field. Default value is 1 and 0 is not allowed. */
  override var maxSkew: Int?
  /** WhenUnsatisfiable indicates how to deal with a pod if it doesn't satisfy the spread constraint. - DoNotSchedule
...
words, the cluster can still be imbalanced, but scheduler won't make it `*`more`*` imbalanced. It's a required field. */
  override var whenUnsatisfiable: String?
}      
typealias TopologySpreadConstraint_core_v1_k8s1_20 = TopologySpreadConstraint_core_v1_k8s1_19       
typealias TopologySpreadConstraint_core_v1_k8s1_21 = TopologySpreadConstraint_core_v1_k8s1_20 