...
@K8sDslMarker
interface LimitResponse_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_17: K8sManifest {
  /** `queuing` holds the configuration parameters for queuing. This field may be non-empty only if `type` is `"Queue"`. */
  val queuing: QueuingConfiguration_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_17?
...
interface LimitResponse_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_20: K8sManifest {
  /** `queuing` holds the configuration parameters for queuing. This field may be non-empty only if `type` is `"Queue"`. */
  val queuing: QueuingConfiguration_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_20?
  /** `type` is "Queue" or "Reject". "Queue" means that requests that can not be executed upon arrival are held in a queue
until they can be executed or a queuing limit is reached. "Reject" means that requests that can not be executed upon
arrival are rejected. Required. */
  @K8sDslMarker var type: String?
