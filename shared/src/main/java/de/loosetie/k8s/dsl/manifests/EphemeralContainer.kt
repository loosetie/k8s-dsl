...
@K8sDslMarker
interface EphemeralContainer_core_v1_k8s1_16: K8sManifest {
...
@K8sDslMarker
interface EphemeralContainer_core_v1_k8s1_17: K8sManifest {
  /** Name of the ephemeral container specified as a DNS_LABEL. This name must be unique among all containers, init containers
and ephemeral containers. */
  @K8sDslMarker var name: String?
  /** Arguments to the entrypoint. The docker image's CMD is used if this is not provided. Variable references $(VAR_NAME) are
...
@K8sDslMarker
interface EphemeralContainer_core_v1_k8s1_18: K8sManifest {
  /** Name of the ephemeral container specified as a DNS_LABEL. This name must be unique among all containers, init containers
and ephemeral containers. */
  @K8sDslMarker var name: String?
  /** Arguments to the entrypoint. The docker image's CMD is used if this is not provided. Variable references $(VAR_NAME) are
...
@K8sDslMarker
interface EphemeralContainer_core_v1_k8s1_19: K8sManifest {
  /** Name of the ephemeral container specified as a DNS_LABEL. This name must be unique among all containers, init containers
and ephemeral containers. */
  @K8sDslMarker var name: String?
  /** Arguments to the entrypoint. The docker image's CMD is used if this is not provided. Variable references $(VAR_NAME) are
...
typealias EphemeralContainer_core_v1_k8s1_20 = EphemeralContainer_core_v1_k8s1_19       
typealias EphemeralContainer_core_v1_k8s1_21 = EphemeralContainer_core_v1_k8s1_20 