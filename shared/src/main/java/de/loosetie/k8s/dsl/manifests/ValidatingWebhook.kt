...
@K8sDslMarker
interface ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_16: K8sManifest {
...
not include any versions known to the API Server, calls to the webhook will fail and be subject to the failure policy. */
  ...
  val clientConfig: WebhookClientConfig_admissionregistration_k8s_io_v1_k8s1_16?
...
more examples of label selectors. Default to the empty LabelSelector, which matches everything. */
  val namespaceSelector: LabelSelector_meta_v1_k8s1_16?
...
labels. Default to the empty LabelSelector, which matches everything. */
  val objectSelector: LabelSelector_meta_v1_k8s1_16?
...
for ValidatingWebhookConfiguration and MutatingWebhookConfiguration objects. */
  val rules: List<RuleWithOperations_admissionregistration_k8s_io_v1_k8s1_16>?
...
typealias ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_17 = ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_16       
typealias ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_18 = ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_17       
typealias ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_19 = ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_18       
typealias ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_20 = ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_19       
@K8sDslMarker
interface ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_21: ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_20 {
  /** SideEffects states whether this webhook has side effects. Acceptable values are: None, NoneOnDryRun (webhooks created
via v1beta1 may also specify Some or Unknown). Webhooks with side effects MUST implement a reconciliation system, since
a request may be rejected by a future step in the admission chain and the side effects therefore need to be undone.
Requests with the dryRun attribute will be auto-rejected if they match a webhook with sideEffects == Unknown or Some. */
  override var sideEffects: String?
}