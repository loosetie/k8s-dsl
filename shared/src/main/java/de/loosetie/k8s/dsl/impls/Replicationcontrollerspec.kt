...
class Replicationcontrollerspec_core_v1_k8s1_16Impl(
  @JsonIgnore
...
@JsonPropertyOrder("minReadySeconds", "replicas", "selector", "template")
class Replicationcontrollerspec_core_v1_k8s1_17Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
...
@JsonPropertyOrder("minReadySeconds", "replicas", "selector", "template")
class Replicationcontrollerspec_core_v1_k8s1_19Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
...
@JsonPropertyOrder("minReadySeconds", "replicas", "selector", "template")
class Replicationcontrollerspec_core_v1_k8s1_20Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
...
@JsonPropertyOrder("minReadySeconds", "replicas", "selector", "template")
class Replicationcontrollerspec_core_v1_k8s1_21Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
