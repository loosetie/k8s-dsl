...
@K8sDslMarker
interface LimitedPriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_17: K8sManifest {
...
more reserved concurrent requests (at the expense of every other PL). This field has a default value of 30. */
  ...
  val limitResponse: LimitResponse_flowcontrol_apiserver_k8s_io_v1alpha1_k8s1_17?
}      
