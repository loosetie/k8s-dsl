...
class Podtemplatespec_core_v1_k8s1_16Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Podtemplatespec_core_v1_k8s1_16, HasParent {
  override var metadata: ObjectMeta_meta_v1_k8s1_16? = null
  override var spec: Podspec_core_v1_k8s1_16? = null
}
@JsonPropertyOrder("metadata", "spec")
class Podtemplatespec_core_v1_k8s1_17Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Podtemplatespec_core_v1_k8s1_17, HasParent {
  override var metadata: ObjectMeta_meta_v1_k8s1_17? = null
  override var spec: Podspec_core_v1_k8s1_17? = null
}
@JsonPropertyOrder("metadata", "spec")
...
@JsonPropertyOrder("metadata", "spec")
class Podtemplatespec_core_v1_k8s1_19Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Podtemplatespec_core_v1_k8s1_19, HasParent {
  override var metadata: ObjectMeta_meta_v1_k8s1_19? = null
  override var spec: Podspec_core_v1_k8s1_19? = null
}
@JsonPropertyOrder("metadata", "spec")
...
@JsonPropertyOrder("metadata", "spec")
class Podtemplatespec_core_v1_k8s1_21Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Podtemplatespec_core_v1_k8s1_21, HasParent {
  override var metadata: ObjectMeta_meta_v1_k8s1_21? = null
  override var spec: Podspec_core_v1_k8s1_21? = null
}