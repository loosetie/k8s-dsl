...
class SecurityContext_core_v1_k8s1_16Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: SecurityContext_core_v1_k8s1_16, HasParent {
  override var allowPrivilegeEscalation: Boolean? = null
  override var capabilities: Capabilities_core_v1_k8s1_16? = null
...
typealias SecurityContext_core_v1_k8s1_17Impl = SecurityContext_core_v1_k8s1_16Impl
typealias SecurityContext_core_v1_k8s1_18Impl = SecurityContext_core_v1_k8s1_17Impl
...
class SecurityContext_core_v1_k8s1_19Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: SecurityContext_core_v1_k8s1_19, HasParent {
  override var allowPrivilegeEscalation: Boolean? = null
  override var capabilities: Capabilities_core_v1_k8s1_19? = null
  override var privileged: Boolean? = null
  override var procMount: String? = null
  override var readOnlyRootFilesystem: Boolean? = null
  override var runAsGroup: Int? = null
...
typealias SecurityContext_core_v1_k8s1_20Impl = SecurityContext_core_v1_k8s1_19Impl
typealias SecurityContext_core_v1_k8s1_21Impl = SecurityContext_core_v1_k8s1_20Impl