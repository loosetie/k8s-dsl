...
@K8sDslMarker
interface Cronjobspec_batch_v1beta1_k8s1_16: K8sManifest {
...
Defaults to 1. */
  ...
  val jobTemplate: JobTemplateSpec_batch_v1beta1_k8s1_16?
...
@K8sDslMarker
interface Cronjobspec_batch_v1beta1_k8s1_17: K8sManifest {
  /** Specifies how to treat concurrent executions of a Job. Valid values are: - "Allow" (default): allows CronJobs to run
concurrently; - "Forbid": forbids concurrent runs, skipping next run if previous run hasn't finished yet; - "Replace":
cancels currently running job and replaces it with a new one */
  @K8sDslMarker var concurrencyPolicy: String?
...
Defaults to 1. */
  @K8sDslMarker var failedJobsHistoryLimit: Int?
  /** Specifies the job that will be created when executing a CronJob. */
  val jobTemplate: JobTemplateSpec_batch_v1beta1_k8s1_17?
  /** The schedule in Cron format, see https://en.wikipedia.org/wiki/Cron. */
  @K8sDslMarker var schedule: String?
  /** Optional deadline in seconds for starting the job if it misses scheduled time for any reason. Missed jobs executions
will be counted as failed ones. */
...
@K8sDslMarker
interface Cronjobspec_batch_v1beta1_k8s1_18: K8sManifest {
  /** Specifies how to treat concurrent executions of a Job. Valid values are: - "Allow" (default): allows CronJobs to run
concurrently; - "Forbid": forbids concurrent runs, skipping next run if previous run hasn't finished yet; - "Replace":
cancels currently running job and replaces it with a new one */
  @K8sDslMarker var concurrencyPolicy: String?
...
Defaults to 1. */
  @K8sDslMarker var failedJobsHistoryLimit: Int?
  /** Specifies the job that will be created when executing a CronJob. */
  val jobTemplate: JobTemplateSpec_batch_v1beta1_k8s1_18?
  /** The schedule in Cron format, see https://en.wikipedia.org/wiki/Cron. */
  @K8sDslMarker var schedule: String?
  /** Optional deadline in seconds for starting the job if it misses scheduled time for any reason. Missed jobs executions
will be counted as failed ones. */
...
@K8sDslMarker
interface Cronjobspec_batch_v1beta1_k8s1_19: K8sManifest {
  /** Specifies how to treat concurrent executions of a Job. Valid values are: - "Allow" (default): allows CronJobs to run
concurrently; - "Forbid": forbids concurrent runs, skipping next run if previous run hasn't finished yet; - "Replace":
cancels currently running job and replaces it with a new one */
  @K8sDslMarker var concurrencyPolicy: String?
...
Defaults to 1. */
  @K8sDslMarker var failedJobsHistoryLimit: Int?
  /** Specifies the job that will be created when executing a CronJob. */
  val jobTemplate: JobTemplateSpec_batch_v1beta1_k8s1_19?
  /** The schedule in Cron format, see https://en.wikipedia.org/wiki/Cron. */
  @K8sDslMarker var schedule: String?
  /** Optional deadline in seconds for starting the job if it misses scheduled time for any reason. Missed jobs executions
will be counted as failed ones. */
...
@K8sDslMarker
interface Cronjobspec_batch_v1_k8s1_21: K8sManifest {
  /** Specifies how to treat concurrent executions of a Job. Valid values are: - "Allow" (default): allows CronJobs to run
concurrently; - "Forbid": forbids concurrent runs, skipping next run if previous run hasn't finished yet; - "Replace":
cancels currently running job and replaces it with a new one */
  @K8sDslMarker var concurrencyPolicy: String?
  ...
  @K8sDslMarker var failedJobsHistoryLimit: Int?
  /** Specifies the job that will be created when executing a CronJob. */
  val jobTemplate: JobTemplateSpec_batch_v1_k8s1_21?
  /** The schedule in Cron format, see https://en.wikipedia.org/wiki/Cron. */
  @K8sDslMarker var schedule: String?
  /** Optional deadline in seconds for starting the job if it misses scheduled time for any reason. Missed jobs executions
will be counted as failed ones. */
