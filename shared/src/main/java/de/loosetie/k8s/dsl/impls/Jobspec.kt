...
class Jobspec_batch_v1_k8s1_16Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Jobspec_batch_v1_k8s1_16, HasParent {
...
@JsonPropertyOrder("activeDeadlineSeconds", "backoffLimit", "completions", "manualSelector", "parallelism", "selector", "template", "ttlSecondsAfterFinished")
class Jobspec_batch_v1_k8s1_17Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Jobspec_batch_v1_k8s1_17, HasParent {
  override var activeDeadlineSeconds: Int? = null
  override var backoffLimit: Int? = null
  override var completions: Int? = null
  override var manualSelector: Boolean? = null
...
@JsonPropertyOrder("activeDeadlineSeconds", "backoffLimit", "completions", "manualSelector", "parallelism", "selector", "template", "ttlSecondsAfterFinished")
class Jobspec_batch_v1_k8s1_18Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Jobspec_batch_v1_k8s1_18, HasParent {
  override var activeDeadlineSeconds: Int? = null
  override var backoffLimit: Int? = null
  override var completions: Int? = null
  override var manualSelector: Boolean? = null
...
@JsonPropertyOrder("activeDeadlineSeconds", "backoffLimit", "completions", "manualSelector", "parallelism", "selector", "template", "ttlSecondsAfterFinished")
class Jobspec_batch_v1_k8s1_20Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Jobspec_batch_v1_k8s1_20, HasParent {
  override var activeDeadlineSeconds: Int? = null
  override var backoffLimit: Int? = null
  override var completions: Int? = null
  override var manualSelector: Boolean? = null
...
@JsonPropertyOrder("activeDeadlineSeconds", "backoffLimit", "completionMode", "completions", "manualSelector", "parallelism", "selector", "suspend", "template", "ttlSecondsAfterFinished")
class Jobspec_batch_v1_k8s1_21Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Jobspec_batch_v1_k8s1_21, HasParent {
  override var activeDeadlineSeconds: Int? = null
  override var backoffLimit: Int? = null
