...
@K8sDslMarker
interface StorageClass_storage_k8s_io_v1_k8s1_16: K8sTopLevel, HasMetadata {
...
honored by servers that enable the VolumeScheduling feature. */
  val allowedTopologies: List<TopologySelectorTerm_core_v1_k8s1_16>?
...
@K8sDslMarker
interface StorageClass_storage_k8s_io_v1_k8s1_17: K8sTopLevel, HasMetadata {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas
to the latest internal value, and may reject unrecognized values. More info:
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  override val apiVersion: String
...
topology specifications. An empty TopologySelectorTerm list means there is no topology restriction. This field is only
honored by servers that enable the VolumeScheduling feature. */
  val allowedTopologies: List<TopologySelectorTerm_core_v1_k8s1_17>?
  /** Dynamically provisioned PersistentVolumes of this storage class are created with these mountOptions, e.g. ["ro",
"soft"]. Not validated - mount of the PVs will simply fail if one is invalid. */
  @K8sDslMarker var mountOptions: List<String>?
  /** Parameters holds the parameters for the provisioner that should create volumes of this storage class. */
...
typealias StorageClass_storage_k8s_io_v1_k8s1_18 = StorageClass_storage_k8s_io_v1_k8s1_17       
typealias StorageClass_storage_k8s_io_v1_k8s1_19 = StorageClass_storage_k8s_io_v1_k8s1_18       
typealias StorageClass_storage_k8s_io_v1_k8s1_20 = StorageClass_storage_k8s_io_v1_k8s1_19       
typealias StorageClass_storage_k8s_io_v1_k8s1_21 = StorageClass_storage_k8s_io_v1_k8s1_20 