...
@K8sDslMarker
interface ServiceAccount_core_v1_k8s1_16: K8sTopLevel, HasMetadata {
...
https://kubernetes.io/docs/concepts/configuration/secret */
  val secrets: List<ObjectReference_core_v1_k8s1_16>?
}      
@K8sDslMarker
interface ServiceAccount_core_v1_k8s1_17: K8sTopLevel, HasMetadata {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas
to the latest internal value, and may reject unrecognized values. More info:
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  override val apiVersion: String
...
https://kubernetes.io/docs/concepts/containers/images/#specifying-imagepullsecrets-on-a-pod */
  ...
  /** Secrets is the list of secrets allowed to be used by pods running using this ServiceAccount. More info:
https://kubernetes.io/docs/concepts/configuration/secret */
  val secrets: List<ObjectReference_core_v1_k8s1_17>?
}      
typealias ServiceAccount_core_v1_k8s1_18 = ServiceAccount_core_v1_k8s1_17       
typealias ServiceAccount_core_v1_k8s1_19 = ServiceAccount_core_v1_k8s1_18       
typealias ServiceAccount_core_v1_k8s1_20 = ServiceAccount_core_v1_k8s1_19       
