...
@K8sDslMarker
interface Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_16: K8sManifest {
  /** conversion defines conversion settings for the CRD. */
  val conversion: CustomResourceConversion_apiextensions_k8s_io_v1_k8s1_16?
...
match the name of the CustomResourceDefinition (in the form `<names.plural>.<group>`). */
  ...
  val names: CustomResourceDefinitionNames_apiextensions_k8s_io_v1_k8s1_16?
...
v10beta3, v3beta1, v12alpha1, v11alpha2, foo1, foo10. */
  val versions: List<CustomResourceDefinitionVersion_apiextensions_k8s_io_v1_k8s1_16>?
}      
@K8sDslMarker
interface Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_17: Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_16 {
  /** scope indicates whether the defined custom resource is cluster- or namespace-scoped. Allowed values are `Cluster` and
`Namespaced`. */
  override var scope: String?
}      
typealias Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_18 = Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_17       
typealias Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_19 = Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_18       
typealias Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_20 = Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_19       
typealias Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_21 = Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_20 