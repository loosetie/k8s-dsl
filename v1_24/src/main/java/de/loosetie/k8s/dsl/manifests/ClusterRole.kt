...
@K8sDslMarker
interface ClusterRole_rbac_authorization_k8s_io_v1: K8sTopLevel, HasMetadata {
...
set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller. */
  val aggregationRule: AggregationRule_rbac_authorization_k8s_io_v1?
  /** Rules holds all the PolicyRules for this ClusterRole */
  val rules: List<PolicyRule_rbac_authorization_k8s_io_v1>?
}