...
@K8sDslMarker
interface RuntimeClass_node_k8s_io_v1_k8s1_21: K8sTopLevel, HasMetadata {
...
honored by servers that enable the PodOverhead feature. */
  val overhead: Overhead_node_k8s_io_v1_k8s1_21?
...
that support it. If scheduling is nil, this RuntimeClass is assumed to be supported by all nodes. */
  val scheduling: Scheduling_node_k8s_io_v1_k8s1_21?
}