...
@K8sDslMarker
interface CSIStorageCapacity_storage_k8s_io_v1beta1_k8s1_21: K8sTopLevel, HasMetadata {
...
and treated like zero capacity. */
  val capacity: Quantity_core_resource_k8s1_21?
...
claim. */
  val maximumVolumeSize: Quantity_core_resource_k8s1_21?
...
immutable. */
  val nodeTopology: LabelSelector_meta_v1_k8s1_21?
  /** The name of the StorageClass that the reported capacity applies to. It must meet the same requirements as the name of a
StorageClass object (non-empty, DNS subdomain). If that object no longer exists, the CSIStorageCapacity object is
