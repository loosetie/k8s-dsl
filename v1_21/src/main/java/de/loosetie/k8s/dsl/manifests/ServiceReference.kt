...
@K8sDslMarker
interface ServiceReference_admissionregistration_k8s_io_v1_k8s1_21: K8sManifest {
...
@K8sDslMarker
interface ServiceReference_apiextensions_k8s_io_v1_k8s1_21: K8sManifest {
  /** namespace is the namespace of the service. Required */
  @K8sDslMarker var namespace: String?
  /** name is the name of the service. Required */
  @K8sDslMarker var name: String?
...
@Deprecated(message="Old api version")
@K8sDslMarker
interface ServiceReference_apiregistration_k8s_io_v1_k8s1_21: K8sManifest {
