...
class CSIVolumeSource_core_v1_k8s1_21Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: CSIVolumeSource_core_v1_k8s1_21, HasParent {
  override var driver: String? = null
  override var fsType: String? = null
  override var nodePublishSecretRef: LocalObjectReference_core_v1_k8s1_21? = null
