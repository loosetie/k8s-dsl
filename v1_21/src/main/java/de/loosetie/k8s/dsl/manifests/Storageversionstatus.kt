...
@K8sDslMarker
interface Storageversionstatus_internal_apiserver_k8s_io_v1alpha1_k8s1_21: K8sManifest {
...
write operations, so that this field will be in sync with the reality. */
  ...
  val conditions: List<StorageVersionCondition_internal_apiserver_k8s_io_v1alpha1_k8s1_21>?
  /** The reported versions per API server instance. */
  val storageVersions: List<ServerStorageVersion_internal_apiserver_k8s_io_v1alpha1_k8s1_21>?
}