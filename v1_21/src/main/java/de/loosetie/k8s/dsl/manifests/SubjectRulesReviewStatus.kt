...
@K8sDslMarker
interface SubjectRulesReviewStatus_authorization_k8s_io_v1_k8s1_21: K8sManifest {
...
significant, may contain duplicates, and possibly be incomplete. */
  val nonResourceRules: List<NonResourceRule_authorization_k8s_io_v1_k8s1_21>?
  /** ResourceRules is the list of actions the subject is allowed to perform on resources. The list ordering isn't
significant, may contain duplicates, and possibly be incomplete. */
  val resourceRules: List<ResourceRule_authorization_k8s_io_v1_k8s1_21>?
}