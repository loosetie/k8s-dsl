...
class Replicationcontrollerstatus_core_v1_k8s1_21Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Replicationcontrollerstatus_core_v1_k8s1_21, HasParent {
  override var availableReplicas: Int? = null
  override var conditions: List<ReplicationControllerCondition_core_v1_k8s1_21>? = null
