...
@K8sDslMarker
interface Podsecuritypolicyspec_policy_v1beta1_k8s1_21: K8sManifest {
...
honored if the API server enables the CSIInlineVolume feature gate. */
  val allowedCSIDrivers: List<AllowedCSIDriver_policy_v1beta1_k8s1_21>?
...
parameter is effective only when the usage of the Flexvolumes is allowed in the "volumes" field. */
  val allowedFlexVolumes: List<AllowedFlexVolume_policy_v1beta1_k8s1_21>?
  /** allowedHostPaths is an allowlist of host paths. Empty indicates that all host paths may be used. */
  val allowedHostPaths: List<AllowedHostPath_policy_v1beta1_k8s1_21>?
...
forbidden. Examples: e.g. "foo/`*`" forbids "foo/bar", "foo/baz", etc. e.g. "foo.`*`" forbids "foo.bar", "foo.baz", etc. */
  ...
  val fsGroup: FSGroupStrategyOptions_policy_v1beta1_k8s1_21?
  ...
  val hostPorts: List<HostPortRange_policy_v1beta1_k8s1_21>?
...
the pod's RunAsGroup can take any value. This field requires the RunAsGroup feature gate to be enabled. */
  val runAsGroup: RunAsGroupStrategyOptions_policy_v1beta1_k8s1_21?
  /** runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set. */
  val runAsUser: RunAsUserStrategyOptions_policy_v1beta1_k8s1_21?
...
enabled. */
  val runtimeClass: RuntimeClassStrategyOptions_policy_v1beta1_k8s1_21?
  /** seLinux is the strategy that will dictate the allowable labels that may be set. */
  val seLinux: SELinuxStrategyOptions_policy_v1beta1_k8s1_21?
  /** supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext. */
  val supplementalGroups: SupplementalGroupsStrategyOptions_policy_v1beta1_k8s1_21?
