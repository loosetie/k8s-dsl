...
@K8sDslMarker
interface NodeAffinity_core_v1_k8s1_21: K8sManifest {
...
the most preferred. */
  val preferredDuringSchedulingIgnoredDuringExecution: List<PreferredSchedulingTerm_core_v1_k8s1_21>?
...
due to an update), the system may or may not try to eventually evict the pod from its node. */
  val requiredDuringSchedulingIgnoredDuringExecution: NodeSelector_core_v1_k8s1_21?
}