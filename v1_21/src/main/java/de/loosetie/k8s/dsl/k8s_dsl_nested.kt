...
fun APIGroup.preferredVersion(init: GroupVersionForDiscovery.() -> Unit) {
  this as APIGroup_meta_v1_k8s1_21Impl
  GroupVersionForDiscovery_meta_v1_k8s1_21Impl(this)
...
fun APIGroup.serverAddressByClientCIDRs(init: ServerAddressByClientCIDR.() -> Unit) {
  this as APIGroup_meta_v1_k8s1_21Impl
  ServerAddressByClientCIDR_meta_v1_k8s1_21Impl(this)
...
fun APIServiceCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as APIServiceCondition_apiregistration_k8s_io_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
...
fun APIService.metadata(init: ObjectMeta.() -> Unit) {
  this as APIService_apiregistration_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun APIService.spec(init: Apiservicespec.() -> Unit) {
  this as APIService_apiregistration_k8s_io_v1_k8s1_21Impl
  Apiservicespec_apiregistration_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun APIService.status(init: Apiservicestatus.() -> Unit) {
  this as APIService_apiregistration_k8s_io_v1_k8s1_21Impl
  Apiservicestatus_apiregistration_k8s_io_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun APIVersions.serverAddressByClientCIDRs(init: ServerAddressByClientCIDR.() -> Unit) {
  this as APIVersions_meta_v1_k8s1_21Impl
  ServerAddressByClientCIDR_meta_v1_k8s1_21Impl(this)
    .also { serverAddressByClientCIDRs = serverAddressByClientCIDRs?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Affinity.nodeAffinity(init: NodeAffinity.() -> Unit) {
  this as Affinity_core_v1_k8s1_21Impl
  NodeAffinity_core_v1_k8s1_21Impl(this)
...
fun Affinity.podAffinity(init: PodAffinity.() -> Unit) {
  this as Affinity_core_v1_k8s1_21Impl
  PodAffinity_core_v1_k8s1_21Impl(this)
    .also { podAffinity = it }
    .apply(init)
}
...
fun Affinity.podAntiAffinity(init: PodAntiAffinity.() -> Unit) {
  this as Affinity_core_v1_k8s1_21Impl
  PodAntiAffinity_core_v1_k8s1_21Impl(this)
...
fun AggregationRule.clusterRoleSelectors(init: LabelSelector.() -> Unit) {
  this as AggregationRule_rbac_authorization_k8s_io_v1_k8s1_21Impl
  LabelSelector_meta_v1_k8s1_21Impl(this)
...
fun Binding.metadata(init: ObjectMeta.() -> Unit) {
  this as Binding_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Binding.target(init: ObjectReference.() -> Unit) {
  this as Binding_core_v1_k8s1_21Impl
  ObjectReference_core_v1_k8s1_21Impl(this)
    .also { target = it }
    .apply(init)
}
...
fun CSIDriver.metadata(init: ObjectMeta.() -> Unit) {
  this as CSIDriver_storage_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CSIDriver.spec(init: Csidriverspec.() -> Unit) {
  this as CSIDriver_storage_k8s_io_v1_k8s1_21Impl
  Csidriverspec_storage_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun CSINodeDriver.allocatable(init: VolumeNodeResources.() -> Unit) {
  this as CSINodeDriver_storage_k8s_io_v1_k8s1_21Impl
  VolumeNodeResources_storage_k8s_io_v1_k8s1_21Impl(this)
    .also { allocatable = it }
    .apply(init)
}
...
fun CSINode.metadata(init: ObjectMeta.() -> Unit) {
  this as CSINode_storage_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CSINode.spec(init: Csinodespec.() -> Unit) {
  this as CSINode_storage_k8s_io_v1_k8s1_21Impl
  Csinodespec_storage_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun CSIPersistentVolumeSource.controllerExpandSecretRef(init: SecretReference.() -> Unit) {
  this as CSIPersistentVolumeSource_core_v1_k8s1_21Impl
  SecretReference_core_v1_k8s1_21Impl(this)
...
fun CSIStorageCapacity.capacity(init: Quantity.() -> Unit) {
  this as CSIStorageCapacity_storage_k8s_io_v1beta1_k8s1_21Impl
  Quantity_core_resource_k8s1_21Impl(this)
    .also { capacity = it }
    .apply(init)
}
...
fun CSIVolumeSource.nodePublishSecretRef(init: LocalObjectReference.() -> Unit) {
  this as CSIVolumeSource_core_v1_k8s1_21Impl
  LocalObjectReference_core_v1_k8s1_21Impl(this)
    .also { nodePublishSecretRef = it }
    .apply(init)
}
...
fun CephFSPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as CephFSPersistentVolumeSource_core_v1_k8s1_21Impl
  SecretReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun CephFSVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as CephFSVolumeSource_core_v1_k8s1_21Impl
  LocalObjectReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun CertificateSigningRequestCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as CertificateSigningRequestCondition_certificates_k8s_io_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun CertificateSigningRequest.metadata(init: ObjectMeta.() -> Unit) {
  this as CertificateSigningRequest_certificates_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CertificateSigningRequest.spec(init: Certificatesigningrequestspec.() -> Unit) {
  this as CertificateSigningRequest_certificates_k8s_io_v1_k8s1_21Impl
  Certificatesigningrequestspec_certificates_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun CertificateSigningRequest.status(init: Certificatesigningrequeststatus.() -> Unit) {
  this as CertificateSigningRequest_certificates_k8s_io_v1_k8s1_21Impl
  Certificatesigningrequeststatus_certificates_k8s_io_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun CinderPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as CinderPersistentVolumeSource_core_v1_k8s1_21Impl
  SecretReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun CinderVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as CinderVolumeSource_core_v1_k8s1_21Impl
  LocalObjectReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun ClusterRoleBinding.metadata(init: ObjectMeta.() -> Unit) {
  this as ClusterRoleBinding_rbac_authorization_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ClusterRoleBinding.roleRef(init: RoleRef.() -> Unit) {
  this as ClusterRoleBinding_rbac_authorization_k8s_io_v1_k8s1_21Impl
  RoleRef_rbac_authorization_k8s_io_v1_k8s1_21Impl(this)
    .also { roleRef = it }
    .apply(init)
}
...
@K8sDslMarker
fun ClusterRoleBinding.subjects(init: Subject_rbac_authorization_k8s_io_v1_k8s1_21.() -> Unit) {
  this as ClusterRoleBinding_rbac_authorization_k8s_io_v1_k8s1_21Impl
  Subject_rbac_authorization_k8s_io_v1_k8s1_21Impl(this)
...
fun ClusterRole.aggregationRule(init: AggregationRule.() -> Unit) {
  this as ClusterRole_rbac_authorization_k8s_io_v1_k8s1_21Impl
  AggregationRule_rbac_authorization_k8s_io_v1_k8s1_21Impl(this)
...
fun ClusterRole.rules(init: PolicyRule.() -> Unit) {
  this as ClusterRole_rbac_authorization_k8s_io_v1_k8s1_21Impl
  PolicyRule_rbac_authorization_k8s_io_v1_k8s1_21Impl(this)
...
fun ComponentStatus.conditions(init: ComponentCondition.() -> Unit) {
  this as ComponentStatus_core_v1_k8s1_21Impl
  ComponentCondition_core_v1_k8s1_21Impl(this)
...
fun Condition.lastTransitionTime(init: Time.() -> Unit) {
  this as Condition_meta_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun ConfigMapProjection.items(init: KeyToPath.() -> Unit) {
  this as ConfigMapProjection_core_v1_k8s1_21Impl
  KeyToPath_core_v1_k8s1_21Impl(this)
...
fun ConfigMapVolumeSource.items(init: KeyToPath.() -> Unit) {
  this as ConfigMapVolumeSource_core_v1_k8s1_21Impl
  KeyToPath_core_v1_k8s1_21Impl(this)
    .also { items = items?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun ConfigMap.metadata(init: ObjectMeta.() -> Unit) {
  this as ConfigMap_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ContainerResourceMetricSource.target(init: MetricTarget.() -> Unit) {
  this as ContainerResourceMetricSource_autoscaling_v2beta2_k8s1_21Impl
  MetricTarget_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { target = it }
    .apply(init)
}
...
fun ContainerResourceMetricStatus.current(init: MetricValueStatus.() -> Unit) {
  this as ContainerResourceMetricStatus_autoscaling_v2beta2_k8s1_21Impl
  MetricValueStatus_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { current = it }
    .apply(init)
}
...
fun ContainerStateRunning.startedAt(init: Time.() -> Unit) {
  this as ContainerStateRunning_core_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { startedAt = it }
    .apply(init)
}
...
fun ContainerStateTerminated.finishedAt(init: Time.() -> Unit) {
  this as ContainerStateTerminated_core_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { finishedAt = it }
    .apply(init)
}
...
fun ContainerState.running(init: ContainerStateRunning.() -> Unit) {
  this as ContainerState_core_v1_k8s1_21Impl
  ContainerStateRunning_core_v1_k8s1_21Impl(this)
    .also { running = it }
    .apply(init)
}
...
fun ContainerState.terminated(init: ContainerStateTerminated.() -> Unit) {
  this as ContainerState_core_v1_k8s1_21Impl
  ContainerStateTerminated_core_v1_k8s1_21Impl(this)
    .also { terminated = it }
    .apply(init)
}
...
fun ContainerState.waiting(init: ContainerStateWaiting.() -> Unit) {
  this as ContainerState_core_v1_k8s1_21Impl
  ContainerStateWaiting_core_v1_k8s1_21Impl(this)
    .also { waiting = it }
    .apply(init)
}
...
fun Container.env(init: EnvVar.() -> Unit) {
  this as Container_core_v1_k8s1_21Impl
  EnvVar_core_v1_k8s1_21Impl(this)
...
fun Container.envFrom(init: EnvFromSource.() -> Unit) {
  this as Container_core_v1_k8s1_21Impl
  EnvFromSource_core_v1_k8s1_21Impl(this)
...
fun Container.lifecycle(init: Lifecycle.() -> Unit) {
  this as Container_core_v1_k8s1_21Impl
  Lifecycle_core_v1_k8s1_21Impl(this)
    .also { lifecycle = it }
    .apply(init)
}
...
fun Container.livenessProbe(init: Probe.() -> Unit) {
  this as Container_core_v1_k8s1_21Impl
  Probe_core_v1_k8s1_21Impl(this)
...
fun Container.ports(init: ContainerPort.() -> Unit) {
  this as Container_core_v1_k8s1_21Impl
  ContainerPort_core_v1_k8s1_21Impl(this)
...
fun Container.resources(init: ResourceRequirements.() -> Unit) {
  this as Container_core_v1_k8s1_21Impl
  ResourceRequirements_core_v1_k8s1_21Impl(this)
    .also { resources = it }
    .apply(init)
}
...
fun Container.securityContext(init: SecurityContext.() -> Unit) {
  this as Container_core_v1_k8s1_21Impl
  SecurityContext_core_v1_k8s1_21Impl(this)
...
fun Container.volumeDevices(init: VolumeDevice.() -> Unit) {
  this as Container_core_v1_k8s1_21Impl
  VolumeDevice_core_v1_k8s1_21Impl(this)
...
fun Container.volumeMounts(init: VolumeMount.() -> Unit) {
  this as Container_core_v1_k8s1_21Impl
  VolumeMount_core_v1_k8s1_21Impl(this)
...
fun ControllerRevision.metadata(init: ObjectMeta.() -> Unit) {
  this as ControllerRevision_apps_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CronJob.metadata(init: ObjectMeta.() -> Unit) {
  this as CronJob_batch_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CronJob.spec(init: Cronjobspec.() -> Unit) {
  this as CronJob_batch_v1_k8s1_21Impl
  Cronjobspec_batch_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun CronJob.status(init: Cronjobstatus.() -> Unit) {
  this as CronJob_batch_v1_k8s1_21Impl
  Cronjobstatus_batch_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun CustomResourceConversion.webhook(init: WebhookConversion.() -> Unit) {
  this as CustomResourceConversion_apiextensions_k8s_io_v1_k8s1_21Impl
  WebhookConversion_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { webhook = it }
    .apply(init)
}
...
fun CustomResourceDefinitionCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as CustomResourceDefinitionCondition_apiextensions_k8s_io_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun CustomResourceDefinitionVersion.additionalPrinterColumns(init: CustomResourceColumnDefinition.() -> Unit) {
  this as CustomResourceDefinitionVersion_apiextensions_k8s_io_v1_k8s1_21Impl
  CustomResourceColumnDefinition_apiextensions_k8s_io_v1_k8s1_21Impl(this)
...
fun CustomResourceDefinitionVersion.schema(init: CustomResourceValidation.() -> Unit) {
  this as CustomResourceDefinitionVersion_apiextensions_k8s_io_v1_k8s1_21Impl
  CustomResourceValidation_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { schema = it }
    .apply(init)
}
...
fun CustomResourceDefinitionVersion.subresources(init: CustomResourceSubresources.() -> Unit) {
  this as CustomResourceDefinitionVersion_apiextensions_k8s_io_v1_k8s1_21Impl
  CustomResourceSubresources_apiextensions_k8s_io_v1_k8s1_21Impl(this)
...
fun CustomResourceDefinition.metadata(init: ObjectMeta.() -> Unit) {
  this as CustomResourceDefinition_apiextensions_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun CustomResourceDefinition.spec(init: Customresourcedefinitionspec.() -> Unit) {
  this as CustomResourceDefinition_apiextensions_k8s_io_v1_k8s1_21Impl
  Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun CustomResourceDefinition.status(init: Customresourcedefinitionstatus.() -> Unit) {
  this as CustomResourceDefinition_apiextensions_k8s_io_v1_k8s1_21Impl
  Customresourcedefinitionstatus_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun CustomResourceSubresources.scale(init: CustomResourceSubresourceScale.() -> Unit) {
  this as CustomResourceSubresources_apiextensions_k8s_io_v1_k8s1_21Impl
  CustomResourceSubresourceScale_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { scale = it }
    .apply(init)
}
...
fun CustomResourceSubresources.status(init: CustomResourceSubresourceStatus.() -> Unit) {
  this as CustomResourceSubresources_apiextensions_k8s_io_v1_k8s1_21Impl
  CustomResourceSubresourceStatus_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun CustomResourceValidation.openAPIV3Schema(init: JSONSchemaProps.() -> Unit) {
  this as CustomResourceValidation_apiextensions_k8s_io_v1_k8s1_21Impl
  JSONSchemaProps_apiextensions_k8s_io_v1_k8s1_21Impl(this)
...
fun DaemonSetCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as DaemonSetCondition_apps_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun DaemonSetUpdateStrategy.rollingUpdate(init: Rollingupdatedaemonset.() -> Unit) {
  this as DaemonSetUpdateStrategy_apps_v1_k8s1_21Impl
  Rollingupdatedaemonset_apps_v1_k8s1_21Impl(this)
...
fun DaemonSet.metadata(init: ObjectMeta.() -> Unit) {
  this as DaemonSet_apps_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun DaemonSet.spec(init: Daemonsetspec.() -> Unit) {
  this as DaemonSet_apps_v1_k8s1_21Impl
  Daemonsetspec_apps_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun DaemonSet.status(init: Daemonsetstatus.() -> Unit) {
  this as DaemonSet_apps_v1_k8s1_21Impl
  Daemonsetstatus_apps_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun DeleteOptions.preconditions(init: Preconditions.() -> Unit) {
  this as DeleteOptions_meta_v1_k8s1_21Impl
  Preconditions_meta_v1_k8s1_21Impl(this)
...
fun DeploymentCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as DeploymentCondition_apps_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun Deployment.metadata(init: ObjectMeta.() -> Unit) {
  this as Deployment_apps_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Deployment.spec(init: Deploymentspec.() -> Unit) {
  this as Deployment_apps_v1_k8s1_21Impl
  Deploymentspec_apps_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Deployment.status(init: Deploymentstatus.() -> Unit) {
  this as Deployment_apps_v1_k8s1_21Impl
  Deploymentstatus_apps_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun DownwardAPIProjection.items(init: DownwardAPIVolumeFile.() -> Unit) {
  this as DownwardAPIProjection_core_v1_k8s1_21Impl
  DownwardAPIVolumeFile_core_v1_k8s1_21Impl(this)
    .also { items = items?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun DownwardAPIVolumeFile.fieldRef(init: ObjectFieldSelector.() -> Unit) {
  this as DownwardAPIVolumeFile_core_v1_k8s1_21Impl
  ObjectFieldSelector_core_v1_k8s1_21Impl(this)
    .also { fieldRef = it }
    .apply(init)
}
...
fun DownwardAPIVolumeFile.resourceFieldRef(init: ResourceFieldSelector.() -> Unit) {
  this as DownwardAPIVolumeFile_core_v1_k8s1_21Impl
  ResourceFieldSelector_core_v1_k8s1_21Impl(this)
...
fun DownwardAPIVolumeSource.items(init: DownwardAPIVolumeFile.() -> Unit) {
  this as DownwardAPIVolumeSource_core_v1_k8s1_21Impl
  DownwardAPIVolumeFile_core_v1_k8s1_21Impl(this)
    .also { items = items?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun EmptyDirVolumeSource.sizeLimit(init: Quantity.() -> Unit) {
  this as EmptyDirVolumeSource_core_v1_k8s1_21Impl
  Quantity_core_resource_k8s1_21Impl(this)
    .also { sizeLimit = it }
    .apply(init)
}
...
fun EndpointAddress.targetRef(init: ObjectReference.() -> Unit) {
  this as EndpointAddress_core_v1_k8s1_21Impl
  ObjectReference_core_v1_k8s1_21Impl(this)
    .also { targetRef = it }
    .apply(init)
}
...
fun EndpointHints.forZones(init: ForZone.() -> Unit) {
  this as EndpointHints_discovery_k8s_io_v1_k8s1_21Impl
  ForZone_discovery_k8s_io_v1_k8s1_21Impl(this)
...
fun EndpointSlice.endpoints(init: Endpoint.() -> Unit) {
  this as EndpointSlice_discovery_k8s_io_v1_k8s1_21Impl
  Endpoint_discovery_k8s_io_v1_k8s1_21Impl(this)
...
@K8sDslMarker
fun EndpointSlice.ports(init: EndpointPort_discovery_k8s_io_v1_k8s1_21.() -> Unit) {
  this as EndpointSlice_discovery_k8s_io_v1_k8s1_21Impl
  EndpointPort_discovery_k8s_io_v1_k8s1_21Impl(this)
    .also { ports = ports?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun EndpointSubset.addresses(init: EndpointAddress.() -> Unit) {
  this as EndpointSubset_core_v1_k8s1_21Impl
  EndpointAddress_core_v1_k8s1_21Impl(this)
...
fun EndpointSubset.ports(init: EndpointPort.() -> Unit) {
  this as EndpointSubset_core_v1_k8s1_21Impl
  EndpointPort_core_v1_k8s1_21Impl(this)
    .also { ports = ports?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Endpoint.conditions(init: EndpointConditions.() -> Unit) {
  this as Endpoint_discovery_k8s_io_v1_k8s1_21Impl
  EndpointConditions_discovery_k8s_io_v1_k8s1_21Impl(this)
    .also { conditions = it }
    .apply(init)
}
...
fun Endpoint.hints(init: EndpointHints.() -> Unit) {
  this as Endpoint_discovery_k8s_io_v1_k8s1_21Impl
  EndpointHints_discovery_k8s_io_v1_k8s1_21Impl(this)
    .also { hints = it }
    .apply(init)
}
...
fun Endpoints.metadata(init: ObjectMeta.() -> Unit) {
  this as Endpoints_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Endpoints.subsets(init: EndpointSubset.() -> Unit) {
  this as Endpoints_core_v1_k8s1_21Impl
  EndpointSubset_core_v1_k8s1_21Impl(this)
...
fun EnvFromSource.configMapRef(init: ConfigMapEnvSource.() -> Unit) {
  this as EnvFromSource_core_v1_k8s1_21Impl
  ConfigMapEnvSource_core_v1_k8s1_21Impl(this)
...
fun EnvFromSource.secretRef(init: SecretEnvSource.() -> Unit) {
  this as EnvFromSource_core_v1_k8s1_21Impl
  SecretEnvSource_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun EnvVarSource.configMapKeyRef(init: ConfigMapKeySelector.() -> Unit) {
  this as EnvVarSource_core_v1_k8s1_21Impl
  ConfigMapKeySelector_core_v1_k8s1_21Impl(this)
...
fun EnvVarSource.secretKeyRef(init: SecretKeySelector.() -> Unit) {
  this as EnvVarSource_core_v1_k8s1_21Impl
  SecretKeySelector_core_v1_k8s1_21Impl(this)
...
fun EnvVar.valueFrom(init: EnvVarSource.() -> Unit) {
  this as EnvVar_core_v1_k8s1_21Impl
  EnvVarSource_core_v1_k8s1_21Impl(this)
    .also { valueFrom = it }
    .apply(init)
}
...
fun EphemeralContainer.env(init: EnvVar.() -> Unit) {
  this as EphemeralContainer_core_v1_k8s1_21Impl
  EnvVar_core_v1_k8s1_21Impl(this)
    .also { env = env?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
@K8sDslMarker
fun EphemeralContainers.ephemeralContainers(init: EphemeralContainer.() -> Unit) {
  this as EphemeralContainers_core_v1_k8s1_21Impl
  EphemeralContainer_core_v1_k8s1_21Impl(this)
...
/**  */
@K8sDslMarker
fun EphemeralContainers.metadata(init: ObjectMeta.() -> Unit) {
  this as EphemeralContainers_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
...
fun EphemeralVolumeSource.volumeClaimTemplate(init: PersistentVolumeClaimTemplate.() -> Unit) {
  this as EphemeralVolumeSource_core_v1_k8s1_21Impl
  PersistentVolumeClaimTemplate_core_v1_k8s1_21Impl(this)
...
fun EventSeries.lastObservedTime(init: MicroTime.() -> Unit) {
  this as EventSeries_core_v1_k8s1_21Impl
  MicroTime_meta_v1_k8s1_21Impl(this)
...
fun Event.eventTime(init: MicroTime.() -> Unit) {
  this as Event_core_v1_k8s1_21Impl
  MicroTime_meta_v1_k8s1_21Impl(this)
    .also { eventTime = it }
    .apply(init)
}
...
fun Event.series(init: EventSeries.() -> Unit) {
  this as Event_core_v1_k8s1_21Impl
  EventSeries_core_v1_k8s1_21Impl(this)
    .also { series = it }
    .apply(init)
}
...
fun Event.source(init: EventSource.() -> Unit) {
  this as Event_core_v1_k8s1_21Impl
  EventSource_core_v1_k8s1_21Impl(this)
    .also { source = it }
    .apply(init)
}
...
fun Eviction.deleteOptions(init: DeleteOptions.() -> Unit) {
  this as Eviction_policy_v1beta1_k8s1_21Impl
  DeleteOptions_meta_v1_k8s1_21Impl(this)
...
fun ExternalMetricSource.metric(init: MetricIdentifier.() -> Unit) {
  this as ExternalMetricSource_autoscaling_v2beta2_k8s1_21Impl
  MetricIdentifier_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { metric = it }
    .apply(init)
}
...
fun ExternalMetricStatus.current(init: MetricValueStatus.() -> Unit) {
  this as ExternalMetricStatus_autoscaling_v2beta2_k8s1_21Impl
  MetricValueStatus_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { current = it }
    .apply(init)
}
...
fun FSGroupStrategyOptions.ranges(init: IDRange.() -> Unit) {
  this as FSGroupStrategyOptions_policy_v1beta1_k8s1_21Impl
  IDRange_policy_v1beta1_k8s1_21Impl(this)
...
fun FlexPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as FlexPersistentVolumeSource_core_v1_k8s1_21Impl
  SecretReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun FlexVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as FlexVolumeSource_core_v1_k8s1_21Impl
  LocalObjectReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun FlowSchemaCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as FlowSchemaCondition_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun FlowSchema.metadata(init: ObjectMeta.() -> Unit) {
  this as FlowSchema_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun FlowSchema.spec(init: Flowschemaspec.() -> Unit) {
  this as FlowSchema_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  Flowschemaspec_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun FlowSchema.status(init: Flowschemastatus.() -> Unit) {
  this as FlowSchema_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  Flowschemastatus_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun HPAScalingRules.policies(init: HPAScalingPolicy.() -> Unit) {
  this as HPAScalingRules_autoscaling_v2beta2_k8s1_21Impl
  HPAScalingPolicy_autoscaling_v2beta2_k8s1_21Impl(this)
...
fun HTTPGetAction.httpHeaders(init: HTTPHeader.() -> Unit) {
  this as HTTPGetAction_core_v1_k8s1_21Impl
  HTTPHeader_core_v1_k8s1_21Impl(this)
...
fun HTTPIngressPath.backend(init: IngressBackend.() -> Unit) {
  this as HTTPIngressPath_networking_k8s_io_v1_k8s1_21Impl
  IngressBackend_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { backend = it }
    .apply(init)
}
...
fun HTTPIngressRuleValue.paths(init: HTTPIngressPath.() -> Unit) {
  this as HTTPIngressRuleValue_networking_k8s_io_v1_k8s1_21Impl
  HTTPIngressPath_networking_k8s_io_v1_k8s1_21Impl(this)
...
fun Handler.exec(init: ExecAction.() -> Unit) {
  this as Handler_core_v1_k8s1_21Impl
  ExecAction_core_v1_k8s1_21Impl(this)
    .also { exec = it }
    .apply(init)
}
...
fun Handler.httpGet(init: HTTPGetAction.() -> Unit) {
  this as Handler_core_v1_k8s1_21Impl
  HTTPGetAction_core_v1_k8s1_21Impl(this)
    .also { httpGet = it }
    .apply(init)
}
...
fun Handler.tcpSocket(init: TCPSocketAction.() -> Unit) {
  this as Handler_core_v1_k8s1_21Impl
  TCPSocketAction_core_v1_k8s1_21Impl(this)
    .also { tcpSocket = it }
    .apply(init)
}
...
fun HorizontalPodAutoscalerBehavior.scaleDown(init: HPAScalingRules.() -> Unit) {
  this as HorizontalPodAutoscalerBehavior_autoscaling_v2beta2_k8s1_21Impl
  HPAScalingRules_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { scaleDown = it }
    .apply(init)
}
...
fun HorizontalPodAutoscalerCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as HorizontalPodAutoscalerCondition_autoscaling_v2beta2_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun HorizontalPodAutoscaler.metadata(init: ObjectMeta.() -> Unit) {
  this as HorizontalPodAutoscaler_autoscaling_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun HorizontalPodAutoscaler.spec(init: Horizontalpodautoscalerspec.() -> Unit) {
  this as HorizontalPodAutoscaler_autoscaling_v1_k8s1_21Impl
  Horizontalpodautoscalerspec_autoscaling_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun HorizontalPodAutoscaler.status(init: Horizontalpodautoscalerstatus.() -> Unit) {
  this as HorizontalPodAutoscaler_autoscaling_v1_k8s1_21Impl
  Horizontalpodautoscalerstatus_autoscaling_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun ISCSIPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as ISCSIPersistentVolumeSource_core_v1_k8s1_21Impl
  SecretReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun ISCSIVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as ISCSIVolumeSource_core_v1_k8s1_21Impl
  LocalObjectReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun IngressBackend.resource(init: TypedLocalObjectReference.() -> Unit) {
  this as IngressBackend_networking_k8s_io_v1_k8s1_21Impl
  TypedLocalObjectReference_core_v1_k8s1_21Impl(this)
    .also { resource = it }
    .apply(init)
}
...
fun IngressBackend.service(init: IngressServiceBackend.() -> Unit) {
  this as IngressBackend_networking_k8s_io_v1_k8s1_21Impl
  IngressServiceBackend_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { service = it }
    .apply(init)
}
...
fun IngressClass.metadata(init: ObjectMeta.() -> Unit) {
  this as IngressClass_networking_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun IngressClass.spec(init: Ingressclassspec.() -> Unit) {
  this as IngressClass_networking_k8s_io_v1_k8s1_21Impl
  Ingressclassspec_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun IngressRule.http(init: HTTPIngressRuleValue.() -> Unit) {
  this as IngressRule_networking_k8s_io_v1_k8s1_21Impl
  HTTPIngressRuleValue_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { http = it }
    .apply(init)
}
...
fun IngressServiceBackend.port(init: ServiceBackendPort.() -> Unit) {
  this as IngressServiceBackend_networking_k8s_io_v1_k8s1_21Impl
  ServiceBackendPort_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { port = it }
    .apply(init)
}
...
fun Ingress.metadata(init: ObjectMeta.() -> Unit) {
  this as Ingress_networking_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Ingress.spec(init: Ingressspec.() -> Unit) {
  this as Ingress_networking_k8s_io_v1_k8s1_21Impl
  Ingressspec_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Ingress.status(init: Ingressstatus.() -> Unit) {
  this as Ingress_networking_k8s_io_v1_k8s1_21Impl
  Ingressstatus_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun JSONSchemaProps.additionalItems(init: JSONSchemaPropsOrBool.() -> Unit) {
  this as JSONSchemaProps_apiextensions_k8s_io_v1_k8s1_21Impl
  JSONSchemaPropsOrBool_apiextensions_k8s_io_v1_k8s1_21Impl(this)
...
fun JSONSchemaProps.default(init: JSON.() -> Unit) {
  this as JSONSchemaProps_apiextensions_k8s_io_v1_k8s1_21Impl
  JSON_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { default = it }
    .apply(init)
}
...
fun JSONSchemaProps.externalDocs(init: ExternalDocumentation.() -> Unit) {
  this as JSONSchemaProps_apiextensions_k8s_io_v1_k8s1_21Impl
  ExternalDocumentation_apiextensions_k8s_io_v1_k8s1_21Impl(this)
...
fun JSONSchemaProps.items(init: JSONSchemaPropsOrArray.() -> Unit) {
  this as JSONSchemaProps_apiextensions_k8s_io_v1_k8s1_21Impl
  JSONSchemaPropsOrArray_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { items = it }
    .apply(init)
}
...
fun JobCondition.lastProbeTime(init: Time.() -> Unit) {
  this as JobCondition_batch_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
...
fun JobTemplateSpec.metadata(init: ObjectMeta.() -> Unit) {
  this as JobTemplateSpec_batch_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun JobTemplateSpec.spec(init: Jobspec.() -> Unit) {
  this as JobTemplateSpec_batch_v1_k8s1_21Impl
  Jobspec_batch_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Job.metadata(init: ObjectMeta.() -> Unit) {
  this as Job_batch_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Job.status(init: Jobstatus.() -> Unit) {
  this as Job_batch_v1_k8s1_21Impl
  Jobstatus_batch_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun LabelSelector.matchExpressions(init: LabelSelectorRequirement.() -> Unit) {
  this as LabelSelector_meta_v1_k8s1_21Impl
  LabelSelectorRequirement_meta_v1_k8s1_21Impl(this)
...
fun Lease.metadata(init: ObjectMeta.() -> Unit) {
  this as Lease_coordination_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Lease.spec(init: Leasespec.() -> Unit) {
  this as Lease_coordination_k8s_io_v1_k8s1_21Impl
  Leasespec_coordination_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Lifecycle.postStart(init: Handler.() -> Unit) {
  this as Lifecycle_core_v1_k8s1_21Impl
  Handler_core_v1_k8s1_21Impl(this)
    .also { postStart = it }
    .apply(init)
}
...
fun LimitRangeItem.default(init: de.loosetie.k8s.dsl.types.CpuMem.() -> Unit) {
  this as LimitRangeItem_core_v1_k8s1_21Impl
...
fun LimitRange.metadata(init: ObjectMeta.() -> Unit) {
  this as LimitRange_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun LimitRange.spec(init: Limitrangespec.() -> Unit) {
  this as LimitRange_core_v1_k8s1_21Impl
  Limitrangespec_core_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun LimitResponse.queuing(init: QueuingConfiguration.() -> Unit) {
  this as LimitResponse_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  QueuingConfiguration_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { queuing = it }
    .apply(init)
}
...
fun LimitedPriorityLevelConfiguration.limitResponse(init: LimitResponse.() -> Unit) {
  this as LimitedPriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  LimitResponse_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
...
fun LoadBalancerIngress.ports(init: PortStatus.() -> Unit) {
  this as LoadBalancerIngress_core_v1_k8s1_21Impl
  PortStatus_core_v1_k8s1_21Impl(this)
    .also { ports = ports?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun LoadBalancerStatus.ingress(init: LoadBalancerIngress.() -> Unit) {
  this as LoadBalancerStatus_core_v1_k8s1_21Impl
  LoadBalancerIngress_core_v1_k8s1_21Impl(this)
...
fun LocalSubjectAccessReview.metadata(init: ObjectMeta.() -> Unit) {
  this as LocalSubjectAccessReview_authorization_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun LocalSubjectAccessReview.spec(init: Subjectaccessreviewspec.() -> Unit) {
  this as LocalSubjectAccessReview_authorization_k8s_io_v1_k8s1_21Impl
  Subjectaccessreviewspec_authorization_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun LocalSubjectAccessReview.status(init: Subjectaccessreviewstatus.() -> Unit) {
  this as LocalSubjectAccessReview_authorization_k8s_io_v1_k8s1_21Impl
  Subjectaccessreviewstatus_authorization_k8s_io_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun ManagedFieldsEntry.fieldsV1(init: FieldsV1.() -> Unit) {
  this as ManagedFieldsEntry_meta_v1_k8s1_21Impl
  FieldsV1_meta_v1_k8s1_21Impl(this)
    .also { fieldsV1 = it }
    .apply(init)
}
...
fun MetricIdentifier.selector(init: LabelSelector.() -> Unit) {
  this as MetricIdentifier_autoscaling_v2beta2_k8s1_21Impl
  LabelSelector_meta_v1_k8s1_21Impl(this)
    .also { selector = it }
    .apply(init)
}
...
fun MetricSpec.containerResource(init: ContainerResourceMetricSource.() -> Unit) {
  this as MetricSpec_autoscaling_v2beta2_k8s1_21Impl
  ContainerResourceMetricSource_autoscaling_v2beta2_k8s1_21Impl(this)
...
fun MetricSpec.external(init: ExternalMetricSource.() -> Unit) {
  this as MetricSpec_autoscaling_v2beta2_k8s1_21Impl
  ExternalMetricSource_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { external = it }
    .apply(init)
}
...
fun MetricSpec.`object`(init: ObjectMetricSource.() -> Unit) {
  this as MetricSpec_autoscaling_v2beta2_k8s1_21Impl
  ObjectMetricSource_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { `object` = it }
    .apply(init)
}
...
fun MetricSpec.pods(init: PodsMetricSource.() -> Unit) {
  this as MetricSpec_autoscaling_v2beta2_k8s1_21Impl
  PodsMetricSource_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { pods = it }
    .apply(init)
}
...
fun MetricSpec.resource(init: ResourceMetricSource.() -> Unit) {
  this as MetricSpec_autoscaling_v2beta2_k8s1_21Impl
  ResourceMetricSource_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { resource = it }
    .apply(init)
}
...
fun MetricStatus.containerResource(init: ContainerResourceMetricStatus.() -> Unit) {
  this as MetricStatus_autoscaling_v2beta2_k8s1_21Impl
  ContainerResourceMetricStatus_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { containerResource = it }
    .apply(init)
}
...
fun MetricStatus.external(init: ExternalMetricStatus.() -> Unit) {
  this as MetricStatus_autoscaling_v2beta2_k8s1_21Impl
  ExternalMetricStatus_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { external = it }
    .apply(init)
}
...
fun MetricStatus.`object`(init: ObjectMetricStatus.() -> Unit) {
  this as MetricStatus_autoscaling_v2beta2_k8s1_21Impl
  ObjectMetricStatus_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { `object` = it }
    .apply(init)
}
...
fun MetricStatus.pods(init: PodsMetricStatus.() -> Unit) {
  this as MetricStatus_autoscaling_v2beta2_k8s1_21Impl
  PodsMetricStatus_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { pods = it }
    .apply(init)
}
...
fun MetricStatus.resource(init: ResourceMetricStatus.() -> Unit) {
  this as MetricStatus_autoscaling_v2beta2_k8s1_21Impl
  ResourceMetricStatus_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { resource = it }
    .apply(init)
}
...
fun MetricTarget.averageValue(init: Quantity.() -> Unit) {
  this as MetricTarget_autoscaling_v2beta2_k8s1_21Impl
  Quantity_core_resource_k8s1_21Impl(this)
...
fun MetricValueStatus.averageValue(init: Quantity.() -> Unit) {
  this as MetricValueStatus_autoscaling_v2beta2_k8s1_21Impl
  Quantity_core_resource_k8s1_21Impl(this)
    .also { averageValue = it }
    .apply(init)
}
...
fun MutatingWebhookConfiguration.metadata(init: ObjectMeta.() -> Unit) {
  this as MutatingWebhookConfiguration_admissionregistration_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun MutatingWebhookConfiguration.webhooks(init: MutatingWebhook.() -> Unit) {
  this as MutatingWebhookConfiguration_admissionregistration_k8s_io_v1_k8s1_21Impl
  MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_21Impl(this)
...
fun MutatingWebhook.clientConfig(init: WebhookClientConfig.() -> Unit) {
  this as MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_21Impl
  WebhookClientConfig_admissionregistration_k8s_io_v1_k8s1_21Impl(this)
...
fun MutatingWebhook.rules(init: RuleWithOperations.() -> Unit) {
  this as MutatingWebhook_admissionregistration_k8s_io_v1_k8s1_21Impl
  RuleWithOperations_admissionregistration_k8s_io_v1_k8s1_21Impl(this)
    .also { rules = rules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun NamespaceCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as NamespaceCondition_core_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun Namespace.metadata(init: ObjectMeta.() -> Unit) {
  this as Namespace_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Namespace.spec(init: Namespacespec.() -> Unit) {
  this as Namespace_core_v1_k8s1_21Impl
  Namespacespec_core_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Namespace.status(init: Namespacestatus.() -> Unit) {
  this as Namespace_core_v1_k8s1_21Impl
  Namespacestatus_core_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun NetworkPolicyEgressRule.ports(init: NetworkPolicyPort.() -> Unit) {
  this as NetworkPolicyEgressRule_networking_k8s_io_v1_k8s1_21Impl
  NetworkPolicyPort_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { ports = ports?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun NetworkPolicyEgressRule.to(init: NetworkPolicyPeer.() -> Unit) {
  this as NetworkPolicyEgressRule_networking_k8s_io_v1_k8s1_21Impl
  NetworkPolicyPeer_networking_k8s_io_v1_k8s1_21Impl(this)
...
fun NetworkPolicyIngressRule.from(init: NetworkPolicyPeer.() -> Unit) {
  this as NetworkPolicyIngressRule_networking_k8s_io_v1_k8s1_21Impl
  NetworkPolicyPeer_networking_k8s_io_v1_k8s1_21Impl(this)
...
fun NetworkPolicyPeer.ipBlock(init: IPBlock.() -> Unit) {
  this as NetworkPolicyPeer_networking_k8s_io_v1_k8s1_21Impl
  IPBlock_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { ipBlock = it }
    .apply(init)
}
...
fun NetworkPolicyPort.port(string: String) {
  this as NetworkPolicyPort_networking_k8s_io_v1_k8s1_21Impl
  de.loosetie.k8s.dsl.types.IntOrString(string)
    .also { port = it }
}
...
fun NetworkPolicy.metadata(init: ObjectMeta.() -> Unit) {
  this as NetworkPolicy_networking_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun NetworkPolicy.spec(init: Networkpolicyspec.() -> Unit) {
  this as NetworkPolicy_networking_k8s_io_v1_k8s1_21Impl
  Networkpolicyspec_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun NodeAffinity.preferredDuringSchedulingIgnoredDuringExecution(init: PreferredSchedulingTerm.() -> Unit) {
  this as NodeAffinity_core_v1_k8s1_21Impl
  PreferredSchedulingTerm_core_v1_k8s1_21Impl(this)
...
fun NodeAffinity.requiredDuringSchedulingIgnoredDuringExecution(init: NodeSelector.() -> Unit) {
  this as NodeAffinity_core_v1_k8s1_21Impl
  NodeSelector_core_v1_k8s1_21Impl(this)
...
fun NodeCondition.lastHeartbeatTime(init: Time.() -> Unit) {
  this as NodeCondition_core_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
...
fun NodeConfigSource.configMap(init: ConfigMapNodeConfigSource.() -> Unit) {
  this as NodeConfigSource_core_v1_k8s1_21Impl
  ConfigMapNodeConfigSource_core_v1_k8s1_21Impl(this)
    .also { configMap = it }
    .apply(init)
}
...
fun NodeConfigStatus.active(init: NodeConfigSource.() -> Unit) {
  this as NodeConfigStatus_core_v1_k8s1_21Impl
  NodeConfigSource_core_v1_k8s1_21Impl(this)
    .also { active = it }
    .apply(init)
}
...
fun NodeDaemonEndpoints.kubeletEndpoint(init: DaemonEndpoint.() -> Unit) {
  this as NodeDaemonEndpoints_core_v1_k8s1_21Impl
  DaemonEndpoint_core_v1_k8s1_21Impl(this)
...
fun NodeSelectorTerm.matchExpressions(init: NodeSelectorRequirement.() -> Unit) {
  this as NodeSelectorTerm_core_v1_k8s1_21Impl
  NodeSelectorRequirement_core_v1_k8s1_21Impl(this)
    .also { matchExpressions = matchExpressions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun NodeSelector.nodeSelectorTerms(init: NodeSelectorTerm.() -> Unit) {
  this as NodeSelector_core_v1_k8s1_21Impl
  NodeSelectorTerm_core_v1_k8s1_21Impl(this)
...
fun Node.metadata(init: ObjectMeta.() -> Unit) {
  this as Node_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Node.spec(init: Nodespec.() -> Unit) {
  this as Node_core_v1_k8s1_21Impl
  Nodespec_core_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Node.status(init: Nodestatus.() -> Unit) {
  this as Node_core_v1_k8s1_21Impl
  Nodestatus_core_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun ObjectMeta.creationTimestamp(init: Time.() -> Unit) {
  this as ObjectMeta_meta_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
...
fun ObjectMeta.managedFields(init: ManagedFieldsEntry.() -> Unit) {
  this as ObjectMeta_meta_v1_k8s1_21Impl
  ManagedFieldsEntry_meta_v1_k8s1_21Impl(this)
...
fun ObjectMeta.ownerReferences(init: OwnerReference.() -> Unit) {
  this as ObjectMeta_meta_v1_k8s1_21Impl
  OwnerReference_meta_v1_k8s1_21Impl(this)
...
/**  */
@K8sDslMarker
fun ObjectMetricSource.describedObject(init: CrossVersionObjectReference_autoscaling_v2beta2_k8s1_21.() -> Unit) {
  this as ObjectMetricSource_autoscaling_v2beta2_k8s1_21Impl
  CrossVersionObjectReference_autoscaling_v2beta2_k8s1_21Impl(this)
...
fun ObjectMetricStatus.current(init: MetricValueStatus.() -> Unit) {
  this as ObjectMetricStatus_autoscaling_v2beta2_k8s1_21Impl
  MetricValueStatus_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { current = it }
    .apply(init)
}
...
/**  */
@K8sDslMarker
fun ObjectMetricStatus.describedObject(init: CrossVersionObjectReference_autoscaling_v2beta2_k8s1_21.() -> Unit) {
  this as ObjectMetricStatus_autoscaling_v2beta2_k8s1_21Impl
  CrossVersionObjectReference_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { describedObject = it }
    .apply(init)
...
fun Overhead.podFixed(init: de.loosetie.k8s.dsl.types.LimitsAndRequests.() -> Unit) {
  this as Overhead_node_k8s_io_v1_k8s1_21Impl
...
fun PersistentVolumeClaimCondition.lastProbeTime(init: Time.() -> Unit) {
  this as PersistentVolumeClaimCondition_core_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastProbeTime = it }
    .apply(init)
}
...
fun PersistentVolumeClaimTemplate.metadata(init: ObjectMeta.() -> Unit) {
  this as PersistentVolumeClaimTemplate_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PersistentVolumeClaimTemplate.spec(init: Persistentvolumeclaimspec.() -> Unit) {
  this as PersistentVolumeClaimTemplate_core_v1_k8s1_21Impl
  Persistentvolumeclaimspec_core_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun PersistentVolumeClaim.metadata(init: ObjectMeta.() -> Unit) {
  this as PersistentVolumeClaim_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PersistentVolumeClaim.status(init: Persistentvolumeclaimstatus.() -> Unit) {
  this as PersistentVolumeClaim_core_v1_k8s1_21Impl
  Persistentvolumeclaimstatus_core_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun PersistentVolume.metadata(init: ObjectMeta.() -> Unit) {
  this as PersistentVolume_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PersistentVolume.spec(init: Persistentvolumespec.() -> Unit) {
  this as PersistentVolume_core_v1_k8s1_21Impl
  Persistentvolumespec_core_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun PersistentVolume.status(init: Persistentvolumestatus.() -> Unit) {
  this as PersistentVolume_core_v1_k8s1_21Impl
  Persistentvolumestatus_core_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun PodAffinityTerm.labelSelector(init: LabelSelector.() -> Unit) {
  this as PodAffinityTerm_core_v1_k8s1_21Impl
  LabelSelector_meta_v1_k8s1_21Impl(this)
...
means "this pod's namespace". An empty selector ({}) matches all namespaces. This field is alpha-level and is only
...
fun PodAffinity.preferredDuringSchedulingIgnoredDuringExecution(init: WeightedPodAffinityTerm.() -> Unit) {
  this as PodAffinity_core_v1_k8s1_21Impl
  WeightedPodAffinityTerm_core_v1_k8s1_21Impl(this)
    .also { preferredDuringSchedulingIgnoredDuringExecution = preferredDuringSchedulingIgnoredDuringExecution?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun PodAffinity.requiredDuringSchedulingIgnoredDuringExecution(init: PodAffinityTerm.() -> Unit) {
  this as PodAffinity_core_v1_k8s1_21Impl
  PodAffinityTerm_core_v1_k8s1_21Impl(this)
...
fun PodAntiAffinity.preferredDuringSchedulingIgnoredDuringExecution(init: WeightedPodAffinityTerm.() -> Unit) {
  this as PodAntiAffinity_core_v1_k8s1_21Impl
  WeightedPodAffinityTerm_core_v1_k8s1_21Impl(this)
    .also { preferredDuringSchedulingIgnoredDuringExecution = preferredDuringSchedulingIgnoredDuringExecution?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun PodCondition.lastProbeTime(init: Time.() -> Unit) {
  this as PodCondition_core_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastProbeTime = it }
    .apply(init)
}
...
fun PodDNSConfig.options(init: PodDNSConfigOption.() -> Unit) {
  this as PodDNSConfig_core_v1_k8s1_21Impl
  PodDNSConfigOption_core_v1_k8s1_21Impl(this)
...
fun PodDisruptionBudget.metadata(init: ObjectMeta.() -> Unit) {
  this as PodDisruptionBudget_policy_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PodDisruptionBudget.spec(init: Poddisruptionbudgetspec.() -> Unit) {
  this as PodDisruptionBudget_policy_v1_k8s1_21Impl
  Poddisruptionbudgetspec_policy_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun PodDisruptionBudget.status(init: Poddisruptionbudgetstatus.() -> Unit) {
  this as PodDisruptionBudget_policy_v1_k8s1_21Impl
  Poddisruptionbudgetstatus_policy_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun PodSecurityContext.seLinuxOptions(init: SELinuxOptions.() -> Unit) {
  this as PodSecurityContext_core_v1_k8s1_21Impl
  SELinuxOptions_core_v1_k8s1_21Impl(this)
...
fun PodSecurityContext.seccompProfile(init: SeccompProfile.() -> Unit) {
  this as PodSecurityContext_core_v1_k8s1_21Impl
  SeccompProfile_core_v1_k8s1_21Impl(this)
...
fun PodSecurityContext.sysctls(init: Sysctl.() -> Unit) {
  this as PodSecurityContext_core_v1_k8s1_21Impl
  Sysctl_core_v1_k8s1_21Impl(this)
...
fun PodSecurityContext.windowsOptions(init: WindowsSecurityContextOptions.() -> Unit) {
  this as PodSecurityContext_core_v1_k8s1_21Impl
  WindowsSecurityContextOptions_core_v1_k8s1_21Impl(this)
...
fun PodSecurityPolicy.metadata(init: ObjectMeta.() -> Unit) {
  this as PodSecurityPolicy_policy_v1beta1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PodSecurityPolicy.spec(init: Podsecuritypolicyspec.() -> Unit) {
  this as PodSecurityPolicy_policy_v1beta1_k8s1_21Impl
  Podsecuritypolicyspec_policy_v1beta1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun PodTemplate.metadata(init: ObjectMeta.() -> Unit) {
  this as PodTemplate_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PodTemplate.template(init: Podtemplatespec.() -> Unit) {
  this as PodTemplate_core_v1_k8s1_21Impl
  Podtemplatespec_core_v1_k8s1_21Impl(this)
    .also { template = it }
    .apply(init)
}
...
fun Pod.metadata(init: ObjectMeta.() -> Unit) {
  this as Pod_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Pod.spec(init: Podspec.() -> Unit) {
  this as Pod_core_v1_k8s1_21Impl
  Podspec_core_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Pod.status(init: Podstatus.() -> Unit) {
  this as Pod_core_v1_k8s1_21Impl
  Podstatus_core_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun PodsMetricSource.metric(init: MetricIdentifier.() -> Unit) {
  this as PodsMetricSource_autoscaling_v2beta2_k8s1_21Impl
  MetricIdentifier_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { metric = it }
    .apply(init)
}
...
fun PodsMetricStatus.current(init: MetricValueStatus.() -> Unit) {
  this as PodsMetricStatus_autoscaling_v2beta2_k8s1_21Impl
  MetricValueStatus_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { current = it }
    .apply(init)
}
...
fun PolicyRulesWithSubjects.nonResourceRules(init: NonResourcePolicyRule.() -> Unit) {
  this as PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  NonResourcePolicyRule_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
...
fun PolicyRulesWithSubjects.resourceRules(init: ResourcePolicyRule.() -> Unit) {
  this as PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  ResourcePolicyRule_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
...
fun PolicyRulesWithSubjects.subjects(init: Subject.() -> Unit) {
  this as PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  Subject_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { subjects = subjects?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun PreferredSchedulingTerm.preference(init: NodeSelectorTerm.() -> Unit) {
  this as PreferredSchedulingTerm_core_v1_k8s1_21Impl
  NodeSelectorTerm_core_v1_k8s1_21Impl(this)
    .also { preference = it }
    .apply(init)
}
...
fun PriorityClass.metadata(init: ObjectMeta.() -> Unit) {
  this as PriorityClass_scheduling_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PriorityLevelConfigurationCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as PriorityLevelConfigurationCondition_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun PriorityLevelConfiguration.metadata(init: ObjectMeta.() -> Unit) {
  this as PriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun PriorityLevelConfiguration.spec(init: Prioritylevelconfigurationspec.() -> Unit) {
  this as PriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun PriorityLevelConfiguration.status(init: Prioritylevelconfigurationstatus.() -> Unit) {
  this as PriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  Prioritylevelconfigurationstatus_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun Probe.exec(init: ExecAction.() -> Unit) {
  this as Probe_core_v1_k8s1_21Impl
  ExecAction_core_v1_k8s1_21Impl(this)
    .also { exec = it }
    .apply(init)
}
...
fun ProjectedVolumeSource.sources(init: VolumeProjection.() -> Unit) {
  this as ProjectedVolumeSource_core_v1_k8s1_21Impl
  VolumeProjection_core_v1_k8s1_21Impl(this)
...
fun RBDPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as RBDPersistentVolumeSource_core_v1_k8s1_21Impl
  SecretReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun RBDVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as RBDVolumeSource_core_v1_k8s1_21Impl
  LocalObjectReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun ReplicaSetCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as ReplicaSetCondition_apps_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun ReplicaSet.metadata(init: ObjectMeta.() -> Unit) {
  this as ReplicaSet_apps_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ReplicaSet.spec(init: Replicasetspec.() -> Unit) {
  this as ReplicaSet_apps_v1_k8s1_21Impl
  Replicasetspec_apps_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun ReplicaSet.status(init: Replicasetstatus.() -> Unit) {
  this as ReplicaSet_apps_v1_k8s1_21Impl
  Replicasetstatus_apps_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun ReplicationControllerCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as ReplicationControllerCondition_core_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun ReplicationController.metadata(init: ObjectMeta.() -> Unit) {
  this as ReplicationController_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ReplicationController.spec(init: Replicationcontrollerspec.() -> Unit) {
  this as ReplicationController_core_v1_k8s1_21Impl
  Replicationcontrollerspec_core_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun ReplicationController.status(init: Replicationcontrollerstatus.() -> Unit) {
  this as ReplicationController_core_v1_k8s1_21Impl
  Replicationcontrollerstatus_core_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun ResourceFieldSelector.divisor(init: Quantity.() -> Unit) {
  this as ResourceFieldSelector_core_v1_k8s1_21Impl
  Quantity_core_resource_k8s1_21Impl(this)
    .also { divisor = it }
    .apply(init)
}
...
fun ResourceMetricSource.target(init: MetricTarget.() -> Unit) {
  this as ResourceMetricSource_autoscaling_v2beta2_k8s1_21Impl
  MetricTarget_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { target = it }
    .apply(init)
}
...
fun ResourceMetricStatus.current(init: MetricValueStatus.() -> Unit) {
  this as ResourceMetricStatus_autoscaling_v2beta2_k8s1_21Impl
  MetricValueStatus_autoscaling_v2beta2_k8s1_21Impl(this)
    .also { current = it }
    .apply(init)
}
...
fun ResourceQuota.metadata(init: ObjectMeta.() -> Unit) {
  this as ResourceQuota_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ResourceQuota.spec(init: Resourcequotaspec.() -> Unit) {
  this as ResourceQuota_core_v1_k8s1_21Impl
  Resourcequotaspec_core_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun ResourceQuota.status(init: Resourcequotastatus.() -> Unit) {
  this as ResourceQuota_core_v1_k8s1_21Impl
  Resourcequotastatus_core_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun ResourceRequirements.limits(init: de.loosetie.k8s.dsl.types.LimitsAndRequests.() -> Unit) {
  this as ResourceRequirements_core_v1_k8s1_21Impl
  de.loosetie.k8s.dsl.types.LimitsAndRequests(this)
    .also { limits = it }
    .apply(init)
}
...
fun RoleBinding.metadata(init: ObjectMeta.() -> Unit) {
  this as RoleBinding_rbac_authorization_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
/** Subjects holds references to the objects the role applies to. */
@K8sDslMarker
fun RoleBinding.subjects(init: Subject_rbac_authorization_k8s_io_v1_k8s1_21.() -> Unit) {
  this as RoleBinding_rbac_authorization_k8s_io_v1_k8s1_21Impl
  Subject_rbac_authorization_k8s_io_v1_k8s1_21Impl(this)
    .also { subjects = subjects?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
...
fun Role.metadata(init: ObjectMeta.() -> Unit) {
  this as Role_rbac_authorization_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun RunAsGroupStrategyOptions.ranges(init: IDRange.() -> Unit) {
  this as RunAsGroupStrategyOptions_policy_v1beta1_k8s1_21Impl
  IDRange_policy_v1beta1_k8s1_21Impl(this)
    .also { ranges = ranges?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun RunAsUserStrategyOptions.ranges(init: IDRange.() -> Unit) {
  this as RunAsUserStrategyOptions_policy_v1beta1_k8s1_21Impl
  IDRange_policy_v1beta1_k8s1_21Impl(this)
    .also { ranges = ranges?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun RuntimeClass.metadata(init: ObjectMeta.() -> Unit) {
  this as RuntimeClass_node_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun RuntimeClass.overhead(init: Overhead.() -> Unit) {
  this as RuntimeClass_node_k8s_io_v1_k8s1_21Impl
  Overhead_node_k8s_io_v1_k8s1_21Impl(this)
    .also { overhead = it }
    .apply(init)
}
...
fun RuntimeClass.scheduling(init: Scheduling.() -> Unit) {
  this as RuntimeClass_node_k8s_io_v1_k8s1_21Impl
  Scheduling_node_k8s_io_v1_k8s1_21Impl(this)
    .also { scheduling = it }
    .apply(init)
}
...
fun SELinuxStrategyOptions.seLinuxOptions(init: SELinuxOptions.() -> Unit) {
  this as SELinuxStrategyOptions_policy_v1beta1_k8s1_21Impl
  SELinuxOptions_core_v1_k8s1_21Impl(this)
    .also { seLinuxOptions = it }
    .apply(init)
}
...
fun ScaleIOPersistentVolumeSource.secretRef(init: SecretReference.() -> Unit) {
  this as ScaleIOPersistentVolumeSource_core_v1_k8s1_21Impl
  SecretReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun ScaleIOVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as ScaleIOVolumeSource_core_v1_k8s1_21Impl
  LocalObjectReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun Scheduling.tolerations(init: Toleration.() -> Unit) {
  this as Scheduling_node_k8s_io_v1_k8s1_21Impl
  Toleration_core_v1_k8s1_21Impl(this)
...
fun ScopeSelector.matchExpressions(init: ScopedResourceSelectorRequirement.() -> Unit) {
  this as ScopeSelector_core_v1_k8s1_21Impl
  ScopedResourceSelectorRequirement_core_v1_k8s1_21Impl(this)
    .also { matchExpressions = matchExpressions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun SecretProjection.items(init: KeyToPath.() -> Unit) {
  this as SecretProjection_core_v1_k8s1_21Impl
  KeyToPath_core_v1_k8s1_21Impl(this)
    .also { items = items?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun SecretVolumeSource.items(init: KeyToPath.() -> Unit) {
  this as SecretVolumeSource_core_v1_k8s1_21Impl
  KeyToPath_core_v1_k8s1_21Impl(this)
    .also { items = items?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Secret.metadata(init: ObjectMeta.() -> Unit) {
  this as Secret_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun SecurityContext.capabilities(init: Capabilities.() -> Unit) {
  this as SecurityContext_core_v1_k8s1_21Impl
  Capabilities_core_v1_k8s1_21Impl(this)
...
fun SelfSubjectAccessReview.metadata(init: ObjectMeta.() -> Unit) {
  this as SelfSubjectAccessReview_authorization_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun SelfSubjectAccessReview.spec(init: Selfsubjectaccessreviewspec.() -> Unit) {
  this as SelfSubjectAccessReview_authorization_k8s_io_v1_k8s1_21Impl
  Selfsubjectaccessreviewspec_authorization_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun SelfSubjectRulesReview.metadata(init: ObjectMeta.() -> Unit) {
  this as SelfSubjectRulesReview_authorization_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun SelfSubjectRulesReview.spec(init: Selfsubjectrulesreviewspec.() -> Unit) {
  this as SelfSubjectRulesReview_authorization_k8s_io_v1_k8s1_21Impl
  Selfsubjectrulesreviewspec_authorization_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun SelfSubjectRulesReview.status(init: SubjectRulesReviewStatus.() -> Unit) {
  this as SelfSubjectRulesReview_authorization_k8s_io_v1_k8s1_21Impl
  SubjectRulesReviewStatus_authorization_k8s_io_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun ServiceAccount.imagePullSecrets(init: LocalObjectReference.() -> Unit) {
  this as ServiceAccount_core_v1_k8s1_21Impl
  LocalObjectReference_core_v1_k8s1_21Impl(this)
...
fun ServicePort.targetPort(string: String) {
  this as ServicePort_core_v1_k8s1_21Impl
  de.loosetie.k8s.dsl.types.IntOrString(string)
    .also { targetPort = it }
}
...
fun Service.metadata(init: ObjectMeta.() -> Unit) {
  this as Service_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Service.spec(init: Servicespec.() -> Unit) {
  this as Service_core_v1_k8s1_21Impl
  Servicespec_core_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun Service.status(init: Servicestatus.() -> Unit) {
  this as Service_core_v1_k8s1_21Impl
  Servicestatus_core_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun SessionAffinityConfig.clientIP(init: ClientIPConfig.() -> Unit) {
  this as SessionAffinityConfig_core_v1_k8s1_21Impl
  ClientIPConfig_core_v1_k8s1_21Impl(this)
    .also { clientIP = it }
    .apply(init)
}
...
fun StatefulSetCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as StatefulSetCondition_apps_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun StatefulSetUpdateStrategy.rollingUpdate(init: RollingUpdateStatefulSetStrategy.() -> Unit) {
  this as StatefulSetUpdateStrategy_apps_v1_k8s1_21Impl
  RollingUpdateStatefulSetStrategy_apps_v1_k8s1_21Impl(this)
    .also { rollingUpdate = it }
    .apply(init)
}
...
fun StatefulSet.metadata(init: ObjectMeta.() -> Unit) {
  this as StatefulSet_apps_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun StatefulSet.spec(init: Statefulsetspec.() -> Unit) {
  this as StatefulSet_apps_v1_k8s1_21Impl
  Statefulsetspec_apps_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun StatefulSet.status(init: Statefulsetstatus.() -> Unit) {
  this as StatefulSet_apps_v1_k8s1_21Impl
  Statefulsetstatus_apps_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun StatusDetails.causes(init: StatusCause.() -> Unit) {
  this as StatusDetails_meta_v1_k8s1_21Impl
  StatusCause_meta_v1_k8s1_21Impl(this)
...
fun Status.details(init: StatusDetails.() -> Unit) {
  this as Status_meta_v1_k8s1_21Impl
  StatusDetails_meta_v1_k8s1_21Impl(this)
    .also { details = it }
    .apply(init)
}
...
fun Status.metadata(init: ListMeta.() -> Unit) {
  this as Status_meta_v1_k8s1_21Impl
  ListMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun StorageClass.allowedTopologies(init: TopologySelectorTerm.() -> Unit) {
  this as StorageClass_storage_k8s_io_v1_k8s1_21Impl
  TopologySelectorTerm_core_v1_k8s1_21Impl(this)
...
fun StorageOSPersistentVolumeSource.secretRef(init: ObjectReference.() -> Unit) {
  this as StorageOSPersistentVolumeSource_core_v1_k8s1_21Impl
  ObjectReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun StorageOSVolumeSource.secretRef(init: LocalObjectReference.() -> Unit) {
  this as StorageOSVolumeSource_core_v1_k8s1_21Impl
  LocalObjectReference_core_v1_k8s1_21Impl(this)
    .also { secretRef = it }
    .apply(init)
}
...
fun StorageVersionCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as StorageVersionCondition_internal_apiserver_k8s_io_v1alpha1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun StorageVersion.metadata(init: ObjectMeta.() -> Unit) {
  this as StorageVersion_internal_apiserver_k8s_io_v1alpha1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun StorageVersion.spec(init: Storageversionspec.() -> Unit) {
  this as StorageVersion_internal_apiserver_k8s_io_v1alpha1_k8s1_21Impl
  Storageversionspec_internal_apiserver_k8s_io_v1alpha1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun StorageVersion.status(init: Storageversionstatus.() -> Unit) {
  this as StorageVersion_internal_apiserver_k8s_io_v1alpha1_k8s1_21Impl
  Storageversionstatus_internal_apiserver_k8s_io_v1alpha1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun SubjectAccessReview.metadata(init: ObjectMeta.() -> Unit) {
  this as SubjectAccessReview_authorization_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun SubjectRulesReviewStatus.nonResourceRules(init: NonResourceRule.() -> Unit) {
  this as SubjectRulesReviewStatus_authorization_k8s_io_v1_k8s1_21Impl
  NonResourceRule_authorization_k8s_io_v1_k8s1_21Impl(this)
    .also { nonResourceRules = nonResourceRules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun SubjectRulesReviewStatus.resourceRules(init: ResourceRule.() -> Unit) {
  this as SubjectRulesReviewStatus_authorization_k8s_io_v1_k8s1_21Impl
  ResourceRule_authorization_k8s_io_v1_k8s1_21Impl(this)
    .also { resourceRules = resourceRules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Subject.group(init: GroupSubject.() -> Unit) {
  this as Subject_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  GroupSubject_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { group = it }
    .apply(init)
}
...
fun Subject.serviceAccount(init: ServiceAccountSubject.() -> Unit) {
  this as Subject_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  ServiceAccountSubject_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
...
fun Subject.user(init: UserSubject.() -> Unit) {
  this as Subject_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  UserSubject_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { user = it }
    .apply(init)
}
...
fun SupplementalGroupsStrategyOptions.ranges(init: IDRange.() -> Unit) {
  this as SupplementalGroupsStrategyOptions_policy_v1beta1_k8s1_21Impl
  IDRange_policy_v1beta1_k8s1_21Impl(this)
    .also { ranges = ranges?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun TCPSocketAction.port(string: String) {
  this as TCPSocketAction_core_v1_k8s1_21Impl
  de.loosetie.k8s.dsl.types.IntOrString(string)
    .also { port = it }
}
...
fun Taint.timeAdded(init: Time.() -> Unit) {
  this as Taint_core_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { timeAdded = it }
    .apply(init)
}
...
fun TokenRequest.metadata(init: ObjectMeta.() -> Unit) {
  this as TokenRequest_authentication_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun TokenRequest.spec(init: Tokenrequestspec.() -> Unit) {
  this as TokenRequest_authentication_k8s_io_v1_k8s1_21Impl
  Tokenrequestspec_authentication_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun TokenRequest.status(init: Tokenrequeststatus.() -> Unit) {
  this as TokenRequest_authentication_k8s_io_v1_k8s1_21Impl
  Tokenrequeststatus_authentication_k8s_io_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun TokenReview.metadata(init: ObjectMeta.() -> Unit) {
  this as TokenReview_authentication_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun TokenReview.spec(init: Tokenreviewspec.() -> Unit) {
  this as TokenReview_authentication_k8s_io_v1_k8s1_21Impl
  Tokenreviewspec_authentication_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun TokenReview.status(init: Tokenreviewstatus.() -> Unit) {
  this as TokenReview_authentication_k8s_io_v1_k8s1_21Impl
  Tokenreviewstatus_authentication_k8s_io_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun TopologySelectorTerm.matchLabelExpressions(init: TopologySelectorLabelRequirement.() -> Unit) {
  this as TopologySelectorTerm_core_v1_k8s1_21Impl
  TopologySelectorLabelRequirement_core_v1_k8s1_21Impl(this)
...
fun TopologySpreadConstraint.labelSelector(init: LabelSelector.() -> Unit) {
  this as TopologySpreadConstraint_core_v1_k8s1_21Impl
  LabelSelector_meta_v1_k8s1_21Impl(this)
    .also { labelSelector = it }
    .apply(init)
}
...
fun ValidatingWebhookConfiguration.metadata(init: ObjectMeta.() -> Unit) {
  this as ValidatingWebhookConfiguration_admissionregistration_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun ValidatingWebhookConfiguration.webhooks(init: ValidatingWebhook.() -> Unit) {
  this as ValidatingWebhookConfiguration_admissionregistration_k8s_io_v1_k8s1_21Impl
  ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_21Impl(this)
    .also { webhooks = webhooks?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun ValidatingWebhook.clientConfig(init: WebhookClientConfig.() -> Unit) {
  this as ValidatingWebhook_admissionregistration_k8s_io_v1_k8s1_21Impl
  WebhookClientConfig_admissionregistration_k8s_io_v1_k8s1_21Impl(this)
    .also { clientConfig = it }
    .apply(init)
}
...
fun VolumeAttachmentSource.inlineVolumeSpec(init: Persistentvolumespec.() -> Unit) {
  this as VolumeAttachmentSource_storage_k8s_io_v1_k8s1_21Impl
  Persistentvolumespec_core_v1_k8s1_21Impl(this)
...
fun VolumeAttachment.metadata(init: ObjectMeta.() -> Unit) {
  this as VolumeAttachment_storage_k8s_io_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun VolumeAttachment.spec(init: Volumeattachmentspec.() -> Unit) {
  this as VolumeAttachment_storage_k8s_io_v1_k8s1_21Impl
  Volumeattachmentspec_storage_k8s_io_v1_k8s1_21Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun VolumeAttachment.status(init: Volumeattachmentstatus.() -> Unit) {
  this as VolumeAttachment_storage_k8s_io_v1_k8s1_21Impl
  Volumeattachmentstatus_storage_k8s_io_v1_k8s1_21Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun VolumeError.time(init: Time.() -> Unit) {
  this as VolumeError_storage_k8s_io_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
    .also { time = it }
    .apply(init)
}
...
fun VolumeNodeAffinity.required(init: NodeSelector.() -> Unit) {
  this as VolumeNodeAffinity_core_v1_k8s1_21Impl
  NodeSelector_core_v1_k8s1_21Impl(this)
    .also { required = it }
    .apply(init)
}
...
fun VolumeProjection.configMap(init: ConfigMapProjection.() -> Unit) {
  this as VolumeProjection_core_v1_k8s1_21Impl
  ConfigMapProjection_core_v1_k8s1_21Impl(this)
    .also { configMap = it }
    .apply(init)
}
...
fun VolumeProjection.downwardAPI(init: DownwardAPIProjection.() -> Unit) {
  this as VolumeProjection_core_v1_k8s1_21Impl
  DownwardAPIProjection_core_v1_k8s1_21Impl(this)
    .also { downwardAPI = it }
    .apply(init)
}
...
fun VolumeProjection.secret(init: SecretProjection.() -> Unit) {
  this as VolumeProjection_core_v1_k8s1_21Impl
  SecretProjection_core_v1_k8s1_21Impl(this)
    .also { secret = it }
    .apply(init)
}
...
fun VolumeProjection.serviceAccountToken(init: ServiceAccountTokenProjection.() -> Unit) {
  this as VolumeProjection_core_v1_k8s1_21Impl
  ServiceAccountTokenProjection_core_v1_k8s1_21Impl(this)
...
fun Volume.awsElasticBlockStore(init: AWSElasticBlockStoreVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  AWSElasticBlockStoreVolumeSource_core_v1_k8s1_21Impl(this)
...
fun Volume.azureDisk(init: AzureDiskVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  AzureDiskVolumeSource_core_v1_k8s1_21Impl(this)
    .also { azureDisk = it }
    .apply(init)
}
...
fun Volume.azureFile(init: AzureFileVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  AzureFileVolumeSource_core_v1_k8s1_21Impl(this)
    .also { azureFile = it }
    .apply(init)
}
...
fun Volume.cephfs(init: CephFSVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  CephFSVolumeSource_core_v1_k8s1_21Impl(this)
    .also { cephfs = it }
    .apply(init)
}
...
fun Volume.cinder(init: CinderVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  CinderVolumeSource_core_v1_k8s1_21Impl(this)
    .also { cinder = it }
    .apply(init)
}
...
fun Volume.configMap(init: ConfigMapVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  ConfigMapVolumeSource_core_v1_k8s1_21Impl(this)
    .also { configMap = it }
    .apply(init)
}
...
fun Volume.csi(init: CSIVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  CSIVolumeSource_core_v1_k8s1_21Impl(this)
    .also { csi = it }
    .apply(init)
}
...
fun Volume.downwardAPI(init: DownwardAPIVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  DownwardAPIVolumeSource_core_v1_k8s1_21Impl(this)
    .also { downwardAPI = it }
    .apply(init)
}
...
fun Volume.emptyDir(init: EmptyDirVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  EmptyDirVolumeSource_core_v1_k8s1_21Impl(this)
    .also { emptyDir = it }
    .apply(init)
}
...
information. A pod can use both types of ephemeral volumes and persistent volumes at the same time. This is a beta
feature and only available when the GenericEphemeralVolume feature gate is enabled. */
@K8sDslMarker
fun Volume.ephemeral(init: EphemeralVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  EphemeralVolumeSource_core_v1_k8s1_21Impl(this)
    .also { ephemeral = it }
    .apply(init)
}
...
fun Volume.fc(init: FCVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  FCVolumeSource_core_v1_k8s1_21Impl(this)
    .also { fc = it }
    .apply(init)
}
...
fun Volume.flexVolume(init: FlexVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  FlexVolumeSource_core_v1_k8s1_21Impl(this)
    .also { flexVolume = it }
    .apply(init)
}
...
fun Volume.flocker(init: FlockerVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  FlockerVolumeSource_core_v1_k8s1_21Impl(this)
    .also { flocker = it }
    .apply(init)
}
...
fun Volume.gcePersistentDisk(init: GCEPersistentDiskVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  GCEPersistentDiskVolumeSource_core_v1_k8s1_21Impl(this)
...
fun Volume.gitRepo(init: GitRepoVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  GitRepoVolumeSource_core_v1_k8s1_21Impl(this)
    .also { gitRepo = it }
    .apply(init)
}
...
fun Volume.glusterfs(init: GlusterfsVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  GlusterfsVolumeSource_core_v1_k8s1_21Impl(this)
    .also { glusterfs = it }
    .apply(init)
}
...
fun Volume.hostPath(init: HostPathVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  HostPathVolumeSource_core_v1_k8s1_21Impl(this)
    .also { hostPath = it }
    .apply(init)
}
...
fun Volume.iscsi(init: ISCSIVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  ISCSIVolumeSource_core_v1_k8s1_21Impl(this)
    .also { iscsi = it }
    .apply(init)
}
...
fun Volume.nfs(init: NFSVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  NFSVolumeSource_core_v1_k8s1_21Impl(this)
    .also { nfs = it }
    .apply(init)
}
...
fun Volume.persistentVolumeClaim(init: PersistentVolumeClaimVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  PersistentVolumeClaimVolumeSource_core_v1_k8s1_21Impl(this)
...
fun Volume.photonPersistentDisk(init: PhotonPersistentDiskVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  PhotonPersistentDiskVolumeSource_core_v1_k8s1_21Impl(this)
...
fun Volume.portworxVolume(init: PortworxVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  PortworxVolumeSource_core_v1_k8s1_21Impl(this)
...
fun Volume.projected(init: ProjectedVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  ProjectedVolumeSource_core_v1_k8s1_21Impl(this)
    .also { projected = it }
    .apply(init)
}
...
fun Volume.quobyte(init: QuobyteVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  QuobyteVolumeSource_core_v1_k8s1_21Impl(this)
    .also { quobyte = it }
    .apply(init)
}
...
fun Volume.rbd(init: RBDVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  RBDVolumeSource_core_v1_k8s1_21Impl(this)
    .also { rbd = it }
    .apply(init)
}
...
fun Volume.scaleIO(init: ScaleIOVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  ScaleIOVolumeSource_core_v1_k8s1_21Impl(this)
    .also { scaleIO = it }
    .apply(init)
}
...
fun Volume.secret(init: SecretVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  SecretVolumeSource_core_v1_k8s1_21Impl(this)
    .also { secret = it }
    .apply(init)
}
...
fun Volume.storageos(init: StorageOSVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  StorageOSVolumeSource_core_v1_k8s1_21Impl(this)
    .also { storageos = it }
    .apply(init)
}
...
fun Volume.vsphereVolume(init: VsphereVirtualDiskVolumeSource.() -> Unit) {
  this as Volume_core_v1_k8s1_21Impl
  VsphereVirtualDiskVolumeSource_core_v1_k8s1_21Impl(this)
...
fun WebhookClientConfig.service(init: ServiceReference.() -> Unit) {
  this as WebhookClientConfig_admissionregistration_k8s_io_v1_k8s1_21Impl
  ServiceReference_admissionregistration_k8s_io_v1_k8s1_21Impl(this)
    .also { service = it }
    .apply(init)
}
...
running within the cluster, then you should use `service`. */
@K8sDslMarker
fun WebhookClientConfig_apiextensions_k8s_io_v1_k8s1_21.service(init: ServiceReference_apiextensions_k8s_io_v1_k8s1_21.() -> Unit) {
  this as WebhookClientConfig_apiextensions_k8s_io_v1_k8s1_21Impl
  ServiceReference_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { service = it }
    .apply(init)
}
...
@K8sDslMarker
fun WebhookConversion.clientConfig(init: WebhookClientConfig_apiextensions_k8s_io_v1_k8s1_21.() -> Unit) {
  this as WebhookConversion_apiextensions_k8s_io_v1_k8s1_21Impl
  WebhookClientConfig_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { clientConfig = it }
    .apply(init)
}
...
fun WeightedPodAffinityTerm.podAffinityTerm(init: PodAffinityTerm.() -> Unit) {
  this as WeightedPodAffinityTerm_core_v1_k8s1_21Impl
  PodAffinityTerm_core_v1_k8s1_21Impl(this)
...
@K8sDslMarker
fun Apiservicespec.service(init: ServiceReference_apiregistration_k8s_io_v1_k8s1_21.() -> Unit) {
  this as Apiservicespec_apiregistration_k8s_io_v1_k8s1_21Impl
  ServiceReference_apiregistration_k8s_io_v1_k8s1_21Impl(this)
    .also { service = it }
    .apply(init)
}
...
fun Apiservicestatus.conditions(init: APIServiceCondition.() -> Unit) {
  this as Apiservicestatus_apiregistration_k8s_io_v1_k8s1_21Impl
  APIServiceCondition_apiregistration_k8s_io_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Certificatesigningrequeststatus.conditions(init: CertificateSigningRequestCondition.() -> Unit) {
  this as Certificatesigningrequeststatus_certificates_k8s_io_v1_k8s1_21Impl
  CertificateSigningRequestCondition_certificates_k8s_io_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Containerstatus.lastState(init: ContainerState.() -> Unit) {
  this as Containerstatus_core_v1_k8s1_21Impl
  ContainerState_core_v1_k8s1_21Impl(this)
    .also { lastState = it }
    .apply(init)
}
...
fun Cronjobspec.jobTemplate(init: JobTemplateSpec.() -> Unit) {
  this as Cronjobspec_batch_v1_k8s1_21Impl
  JobTemplateSpec_batch_v1_k8s1_21Impl(this)
    .also { jobTemplate = it }
    .apply(init)
}
...
fun Cronjobstatus.active(init: ObjectReference.() -> Unit) {
  this as Cronjobstatus_batch_v1_k8s1_21Impl
  ObjectReference_core_v1_k8s1_21Impl(this)
...
to trigger NodePublishVolume periodically. This is a beta feature and only available when the CSIServiceAccountToken
feature is enabled. */
@K8sDslMarker
fun Csidriverspec.tokenRequests(init: TokenRequest_storage_k8s_io_v1_k8s1_21.() -> Unit) {
  this as Csidriverspec_storage_k8s_io_v1_k8s1_21Impl
  TokenRequest_storage_k8s_io_v1_k8s1_21Impl(this)
...
fun Csinodespec.drivers(init: CSINodeDriver.() -> Unit) {
  this as Csinodespec_storage_k8s_io_v1_k8s1_21Impl
  CSINodeDriver_storage_k8s_io_v1_k8s1_21Impl(this)
...
fun Customresourcedefinitionspec.conversion(init: CustomResourceConversion.() -> Unit) {
  this as Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_21Impl
  CustomResourceConversion_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { conversion = it }
    .apply(init)
}
...
fun Customresourcedefinitionspec.names(init: CustomResourceDefinitionNames.() -> Unit) {
  this as Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_21Impl
  CustomResourceDefinitionNames_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { names = it }
    .apply(init)
}
...
fun Customresourcedefinitionspec.versions(init: CustomResourceDefinitionVersion.() -> Unit) {
  this as Customresourcedefinitionspec_apiextensions_k8s_io_v1_k8s1_21Impl
  CustomResourceDefinitionVersion_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { versions = versions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Customresourcedefinitionstatus.acceptedNames(init: CustomResourceDefinitionNames.() -> Unit) {
  this as Customresourcedefinitionstatus_apiextensions_k8s_io_v1_k8s1_21Impl
  CustomResourceDefinitionNames_apiextensions_k8s_io_v1_k8s1_21Impl(this)
...
fun Customresourcedefinitionstatus.conditions(init: CustomResourceDefinitionCondition.() -> Unit) {
  this as Customresourcedefinitionstatus_apiextensions_k8s_io_v1_k8s1_21Impl
  CustomResourceDefinitionCondition_apiextensions_k8s_io_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Daemonsetspec.selector(init: LabelSelector.() -> Unit) {
  this as Daemonsetspec_apps_v1_k8s1_21Impl
  LabelSelector_meta_v1_k8s1_21Impl(this)
    .also { selector = it }
    .apply(init)
}
...
fun Daemonsetspec.updateStrategy(init: DaemonSetUpdateStrategy.() -> Unit) {
  this as Daemonsetspec_apps_v1_k8s1_21Impl
  DaemonSetUpdateStrategy_apps_v1_k8s1_21Impl(this)
...
fun Daemonsetstatus.conditions(init: DaemonSetCondition.() -> Unit) {
  this as Daemonsetstatus_apps_v1_k8s1_21Impl
  DaemonSetCondition_apps_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Deploymentspec.selector(init: LabelSelector.() -> Unit) {
  this as Deploymentspec_apps_v1_k8s1_21Impl
  LabelSelector_meta_v1_k8s1_21Impl(this)
    .also { selector = it }
    .apply(init)
}
...
fun Deploymentspec.strategy(init: Deploymentstrategy.() -> Unit) {
  this as Deploymentspec_apps_v1_k8s1_21Impl
  Deploymentstrategy_apps_v1_k8s1_21Impl(this)
    .also { strategy = it }
    .apply(init)
}
...
fun Deploymentstatus.conditions(init: DeploymentCondition.() -> Unit) {
  this as Deploymentstatus_apps_v1_k8s1_21Impl
  DeploymentCondition_apps_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Deploymentstrategy.rollingUpdate(init: Rollingupdatedeployment.() -> Unit) {
  this as Deploymentstrategy_apps_v1_k8s1_21Impl
  Rollingupdatedeployment_apps_v1_k8s1_21Impl(this)
    .also { rollingUpdate = it }
    .apply(init)
}
...
fun Flowschemaspec.distinguisherMethod(init: FlowDistinguisherMethod.() -> Unit) {
  this as Flowschemaspec_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  FlowDistinguisherMethod_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
...
fun Flowschemaspec.priorityLevelConfiguration(init: PriorityLevelConfigurationReference.() -> Unit) {
  this as Flowschemaspec_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  PriorityLevelConfigurationReference_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
...
fun Flowschemaspec.rules(init: PolicyRulesWithSubjects.() -> Unit) {
  this as Flowschemaspec_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { rules = rules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Flowschemastatus.conditions(init: FlowSchemaCondition.() -> Unit) {
  this as Flowschemastatus_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  FlowSchemaCondition_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Horizontalpodautoscalerspec.scaleTargetRef(init: CrossVersionObjectReference.() -> Unit) {
  this as Horizontalpodautoscalerspec_autoscaling_v1_k8s1_21Impl
  CrossVersionObjectReference_autoscaling_v1_k8s1_21Impl(this)
...
fun Horizontalpodautoscalerstatus.lastScaleTime(init: Time.() -> Unit) {
  this as Horizontalpodautoscalerstatus_autoscaling_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
...
fun Ingressclassspec.parameters(init: IngressClassParametersReference.() -> Unit) {
  this as Ingressclassspec_networking_k8s_io_v1_k8s1_21Impl
  IngressClassParametersReference_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { parameters = it }
    .apply(init)
}
...
fun Ingressspec.defaultBackend(init: IngressBackend.() -> Unit) {
  this as Ingressspec_networking_k8s_io_v1_k8s1_21Impl
  IngressBackend_networking_k8s_io_v1_k8s1_21Impl(this)
...
fun Ingressspec.rules(init: IngressRule.() -> Unit) {
  this as Ingressspec_networking_k8s_io_v1_k8s1_21Impl
  IngressRule_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { rules = rules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Ingressspec.tls(init: IngressTLS.() -> Unit) {
  this as Ingressspec_networking_k8s_io_v1_k8s1_21Impl
  IngressTLS_networking_k8s_io_v1_k8s1_21Impl(this)
...
fun Ingressstatus.loadBalancer(init: LoadBalancerStatus.() -> Unit) {
  this as Ingressstatus_networking_k8s_io_v1_k8s1_21Impl
  LoadBalancerStatus_core_v1_k8s1_21Impl(this)
...
fun Jobspec.selector(init: LabelSelector.() -> Unit) {
  this as Jobspec_batch_v1_k8s1_21Impl
  LabelSelector_meta_v1_k8s1_21Impl(this)
    .also { selector = it }
    .apply(init)
}
...
fun Jobstatus.completionTime(init: Time.() -> Unit) {
  this as Jobstatus_batch_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
...
fun Jobstatus.conditions(init: JobCondition.() -> Unit) {
  this as Jobstatus_batch_v1_k8s1_21Impl
  JobCondition_batch_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Leasespec.acquireTime(init: MicroTime.() -> Unit) {
  this as Leasespec_coordination_k8s_io_v1_k8s1_21Impl
  MicroTime_meta_v1_k8s1_21Impl(this)
    .also { acquireTime = it }
    .apply(init)
}
...
fun Limitrangespec.limits(init: LimitRangeItem.() -> Unit) {
  this as Limitrangespec_core_v1_k8s1_21Impl
  LimitRangeItem_core_v1_k8s1_21Impl(this)
...
fun Namespacestatus.conditions(init: NamespaceCondition.() -> Unit) {
  this as Namespacestatus_core_v1_k8s1_21Impl
  NamespaceCondition_core_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Networkpolicyspec.egress(init: NetworkPolicyEgressRule.() -> Unit) {
  this as Networkpolicyspec_networking_k8s_io_v1_k8s1_21Impl
  NetworkPolicyEgressRule_networking_k8s_io_v1_k8s1_21Impl(this)
...
fun Networkpolicyspec.ingress(init: NetworkPolicyIngressRule.() -> Unit) {
  this as Networkpolicyspec_networking_k8s_io_v1_k8s1_21Impl
  NetworkPolicyIngressRule_networking_k8s_io_v1_k8s1_21Impl(this)
    .also { ingress = ingress?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Nodespec.configSource(init: NodeConfigSource.() -> Unit) {
  this as Nodespec_core_v1_k8s1_21Impl
  NodeConfigSource_core_v1_k8s1_21Impl(this)
...
fun Nodespec.taints(init: Taint.() -> Unit) {
  this as Nodespec_core_v1_k8s1_21Impl
  Taint_core_v1_k8s1_21Impl(this)
...
fun Nodestatus.addresses(init: NodeAddress.() -> Unit) {
  this as Nodestatus_core_v1_k8s1_21Impl
  NodeAddress_core_v1_k8s1_21Impl(this)
    .also { addresses = addresses?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Nodestatus.conditions(init: NodeCondition.() -> Unit) {
  this as Nodestatus_core_v1_k8s1_21Impl
  NodeCondition_core_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Nodestatus.config(init: NodeConfigStatus.() -> Unit) {
  this as Nodestatus_core_v1_k8s1_21Impl
  NodeConfigStatus_core_v1_k8s1_21Impl(this)
    .also { config = it }
    .apply(init)
}
...
fun Nodestatus.daemonEndpoints(init: NodeDaemonEndpoints.() -> Unit) {
  this as Nodestatus_core_v1_k8s1_21Impl
  NodeDaemonEndpoints_core_v1_k8s1_21Impl(this)
...
fun Nodestatus.images(init: ContainerImage.() -> Unit) {
  this as Nodestatus_core_v1_k8s1_21Impl
  ContainerImage_core_v1_k8s1_21Impl(this)
...
fun Nodestatus.nodeInfo(init: NodeSystemInfo.() -> Unit) {
  this as Nodestatus_core_v1_k8s1_21Impl
  NodeSystemInfo_core_v1_k8s1_21Impl(this)
    .also { nodeInfo = it }
    .apply(init)
}
...
fun Nodestatus.volumesAttached(init: AttachedVolume.() -> Unit) {
  this as Nodestatus_core_v1_k8s1_21Impl
  AttachedVolume_core_v1_k8s1_21Impl(this)
...
fun Persistentvolumeclaimspec.dataSource(init: TypedLocalObjectReference.() -> Unit) {
  this as Persistentvolumeclaimspec_core_v1_k8s1_21Impl
  TypedLocalObjectReference_core_v1_k8s1_21Impl(this)
    .also { dataSource = it }
    .apply(init)
}
...
fun Persistentvolumeclaimstatus.conditions(init: PersistentVolumeClaimCondition.() -> Unit) {
  this as Persistentvolumeclaimstatus_core_v1_k8s1_21Impl
  PersistentVolumeClaimCondition_core_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Persistentvolumespec.awsElasticBlockStore(init: AWSElasticBlockStoreVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  AWSElasticBlockStoreVolumeSource_core_v1_k8s1_21Impl(this)
    .also { awsElasticBlockStore = it }
    .apply(init)
}
...
fun Persistentvolumespec.azureFile(init: AzureFilePersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  AzureFilePersistentVolumeSource_core_v1_k8s1_21Impl(this)
    .also { azureFile = it }
    .apply(init)
}
...
fun Persistentvolumespec.cephfs(init: CephFSPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  CephFSPersistentVolumeSource_core_v1_k8s1_21Impl(this)
    .also { cephfs = it }
    .apply(init)
}
...
fun Persistentvolumespec.cinder(init: CinderPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  CinderPersistentVolumeSource_core_v1_k8s1_21Impl(this)
    .also { cinder = it }
    .apply(init)
}
...
fun Persistentvolumespec.csi(init: CSIPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  CSIPersistentVolumeSource_core_v1_k8s1_21Impl(this)
    .also { csi = it }
    .apply(init)
}
...
fun Persistentvolumespec.flexVolume(init: FlexPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  FlexPersistentVolumeSource_core_v1_k8s1_21Impl(this)
    .also { flexVolume = it }
    .apply(init)
}
...
fun Persistentvolumespec.glusterfs(init: GlusterfsPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  GlusterfsPersistentVolumeSource_core_v1_k8s1_21Impl(this)
    .also { glusterfs = it }
    .apply(init)
}
...
fun Persistentvolumespec.iscsi(init: ISCSIPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  ISCSIPersistentVolumeSource_core_v1_k8s1_21Impl(this)
    .also { iscsi = it }
    .apply(init)
}
...
fun Persistentvolumespec.local(init: LocalVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  LocalVolumeSource_core_v1_k8s1_21Impl(this)
    .also { local = it }
    .apply(init)
}
...
fun Persistentvolumespec.nodeAffinity(init: VolumeNodeAffinity.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  VolumeNodeAffinity_core_v1_k8s1_21Impl(this)
    .also { nodeAffinity = it }
    .apply(init)
}
...
fun Persistentvolumespec.rbd(init: RBDPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  RBDPersistentVolumeSource_core_v1_k8s1_21Impl(this)
    .also { rbd = it }
    .apply(init)
}
...
fun Persistentvolumespec.scaleIO(init: ScaleIOPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  ScaleIOPersistentVolumeSource_core_v1_k8s1_21Impl(this)
    .also { scaleIO = it }
    .apply(init)
}
...
fun Persistentvolumespec.storageos(init: StorageOSPersistentVolumeSource.() -> Unit) {
  this as Persistentvolumespec_core_v1_k8s1_21Impl
  StorageOSPersistentVolumeSource_core_v1_k8s1_21Impl(this)
    .also { storageos = it }
    .apply(init)
}
...
fun Poddisruptionbudgetspec.selector(init: LabelSelector.() -> Unit) {
  this as Poddisruptionbudgetspec_policy_v1_k8s1_21Impl
  LabelSelector_meta_v1_k8s1_21Impl(this)
    .also { selector = it }
    .apply(init)
}
...
fun Poddisruptionbudgetstatus.conditions(init: Condition.() -> Unit) {
  this as Poddisruptionbudgetstatus_policy_v1_k8s1_21Impl
  Condition_meta_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Podsecuritypolicyspec.allowedCSIDrivers(init: AllowedCSIDriver.() -> Unit) {
  this as Podsecuritypolicyspec_policy_v1beta1_k8s1_21Impl
  AllowedCSIDriver_policy_v1beta1_k8s1_21Impl(this)
...
fun Podsecuritypolicyspec.allowedFlexVolumes(init: AllowedFlexVolume.() -> Unit) {
  this as Podsecuritypolicyspec_policy_v1beta1_k8s1_21Impl
  AllowedFlexVolume_policy_v1beta1_k8s1_21Impl(this)
...
fun Podsecuritypolicyspec.allowedHostPaths(init: AllowedHostPath.() -> Unit) {
  this as Podsecuritypolicyspec_policy_v1beta1_k8s1_21Impl
  AllowedHostPath_policy_v1beta1_k8s1_21Impl(this)
...
fun Podsecuritypolicyspec.fsGroup(init: FSGroupStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_policy_v1beta1_k8s1_21Impl
  FSGroupStrategyOptions_policy_v1beta1_k8s1_21Impl(this)
    .also { fsGroup = it }
    .apply(init)
}
...
fun Podsecuritypolicyspec.hostPorts(init: HostPortRange.() -> Unit) {
  this as Podsecuritypolicyspec_policy_v1beta1_k8s1_21Impl
  HostPortRange_policy_v1beta1_k8s1_21Impl(this)
...
fun Podsecuritypolicyspec.runAsGroup(init: RunAsGroupStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_policy_v1beta1_k8s1_21Impl
  RunAsGroupStrategyOptions_policy_v1beta1_k8s1_21Impl(this)
    .also { runAsGroup = it }
    .apply(init)
}
...
fun Podsecuritypolicyspec.runAsUser(init: RunAsUserStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_policy_v1beta1_k8s1_21Impl
  RunAsUserStrategyOptions_policy_v1beta1_k8s1_21Impl(this)
    .also { runAsUser = it }
    .apply(init)
}
...
fun Podsecuritypolicyspec.runtimeClass(init: RuntimeClassStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_policy_v1beta1_k8s1_21Impl
  RuntimeClassStrategyOptions_policy_v1beta1_k8s1_21Impl(this)
...
fun Podsecuritypolicyspec.seLinux(init: SELinuxStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_policy_v1beta1_k8s1_21Impl
  SELinuxStrategyOptions_policy_v1beta1_k8s1_21Impl(this)
    .also { seLinux = it }
    .apply(init)
}
...
fun Podsecuritypolicyspec.supplementalGroups(init: SupplementalGroupsStrategyOptions.() -> Unit) {
  this as Podsecuritypolicyspec_policy_v1beta1_k8s1_21Impl
  SupplementalGroupsStrategyOptions_policy_v1beta1_k8s1_21Impl(this)
...
fun Podspec.affinity(init: Affinity.() -> Unit) {
  this as Podspec_core_v1_k8s1_21Impl
  Affinity_core_v1_k8s1_21Impl(this)
    .also { affinity = it }
    .apply(init)
}
...
fun Podspec.containers(init: Container.() -> Unit) {
  this as Podspec_core_v1_k8s1_21Impl
  Container_core_v1_k8s1_21Impl(this)
...
fun Podspec.dnsConfig(init: PodDNSConfig.() -> Unit) {
  this as Podspec_core_v1_k8s1_21Impl
  PodDNSConfig_core_v1_k8s1_21Impl(this)
    .also { dnsConfig = it }
    .apply(init)
}
...
fun Podspec.hostAliases(init: HostAlias.() -> Unit) {
  this as Podspec_core_v1_k8s1_21Impl
  HostAlias_core_v1_k8s1_21Impl(this)
...
fun Podspec.readinessGates(init: PodReadinessGate.() -> Unit) {
  this as Podspec_core_v1_k8s1_21Impl
  PodReadinessGate_core_v1_k8s1_21Impl(this)
...
fun Podspec.securityContext(init: PodSecurityContext.() -> Unit) {
  this as Podspec_core_v1_k8s1_21Impl
  PodSecurityContext_core_v1_k8s1_21Impl(this)
    .also { securityContext = it }
    .apply(init)
}
...
fun Podspec.topologySpreadConstraints(init: TopologySpreadConstraint.() -> Unit) {
  this as Podspec_core_v1_k8s1_21Impl
  TopologySpreadConstraint_core_v1_k8s1_21Impl(this)
...
fun Podspec.volumes(init: Volume.() -> Unit) {
  this as Podspec_core_v1_k8s1_21Impl
  Volume_core_v1_k8s1_21Impl(this)
...
fun Podstatus.conditions(init: PodCondition.() -> Unit) {
  this as Podstatus_core_v1_k8s1_21Impl
  PodCondition_core_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Podstatus.containerStatuses(init: Containerstatus.() -> Unit) {
  this as Podstatus_core_v1_k8s1_21Impl
  Containerstatus_core_v1_k8s1_21Impl(this)
...
fun Podstatus.podIPs(init: PodIP.() -> Unit) {
  this as Podstatus_core_v1_k8s1_21Impl
  PodIP_core_v1_k8s1_21Impl(this)
...
fun Podtemplatespec.metadata(init: ObjectMeta.() -> Unit) {
  this as Podtemplatespec_core_v1_k8s1_21Impl
  ObjectMeta_meta_v1_k8s1_21Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
fun Prioritylevelconfigurationspec.limited(init: LimitedPriorityLevelConfiguration.() -> Unit) {
  this as Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  LimitedPriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { limited = it }
    .apply(init)
}
...
fun Prioritylevelconfigurationstatus.conditions(init: PriorityLevelConfigurationCondition.() -> Unit) {
  this as Prioritylevelconfigurationstatus_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl
  PriorityLevelConfigurationCondition_flowcontrol_apiserver_k8s_io_v1beta1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Replicasetspec.selector(init: LabelSelector.() -> Unit) {
  this as Replicasetspec_apps_v1_k8s1_21Impl
  LabelSelector_meta_v1_k8s1_21Impl(this)
    .also { selector = it }
    .apply(init)
}
...
fun Replicasetstatus.conditions(init: ReplicaSetCondition.() -> Unit) {
  this as Replicasetstatus_apps_v1_k8s1_21Impl
  ReplicaSetCondition_apps_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Replicationcontrollerspec.template(init: Podtemplatespec.() -> Unit) {
  this as Replicationcontrollerspec_core_v1_k8s1_21Impl
  Podtemplatespec_core_v1_k8s1_21Impl(this)
    .also { template = it }
    .apply(init)
}
...
fun Replicationcontrollerstatus.conditions(init: ReplicationControllerCondition.() -> Unit) {
  this as Replicationcontrollerstatus_core_v1_k8s1_21Impl
  ReplicationControllerCondition_core_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Resourcequotaspec.scopeSelector(init: ScopeSelector.() -> Unit) {
  this as Resourcequotaspec_core_v1_k8s1_21Impl
  ScopeSelector_core_v1_k8s1_21Impl(this)
...
fun Rollingupdatedaemonset.maxUnavailable(percentage: String) {
  this as Rollingupdatedaemonset_apps_v1_k8s1_21Impl
...
fun Rollingupdatedeployment.maxSurge(percentage: String) {
  this as Rollingupdatedeployment_apps_v1_k8s1_21Impl
  de.loosetie.k8s.dsl.types.IntOrPercentage(percentage)
    .also { maxSurge = it }
}
...
fun Selfsubjectaccessreviewspec.nonResourceAttributes(init: NonResourceAttributes.() -> Unit) {
  this as Selfsubjectaccessreviewspec_authorization_k8s_io_v1_k8s1_21Impl
  NonResourceAttributes_authorization_k8s_io_v1_k8s1_21Impl(this)
...
fun Selfsubjectaccessreviewspec.resourceAttributes(init: ResourceAttributes.() -> Unit) {
  this as Selfsubjectaccessreviewspec_authorization_k8s_io_v1_k8s1_21Impl
  ResourceAttributes_authorization_k8s_io_v1_k8s1_21Impl(this)
...
fun Servicespec.ports(init: ServicePort.() -> Unit) {
  this as Servicespec_core_v1_k8s1_21Impl
  ServicePort_core_v1_k8s1_21Impl(this)
    .also { ports = ports?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Servicespec.sessionAffinityConfig(init: SessionAffinityConfig.() -> Unit) {
  this as Servicespec_core_v1_k8s1_21Impl
  SessionAffinityConfig_core_v1_k8s1_21Impl(this)
...
fun Servicestatus.conditions(init: Condition.() -> Unit) {
  this as Servicestatus_core_v1_k8s1_21Impl
  Condition_meta_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Statefulsetspec.selector(init: LabelSelector.() -> Unit) {
  this as Statefulsetspec_apps_v1_k8s1_21Impl
  LabelSelector_meta_v1_k8s1_21Impl(this)
    .also { selector = it }
    .apply(init)
}
...
fun Statefulsetspec.updateStrategy(init: StatefulSetUpdateStrategy.() -> Unit) {
  this as Statefulsetspec_apps_v1_k8s1_21Impl
  StatefulSetUpdateStrategy_apps_v1_k8s1_21Impl(this)
    .also { updateStrategy = it }
    .apply(init)
}
...
fun Statefulsetspec.volumeClaimTemplates(init: PersistentVolumeClaim.() -> Unit) {
  this as Statefulsetspec_apps_v1_k8s1_21Impl
  PersistentVolumeClaim_core_v1_k8s1_21Impl(this)
...
fun Statefulsetstatus.conditions(init: StatefulSetCondition.() -> Unit) {
  this as Statefulsetstatus_apps_v1_k8s1_21Impl
  StatefulSetCondition_apps_v1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Storageversionstatus.conditions(init: StorageVersionCondition.() -> Unit) {
  this as Storageversionstatus_internal_apiserver_k8s_io_v1alpha1_k8s1_21Impl
  StorageVersionCondition_internal_apiserver_k8s_io_v1alpha1_k8s1_21Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun Storageversionstatus.storageVersions(init: ServerStorageVersion.() -> Unit) {
  this as Storageversionstatus_internal_apiserver_k8s_io_v1alpha1_k8s1_21Impl
  ServerStorageVersion_internal_apiserver_k8s_io_v1alpha1_k8s1_21Impl(this)
...
fun Subjectaccessreviewspec.nonResourceAttributes(init: NonResourceAttributes.() -> Unit) {
  this as Subjectaccessreviewspec_authorization_k8s_io_v1_k8s1_21Impl
  NonResourceAttributes_authorization_k8s_io_v1_k8s1_21Impl(this)
    .also { nonResourceAttributes = it }
    .apply(init)
}
...
fun Tokenrequestspec.boundObjectRef(init: BoundObjectReference.() -> Unit) {
  this as Tokenrequestspec_authentication_k8s_io_v1_k8s1_21Impl
  BoundObjectReference_authentication_k8s_io_v1_k8s1_21Impl(this)
...
fun Tokenrequeststatus.expirationTimestamp(init: Time.() -> Unit) {
  this as Tokenrequeststatus_authentication_k8s_io_v1_k8s1_21Impl
  Time_meta_v1_k8s1_21Impl(this)
...
fun Tokenreviewstatus.user(init: UserInfo.() -> Unit) {
  this as Tokenreviewstatus_authentication_k8s_io_v1_k8s1_21Impl
  UserInfo_authentication_k8s_io_v1_k8s1_21Impl(this)
    .also { user = it }
    .apply(init)
}
...
fun Volumeattachmentspec.source(init: VolumeAttachmentSource.() -> Unit) {
  this as Volumeattachmentspec_storage_k8s_io_v1_k8s1_21Impl
  VolumeAttachmentSource_storage_k8s_io_v1_k8s1_21Impl(this)
    .also { source = it }
    .apply(init)
}
...
fun Volumeattachmentstatus.attachError(init: VolumeError.() -> Unit) {
  this as Volumeattachmentstatus_storage_k8s_io_v1_k8s1_21Impl
  VolumeError_storage_k8s_io_v1_k8s1_21Impl(this)
    .also { attachError = it }
    .apply(init)
}
