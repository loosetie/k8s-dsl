...
@K8sDslMarker
interface EnvVarSource_core_v1_k8s1_21: K8sManifest {
  /** Selects a key of a ConfigMap. */
  val configMapKeyRef: ConfigMapKeySelector_core_v1_k8s1_21?
  /** Selects a field of the pod: supports metadata.name, metadata.namespace, `metadata.labels['<KEY>']`,
`metadata.annotations['<KEY>']`, spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP, status.podIPs. */
  val fieldRef: ObjectFieldSelector_core_v1_k8s1_21?
...
limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported. */
  val resourceFieldRef: ResourceFieldSelector_core_v1_k8s1_21?
  /** Selects a key of a secret in the pod's namespace */
  val secretKeyRef: SecretKeySelector_core_v1_k8s1_21?
}