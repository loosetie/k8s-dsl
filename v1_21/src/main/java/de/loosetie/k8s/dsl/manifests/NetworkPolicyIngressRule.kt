...
@K8sDslMarker
interface NetworkPolicyIngressRule_networking_k8s_io_v1_k8s1_21: K8sManifest {
...
at least one item in the from list. */
  val from: List<NetworkPolicyPeer_networking_k8s_io_v1_k8s1_21>?
...
one port in the list. */
  val ports: List<NetworkPolicyPort_networking_k8s_io_v1_k8s1_21>?
}