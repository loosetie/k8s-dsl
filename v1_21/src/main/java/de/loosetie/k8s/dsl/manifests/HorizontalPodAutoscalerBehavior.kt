...
@K8sDslMarker
interface HorizontalPodAutoscalerBehavior_autoscaling_v2beta2_k8s1_21: K8sManifest {
...
pods, with a 300 second stabilization window (i.e., the highest recommendation for the last 300sec is used). */
  val scaleDown: HPAScalingRules_autoscaling_v2beta2_k8s1_21?
...
pods per 60 seconds `*` double the number of pods per 60 seconds No stabilization is used. */
  val scaleUp: HPAScalingRules_autoscaling_v2beta2_k8s1_21?
}