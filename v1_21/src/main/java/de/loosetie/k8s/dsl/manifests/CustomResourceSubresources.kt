...
@K8sDslMarker
interface CustomResourceSubresources_apiextensions_k8s_io_v1_k8s1_21: K8sManifest {
  /** scale indicates the custom resource should serve a `/scale` subresource that returns an `autoscaling/v1` Scale object. */
  val scale: CustomResourceSubresourceScale_apiextensions_k8s_io_v1_k8s1_21?
...
`/status` subresource ignore changes to anything other than the `status` stanza of the object. */
  val status: CustomResourceSubresourceStatus_apiextensions_k8s_io_v1_k8s1_21?
}