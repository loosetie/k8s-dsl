...
class Replicasetstatus_apps_v1_k8s1_21Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Replicasetstatus_apps_v1_k8s1_21, HasParent {
  override var availableReplicas: Int? = null
  override var conditions: List<ReplicaSetCondition_apps_v1_k8s1_21>? = null
