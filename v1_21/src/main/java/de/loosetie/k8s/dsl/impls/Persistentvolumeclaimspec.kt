...
class Persistentvolumeclaimspec_core_v1_k8s1_21Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Persistentvolumeclaimspec_core_v1_k8s1_21, HasParent {
  override var accessModes: List<String>? = null
  override var dataSource: TypedLocalObjectReference_core_v1_k8s1_21? = null
