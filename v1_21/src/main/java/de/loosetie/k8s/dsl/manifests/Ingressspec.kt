...
@K8sDslMarker
interface Ingressspec_networking_k8s_io_v1_k8s1_21: K8sManifest {
...
rules will be up to the Ingress controller. */
  val defaultBackend: IngressBackend_networking_k8s_io_v1_k8s1_21?
...
default backend. */
  val rules: List<IngressRule_networking_k8s_io_v1_k8s1_21>?
...
extension, if the ingress controller fulfilling the ingress supports SNI. */
  val tls: List<IngressTLS_networking_k8s_io_v1_k8s1_21>?
}