...
class JSONSchemaProps_apiextensions_k8s_io_v1_k8s1_21Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: JSONSchemaProps_apiextensions_k8s_io_v1_k8s1_21, HasParent {
  override var `$ref`: String? = null
  override var `$schema`: String? = null
  override var additionalItems: JSONSchemaPropsOrBool_apiextensions_k8s_io_v1_k8s1_21? = null
  override var additionalProperties: JSONSchemaPropsOrBool_apiextensions_k8s_io_v1_k8s1_21? = null
  override var allOf: List<JSONSchemaProps_apiextensions_k8s_io_v1_k8s1_21>? = null
  override var anyOf: List<JSONSchemaProps_apiextensions_k8s_io_v1_k8s1_21>? = null
  override var default: JSON_apiextensions_k8s_io_v1_k8s1_21? = null
  override var definitions: Any? = null
  override var dependencies: Any? = null
  override var description: String? = null
  override var enum: List<JSON_apiextensions_k8s_io_v1_k8s1_21>? = null
  override var example: JSON_apiextensions_k8s_io_v1_k8s1_21? = null
  override var exclusiveMaximum: Boolean? = null
  override var exclusiveMinimum: Boolean? = null
  override var externalDocs: ExternalDocumentation_apiextensions_k8s_io_v1_k8s1_21? = null
  override var format: String? = null
  override var id: String? = null
  override var items: JSONSchemaPropsOrArray_apiextensions_k8s_io_v1_k8s1_21? = null
  ...
  override var not: JSONSchemaProps_apiextensions_k8s_io_v1_k8s1_21? = null
  override var nullable: Boolean? = null
  override var oneOf: List<JSONSchemaProps_apiextensions_k8s_io_v1_k8s1_21>? = null
