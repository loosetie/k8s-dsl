...
@K8sDslMarker
interface APIGroup_meta_v1_k8s1_21: K8sTopLevel {
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
  ...
  val preferredVersion: GroupVersionForDiscovery_meta_v1_k8s1_21?
...
order) to get the client IP. */
  val serverAddressByClientCIDRs: List<ServerAddressByClientCIDR_meta_v1_k8s1_21>?
  /** versions are the versions supported in this group. */
  val versions: List<GroupVersionForDiscovery_meta_v1_k8s1_21>?
}