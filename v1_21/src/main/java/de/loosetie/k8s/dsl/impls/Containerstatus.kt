...
class Containerstatus_core_v1_k8s1_21Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Containerstatus_core_v1_k8s1_21, HasParent {
  override var name: String? = null
  override var containerID: String? = null
  override var image: String? = null
  override var imageID: String? = null
  override var lastState: ContainerState_core_v1_k8s1_21? = null
  override var ready: Boolean? = null
  override var restartCount: Int? = null
  override var started: Boolean? = null
  override var state: ContainerState_core_v1_k8s1_21? = null
}