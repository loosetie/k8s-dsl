...
@K8sDslMarker
interface CertificateSigningRequest_certificates_k8s_io_v1_k8s1_21: K8sTopLevel, HasMetadata {
...
can be set on creation. Other fields are derived by Kubernetes and cannot be modified by users. */
  val spec: Certificatesigningrequestspec_certificates_k8s_io_v1_k8s1_21
...
or the failure condition indicating signer failure. */
  val status: Certificatesigningrequeststatus_certificates_k8s_io_v1_k8s1_21?
}