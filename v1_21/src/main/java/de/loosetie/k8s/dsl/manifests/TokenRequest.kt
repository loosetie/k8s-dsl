...
@K8sDslMarker
interface TokenRequest_authentication_k8s_io_v1_k8s1_21: K8sTopLevel, HasMetadata {
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
  ...
  /**  */
  val spec: Tokenrequestspec_authentication_k8s_io_v1_k8s1_21
  /**  */
  val status: Tokenrequeststatus_authentication_k8s_io_v1_k8s1_21?
}

@Deprecated(message="Old api version")
@K8sDslMarker
interface TokenRequest_storage_k8s_io_v1_k8s1_21: K8sManifest {
