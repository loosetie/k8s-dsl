...
@K8sDslMarker
interface ObjectMeta_meta_v1: K8sManifest {
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
  val creationTimestamp: Time_meta_v1?
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
  val deletionTimestamp: Time_meta_v1?
...
the generated name exists, the server will return a 409. Applied only if Name is not specified. More info:
...
that the workflow used when modifying the object. */
  val managedFields: List<ManagedFieldsEntry_meta_v1>?
...
controller field set to true. There cannot be more than one managing controller. */
  val ownerReferences: List<OwnerReference_meta_v1>?
