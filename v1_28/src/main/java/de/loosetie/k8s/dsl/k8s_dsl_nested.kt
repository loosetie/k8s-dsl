...
complete the CSI NodeExpandVolume call. This is a beta field which is enabled default by CSINodeExpandSecret feature
gate. This field is optional, may be omitted if no secret is required. If the secret object contains more than one
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
@K8sDslMarker
fun ClusterCIDR.metadata(init: ObjectMeta.() -> Unit) {
  this as ClusterCIDR_networking_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun ClusterCIDR.spec(init: Clustercidrspec_networking_k8s_io_v1alpha1.() -> Unit) {
  this as ClusterCIDR_networking_k8s_io_v1alpha1Impl
  Clustercidrspec_networking_k8s_io_v1alpha1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun FlowSchemaCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as FlowSchemaCondition_flowcontrol_apiserver_k8s_io_v1beta3Impl
  Time_meta_v1Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun FlowSchema.metadata(init: ObjectMeta.() -> Unit) {
  this as FlowSchema_flowcontrol_apiserver_k8s_io_v1beta3Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun FlowSchema.spec(init: Flowschemaspec_flowcontrol_apiserver_k8s_io_v1beta3.() -> Unit) {
  this as FlowSchema_flowcontrol_apiserver_k8s_io_v1beta3Impl
  Flowschemaspec_flowcontrol_apiserver_k8s_io_v1beta3Impl(this)
    .also { spec = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun FlowSchema.status(init: Flowschemastatus_flowcontrol_apiserver_k8s_io_v1beta3.() -> Unit) {
  this as FlowSchema_flowcontrol_apiserver_k8s_io_v1beta3Impl
  Flowschemastatus_flowcontrol_apiserver_k8s_io_v1beta3Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun LimitResponse.queuing(init: QueuingConfiguration.() -> Unit) {
  this as LimitResponse_flowcontrol_apiserver_k8s_io_v1beta3Impl
  QueuingConfiguration_flowcontrol_apiserver_k8s_io_v1beta3Impl(this)
    .also { queuing = it }
    .apply(init)
}
...
fun LimitedPriorityLevelConfiguration.limitResponse(init: LimitResponse.() -> Unit) {
  this as LimitedPriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1beta3Impl
  LimitResponse_flowcontrol_apiserver_k8s_io_v1beta3Impl(this)
...
fun PolicyRulesWithSubjects.nonResourceRules(init: NonResourcePolicyRule.() -> Unit) {
  this as PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1beta3Impl
  NonResourcePolicyRule_flowcontrol_apiserver_k8s_io_v1beta3Impl(this)
...
fun PolicyRulesWithSubjects.resourceRules(init: ResourcePolicyRule.() -> Unit) {
  this as PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1beta3Impl
  ResourcePolicyRule_flowcontrol_apiserver_k8s_io_v1beta3Impl(this)
    .also { resourceRules = resourceRules?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun PolicyRulesWithSubjects.subjects(init: Subject.() -> Unit) {
  this as PolicyRulesWithSubjects_flowcontrol_apiserver_k8s_io_v1beta3Impl
  Subject_flowcontrol_apiserver_k8s_io_v1beta3Impl(this)
    .also { subjects = subjects?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
fun PriorityLevelConfigurationCondition.lastTransitionTime(init: Time.() -> Unit) {
  this as PriorityLevelConfigurationCondition_flowcontrol_apiserver_k8s_io_v1beta3Impl
  Time_meta_v1Impl(this)
    .also { lastTransitionTime = it }
    .apply(init)
}
...
fun PriorityLevelConfiguration.metadata(init: ObjectMeta.() -> Unit) {
  this as PriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1beta3Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun PriorityLevelConfiguration.spec(init: Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1beta3.() -> Unit) {
  this as PriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1beta3Impl
  Prioritylevelconfigurationspec_flowcontrol_apiserver_k8s_io_v1beta3Impl(this)
    .also { spec = it }
    .apply(init)
}
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun PriorityLevelConfiguration.status(init: Prioritylevelconfigurationstatus_flowcontrol_apiserver_k8s_io_v1beta3.() -> Unit) {
  this as PriorityLevelConfiguration_flowcontrol_apiserver_k8s_io_v1beta3Impl
  Prioritylevelconfigurationstatus_flowcontrol_apiserver_k8s_io_v1beta3Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun Subject.group(init: GroupSubject.() -> Unit) {
  this as Subject_flowcontrol_apiserver_k8s_io_v1beta3Impl
  GroupSubject_flowcontrol_apiserver_k8s_io_v1beta3Impl(this)
    .also { group = it }
    .apply(init)
}
...
fun Subject.serviceAccount(init: ServiceAccountSubject.() -> Unit) {
  this as Subject_flowcontrol_apiserver_k8s_io_v1beta3Impl
  ServiceAccountSubject_flowcontrol_apiserver_k8s_io_v1beta3Impl(this)
