...
@K8sDslMarker
interface PriorityClass_scheduling_k8s_io_v1: K8sTopLevel, HasMetadata {
...
PreemptLowerPriority if unset. */
  ...
  /** value represents the integer value of this priority class. This is the actual priority that pods receive when they have
