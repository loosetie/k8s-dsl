...
@K8sDslMarker
interface ValidatingAdmissionPolicy_admissionregistration_k8s_io_v1beta1: K8sTopLevel, HasMetadata {
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata. */
  ...
  val spec: Validatingadmissionpolicyspec_admissionregistration_k8s_io_v1beta1
...
the expected way. Populated by the system. Read-only. */
  val status: Validatingadmissionpolicystatus_admissionregistration_k8s_io_v1beta1?
}