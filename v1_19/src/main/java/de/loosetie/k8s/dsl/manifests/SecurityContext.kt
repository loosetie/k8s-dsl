...
@K8sDslMarker
interface SecurityContext_core_v1_k8s1_19: K8sManifest {
...
container runtime. */
  val capabilities: Capabilities_core_v1_k8s1_19?
...
PodSecurityContext, the value specified in SecurityContext takes precedence. */
  val seLinuxOptions: SELinuxOptions_core_v1_k8s1_19?
...
used. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence. */
  val windowsOptions: WindowsSecurityContextOptions_core_v1_k8s1_19?
}