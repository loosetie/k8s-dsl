...
@K8sDslMarker
interface PodAntiAffinity_core_v1_k8s1_19: K8sManifest {
...
the highest sum are the most preferred. */
  val preferredDuringSchedulingIgnoredDuringExecution: List<WeightedPodAffinityTerm_core_v1_k8s1_19>?
...
terms must be satisfied. */
  val requiredDuringSchedulingIgnoredDuringExecution: List<PodAffinityTerm_core_v1_k8s1_19>?
}