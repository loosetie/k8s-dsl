...
class StorageClass_storage_k8s_io_v1_k8s1_19Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: StorageClass_storage_k8s_io_v1_k8s1_19, HasParent {
  override lateinit var metadata: ObjectMeta_meta_v1_k8s1_19
  override var allowVolumeExpansion: Boolean? = null
  override var allowedTopologies: List<TopologySelectorTerm_core_v1_k8s1_19>? = null
