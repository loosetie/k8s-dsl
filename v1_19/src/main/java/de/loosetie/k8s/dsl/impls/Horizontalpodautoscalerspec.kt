...
class Horizontalpodautoscalerspec_autoscaling_v1_k8s1_19Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Horizontalpodautoscalerspec_autoscaling_v1_k8s1_19, HasParent {
  override var maxReplicas: Int? = null
  override var minReplicas: Int? = null
  override var scaleTargetRef: CrossVersionObjectReference_autoscaling_v1_k8s1_19? = null
