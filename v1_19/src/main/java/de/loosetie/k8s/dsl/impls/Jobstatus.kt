...
class Jobstatus_batch_v1_k8s1_19Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Jobstatus_batch_v1_k8s1_19, HasParent {
  override var active: Int? = null
  override var completionTime: Time_meta_v1_k8s1_19? = null
  override var conditions: List<JobCondition_batch_v1_k8s1_19>? = null
