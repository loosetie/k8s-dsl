...
@K8sDslMarker
interface CustomResourceDefinitionVersion_apiextensions_k8s_io_v1_k8s1_19: K8sManifest {
...
are specified, a single column displaying the age of the custom resource is used. */
  val additionalPrinterColumns: List<CustomResourceColumnDefinition_apiextensions_k8s_io_v1_k8s1_19>?
...
stability, if one exists. */
  ...
  val schema: CustomResourceValidation_apiextensions_k8s_io_v1_k8s1_19?
...
version with storage=true. */
  ...
  val subresources: CustomResourceSubresources_apiextensions_k8s_io_v1_k8s1_19?
}