...
class Persistentvolumeclaimspec_core_v1_k8s1_19Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Persistentvolumeclaimspec_core_v1_k8s1_19, HasParent {
  override var accessModes: List<String>? = null
  override var dataSource: TypedLocalObjectReference_core_v1_k8s1_19? = null
