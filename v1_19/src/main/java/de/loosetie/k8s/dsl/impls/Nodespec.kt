...
class Nodespec_core_v1_k8s1_19Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Nodespec_core_v1_k8s1_19, HasParent {
  override var configSource: NodeConfigSource_core_v1_k8s1_19? = null
  ...
  override var taints: List<Taint_core_v1_k8s1_19>? = null
