...
@K8sDslMarker
interface TokenRequest_authentication_k8s_io_v1: K8sTopLevel, HasMetadata {
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
  ...
  val spec: Tokenrequestspec_authentication_k8s_io_v1
  /** Status is filled in by the server and indicates whether the token can be authenticated. */
  val status: Tokenrequeststatus_authentication_k8s_io_v1?
}

@Deprecated(message="Old api version")
@K8sDslMarker
interface TokenRequest_storage_k8s_io_v1: K8sManifest {
