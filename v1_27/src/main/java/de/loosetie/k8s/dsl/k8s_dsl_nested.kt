...
@K8sDslMarker
fun ClusterCIDR.spec(init: Clustercidrspec.() -> Unit) {
  this as ClusterCIDR_networking_k8s_io_v1alpha1Impl
...
@K8sDslMarker
fun ClusterTrustBundle.spec(init: Clustertrustbundlespec.() -> Unit) {
  this as ClusterTrustBundle_certificates_k8s_io_v1alpha1Impl
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status */
@K8sDslMarker
fun IPAddress.spec(init: Ipaddressspec.() -> Unit) {
  this as IPAddress_networking_k8s_io_v1alpha1Impl
...
fun MatchResources.excludeResourceRules(init: NamedRuleWithOperations.() -> Unit) {
  this as MatchResources_admissionregistration_k8s_io_v1alpha1Impl
  NamedRuleWithOperations_admissionregistration_k8s_io_v1alpha1Impl(this)
...
is an alpha feature and managed by the AdmissionWebhookMatchConditions feature gate. */
@K8sDslMarker
...
@K8sDslMarker
fun PodSchedulingContext.spec(init: Podschedulingcontextspec.() -> Unit) {
  this as PodSchedulingContext_resource_k8s_io_v1alpha2Impl
...
@K8sDslMarker
fun PodSchedulingContext.status(init: Podschedulingcontextstatus.() -> Unit) {
  this as PodSchedulingContext_resource_k8s_io_v1alpha2Impl
...
@K8sDslMarker
fun ResourceClaimTemplate.spec(init: Resourceclaimtemplatespec.() -> Unit) {
  this as ResourceClaimTemplate_resource_k8s_io_v1alpha2Impl
...
@K8sDslMarker
fun ResourceClaim_resource_k8s_io_v1alpha2.spec(init: Resourceclaimspec.() -> Unit) {
  this as ResourceClaim_resource_k8s_io_v1alpha2Impl
...
@K8sDslMarker
fun ResourceClaim_resource_k8s_io_v1alpha2.status(init: Resourceclaimstatus.() -> Unit) {
  this as ResourceClaim_resource_k8s_io_v1alpha2Impl
...
fun SelfSubjectReview.metadata(init: ObjectMeta.() -> Unit) {
  this as SelfSubjectReview_authentication_k8s_io_v1beta1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun SelfSubjectReview.status(init: Selfsubjectreviewstatus.() -> Unit) {
  this as SelfSubjectReview_authentication_k8s_io_v1beta1Impl
  Selfsubjectreviewstatus_authentication_k8s_io_v1beta1Impl(this)
    .also { status = it }
    .apply(init)
}
...
fun TypeChecking.expressionWarnings(init: ExpressionWarning.() -> Unit) {
  this as TypeChecking_admissionregistration_k8s_io_v1alpha1Impl
  ExpressionWarning_admissionregistration_k8s_io_v1alpha1Impl(this)
...
fun ValidatingAdmissionPolicyBinding.metadata(init: ObjectMeta.() -> Unit) {
  this as ValidatingAdmissionPolicyBinding_admissionregistration_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun ValidatingAdmissionPolicyBinding.spec(init: Validatingadmissionpolicybindingspec.() -> Unit) {
  this as ValidatingAdmissionPolicyBinding_admissionregistration_k8s_io_v1alpha1Impl
  Validatingadmissionpolicybindingspec_admissionregistration_k8s_io_v1alpha1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
fun ValidatingAdmissionPolicy.metadata(init: ObjectMeta.() -> Unit) {
  this as ValidatingAdmissionPolicy_admissionregistration_k8s_io_v1alpha1Impl
  ObjectMeta_meta_v1Impl(this)
    .also { metadata = it }
    .apply(init)
}
...
@K8sDslMarker
fun ValidatingAdmissionPolicy.spec(init: Validatingadmissionpolicyspec.() -> Unit) {
  this as ValidatingAdmissionPolicy_admissionregistration_k8s_io_v1alpha1Impl
  Validatingadmissionpolicyspec_admissionregistration_k8s_io_v1alpha1Impl(this)
    .also { spec = it }
    .apply(init)
}
...
@K8sDslMarker
fun ValidatingAdmissionPolicy.status(init: Validatingadmissionpolicystatus.() -> Unit) {
  this as ValidatingAdmissionPolicy_admissionregistration_k8s_io_v1alpha1Impl
  Validatingadmissionpolicystatus_admissionregistration_k8s_io_v1alpha1Impl(this)
    .also { status = it }
    .apply(init)
}
...
is immutable. */
@K8sDslMarker
fun Clustercidrspec.nodeSelector(init: NodeSelector.() -> Unit) {
...
@K8sDslMarker
fun Containerstatus.resources(init: ResourceRequirements.() -> Unit) {
  this as Containerstatus_core_v1Impl
  ResourceRequirements_core_v1Impl(this)
    .also { resources = it }
    .apply(init)
...
@K8sDslMarker
fun Ingressstatus.loadBalancer(init: IngressLoadBalancerStatus.() -> Unit) {
...
@K8sDslMarker
fun Ipaddressspec.parentRef(init: ParentReference.() -> Unit) {
...
This field cannot be used in combination with restartPolicy=OnFailure. This field is alpha-level. To use this field, you
must enable the `JobPodFailurePolicy` feature gate (disabled by default). */
@K8sDslMarker
fun Jobspec.podFailurePolicy(init: PodFailurePolicy.() -> Unit) {
...
@K8sDslMarker
fun Persistentvolumeclaimspec.dataSourceRef(init: TypedObjectReference.() -> Unit) {
  this as Persistentvolumeclaimspec_core_v1Impl
...
@K8sDslMarker
fun Podschedulingcontextstatus.resourceClaims(init: ResourceClaimSchedulingStatus.() -> Unit) {
...
@K8sDslMarker
fun Podspec.resourceClaims(init: PodResourceClaim.() -> Unit) {
  this as Podspec_core_v1Impl
...
@K8sDslMarker
fun Podspec.schedulingGates(init: PodSchedulingGate.() -> Unit) {
  this as Podspec_core_v1Impl
...
@K8sDslMarker
fun Resourceclaimspec.parametersRef(init: ResourceClaimParametersReference.() -> Unit) {
...
@K8sDslMarker
fun Resourceclaimstatus.allocation(init: AllocationResult.() -> Unit) {
...
@K8sDslMarker
fun Resourceclaimstatus.reservedFor(init: ResourceClaimConsumerReference.() -> Unit) {
  this as Resourceclaimstatus_resource_k8s_io_v1alpha2Impl
...
@K8sDslMarker
fun Resourceclaimtemplatespec.metadata(init: ObjectMeta.() -> Unit) {
...
@K8sDslMarker
fun Resourceclaimtemplatespec.spec(init: Resourceclaimspec.() -> Unit) {
  this as Resourceclaimtemplatespec_resource_k8s_io_v1alpha2Impl
  Resourceclaimspec_resource_k8s_io_v1alpha2Impl(this)
    .also { spec = it }
    .apply(init)
...
@K8sDslMarker
fun Selfsubjectreviewstatus.userInfo(init: UserInfo.() -> Unit) {
  this as Selfsubjectreviewstatus_authentication_k8s_io_v1beta1Impl
...
@K8sDslMarker
fun Statefulsetspec.ordinals(init: StatefulSetOrdinals.() -> Unit) {
...
@K8sDslMarker
fun Validatingadmissionpolicybindingspec.matchResources(init: MatchResources.() -> Unit) {
  this as Validatingadmissionpolicybindingspec_admissionregistration_k8s_io_v1alpha1Impl
  MatchResources_admissionregistration_k8s_io_v1alpha1Impl(this)
...
@K8sDslMarker
fun Validatingadmissionpolicybindingspec.paramRef(init: ParamRef.() -> Unit) {
  this as Validatingadmissionpolicybindingspec_admissionregistration_k8s_io_v1alpha1Impl
  ParamRef_admissionregistration_k8s_io_v1alpha1Impl(this)
    .also { paramRef = it }
    .apply(init)
}
...
required. */
@K8sDslMarker
fun Validatingadmissionpolicyspec.auditAnnotations(init: AuditAnnotation.() -> Unit) {
  this as Validatingadmissionpolicyspec_admissionregistration_k8s_io_v1alpha1Impl
  AuditAnnotation_admissionregistration_k8s_io_v1alpha1Impl(this)
...
@K8sDslMarker
fun Validatingadmissionpolicyspec.matchConditions(init: MatchCondition_admissionregistration_k8s_io_v1alpha1.() -> Unit) {
  this as Validatingadmissionpolicyspec_admissionregistration_k8s_io_v1alpha1Impl
  MatchCondition_admissionregistration_k8s_io_v1alpha1Impl(this)
    .also { matchConditions = matchConditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
@K8sDslMarker
fun Validatingadmissionpolicyspec.matchConstraints(init: MatchResources.() -> Unit) {
  this as Validatingadmissionpolicyspec_admissionregistration_k8s_io_v1alpha1Impl
  MatchResources_admissionregistration_k8s_io_v1alpha1Impl(this)
...
@K8sDslMarker
fun Validatingadmissionpolicyspec.paramKind(init: ParamKind.() -> Unit) {
  this as Validatingadmissionpolicyspec_admissionregistration_k8s_io_v1alpha1Impl
  ParamKind_admissionregistration_k8s_io_v1alpha1Impl(this)
    .also { paramKind = it }
    .apply(init)
}
...
@K8sDslMarker
fun Validatingadmissionpolicyspec.validations(init: Validation.() -> Unit) {
  this as Validatingadmissionpolicyspec_admissionregistration_k8s_io_v1alpha1Impl
  Validation_admissionregistration_k8s_io_v1alpha1Impl(this)
...
@K8sDslMarker
fun Validatingadmissionpolicystatus.conditions(init: Condition.() -> Unit) {
  this as Validatingadmissionpolicystatus_admissionregistration_k8s_io_v1alpha1Impl
  Condition_meta_v1Impl(this)
    .also { conditions = conditions?.let { p -> p + it } ?: listOf(it) }
    .apply(init)
}
...
@K8sDslMarker
fun Validatingadmissionpolicystatus.typeChecking(init: TypeChecking.() -> Unit) {
  this as Validatingadmissionpolicystatus_admissionregistration_k8s_io_v1alpha1Impl
  TypeChecking_admissionregistration_k8s_io_v1alpha1Impl(this)
