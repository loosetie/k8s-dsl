...
@K8sDslMarker
interface NodeConfigStatus_core_v1: K8sManifest {
...
results in an error. */
  val active: NodeConfigSource_core_v1?
...
Active config by loading and validating the checkpointed payload identified by Assigned. */
  val assigned: NodeConfigSource_core_v1?
...
determining config stability and correctness, as this may change or become configurable in the future. */
  val lastKnownGood: NodeConfigSource_core_v1?
}