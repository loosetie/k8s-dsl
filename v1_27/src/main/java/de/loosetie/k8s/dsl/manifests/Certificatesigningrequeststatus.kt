...
@K8sDslMarker
interface Certificatesigningrequeststatus_certificates_k8s_io_v1: K8sManifest {
...
CERTIFICATE----- ) */
  ...
  val conditions: List<CertificateSigningRequestCondition_certificates_k8s_io_v1>?
}