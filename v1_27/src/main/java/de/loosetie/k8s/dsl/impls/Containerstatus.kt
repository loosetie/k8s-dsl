...
@JsonPropertyOrder("name", "allocatedResources", "containerID", "image", "imageID", "lastState", "ready", "resources", "restartCount", "started", "state")
class Containerstatus_core_v1Impl(
  @JsonIgnore
