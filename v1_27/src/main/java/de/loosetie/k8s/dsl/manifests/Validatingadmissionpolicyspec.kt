...
required. */
  val auditAnnotations: List<AuditAnnotation_admissionregistration_k8s_io_v1alpha1>?
...
reject the request - If failurePolicy=Ignore, the policy is skipped */
  val matchConditions: List<MatchCondition_admissionregistration_k8s_io_v1alpha1>?
