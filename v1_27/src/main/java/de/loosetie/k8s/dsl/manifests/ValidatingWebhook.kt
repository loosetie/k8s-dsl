...
@K8sDslMarker
interface ValidatingWebhook_admissionregistration_k8s_io_v1: K8sManifest {
...
not include any versions known to the API Server, calls to the webhook will fail and be subject to the failure policy. */
  ...
  val clientConfig: WebhookClientConfig_admissionregistration_k8s_io_v1?
...
is an alpha feature and managed by the AdmissionWebhookMatchConditions feature gate. */
  val matchConditions: List<MatchCondition_admissionregistration_k8s_io_v1>?
...
for ValidatingWebhookConfiguration and MutatingWebhookConfiguration objects. */
  val rules: List<RuleWithOperations_admissionregistration_k8s_io_v1>?
...
a request may be rejected by a future step in the admission chain and the side effects therefore need to be undone.
