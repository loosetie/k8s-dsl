...
@K8sDslMarker
interface MetricValueStatus_autoscaling_v2beta2_k8s1_20: K8sManifest {
...
represented as a percentage of the requested value of the resource for the pods. */
  ...
  val averageValue: Quantity_core_resource_k8s1_20?
  /** value is the current value of the metric (as a quantity). */
  val value: Quantity_core_resource_k8s1_20?
}