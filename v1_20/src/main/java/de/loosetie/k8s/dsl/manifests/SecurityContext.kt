...
@K8sDslMarker
interface SecurityContext_core_v1_k8s1_20: K8sManifest {
...
container runtime. */
  val capabilities: Capabilities_core_v1_k8s1_20?
...
PodSecurityContext, the value specified in SecurityContext takes precedence. */
  val seLinuxOptions: SELinuxOptions_core_v1_k8s1_20?
...
container options override the pod options. */
  val seccompProfile: SeccompProfile_core_v1_k8s1_20?
...
used. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence. */
  val windowsOptions: WindowsSecurityContextOptions_core_v1_k8s1_20?
}