...
class StorageOSPersistentVolumeSource_core_v1_k8s1_20Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: StorageOSPersistentVolumeSource_core_v1_k8s1_20, HasParent {
  override var fsType: String? = null
  override var readOnly: Boolean? = null
  override var secretRef: ObjectReference_core_v1_k8s1_20? = null
