...
@K8sDslMarker
interface IngressBackend_networking_k8s_io_v1_k8s1_20: K8sManifest {
...
specified, a service.Name and service.Port must not be specified. This is a mutually exclusive setting with "Service". */
  val resource: TypedLocalObjectReference_core_v1_k8s1_20?
  /** Service references a Service as a Backend. This is a mutually exclusive setting with "Resource". */
  val service: IngressServiceBackend_networking_k8s_io_v1_k8s1_20?
}