...
class ManagedFieldsEntry_meta_v1_k8s1_20Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: ManagedFieldsEntry_meta_v1_k8s1_20, HasParent {
  override var apiVersion: String? = null
  override var fieldsType: String? = null
  override var fieldsV1: FieldsV1_meta_v1_k8s1_20? = null
  override var manager: String? = null
  override var operation: String? = null
  override var time: Time_meta_v1_k8s1_20? = null
}