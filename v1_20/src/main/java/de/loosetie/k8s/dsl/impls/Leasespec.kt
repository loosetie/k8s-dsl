...
class Leasespec_coordination_k8s_io_v1_k8s1_20Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Leasespec_coordination_k8s_io_v1_k8s1_20, HasParent {
  override var acquireTime: MicroTime_meta_v1_k8s1_20? = null
  override var holderIdentity: String? = null
  override var leaseDurationSeconds: Int? = null
  override var leaseTransitions: Int? = null
  override var renewTime: MicroTime_meta_v1_k8s1_20? = null
}