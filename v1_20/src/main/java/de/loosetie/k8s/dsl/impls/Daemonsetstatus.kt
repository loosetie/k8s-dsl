...
class Daemonsetstatus_apps_v1_k8s1_20Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Daemonsetstatus_apps_v1_k8s1_20, HasParent {
  override var collisionCount: Int? = null
  override var conditions: List<DaemonSetCondition_apps_v1_k8s1_20>? = null
