...
class Deploymentstatus_apps_v1_k8s1_20Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Deploymentstatus_apps_v1_k8s1_20, HasParent {
  override var availableReplicas: Int? = null
  override var collisionCount: Int? = null
  override var conditions: List<DeploymentCondition_apps_v1_k8s1_20>? = null
