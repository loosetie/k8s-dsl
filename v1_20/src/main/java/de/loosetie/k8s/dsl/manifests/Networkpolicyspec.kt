...
@K8sDslMarker
interface Networkpolicyspec_networking_k8s_io_v1_k8s1_20: K8sManifest {
...
default). This field is beta-level in 1.8 */
  val egress: List<NetworkPolicyEgressRule_networking_k8s_io_v1_k8s1_20>?
...
pods it selects are isolated by default) */
  val ingress: List<NetworkPolicyIngressRule_networking_k8s_io_v1_k8s1_20>?
...
matches all pods in this namespace. */
  val podSelector: LabelSelector_meta_v1_k8s1_20?
