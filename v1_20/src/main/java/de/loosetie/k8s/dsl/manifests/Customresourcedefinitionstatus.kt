...
@K8sDslMarker
interface Customresourcedefinitionstatus_apiextensions_k8s_io_v1_k8s1_20: K8sManifest {
  /** acceptedNames are the names that are actually being used to serve discovery. They may be different than the names in
spec. */
  val acceptedNames: CustomResourceDefinitionNames_apiextensions_k8s_io_v1_k8s1_20?
  /** conditions indicate state for particular aspects of a CustomResourceDefinition */
  val conditions: List<CustomResourceDefinitionCondition_apiextensions_k8s_io_v1_k8s1_20>?
