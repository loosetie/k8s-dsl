...
@K8sDslMarker
interface Persistentvolumespec_core_v1_k8s1_20: K8sManifest {
...
the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore */
  ...
  val azureFile: AzureFilePersistentVolumeSource_core_v1_k8s1_20?
  /** A description of the persistent volume's resources and capacity. More info:
https://kubernetes.io/docs/concepts/storage/persistent-volumes#capacity */
  @K8sDslMarker var capacity: Any?
  /** CephFS represents a Ceph FS mount on the host that shares a pod's lifetime */
  val cephfs: CephFSPersistentVolumeSource_core_v1_k8s1_20?
  /** Cinder represents a cinder volume attached and mounted on kubelets host machine. More info:
https://examples.k8s.io/mysql-cinder-pd/README.md */
  val cinder: CinderPersistentVolumeSource_core_v1_k8s1_20?
...
https://kubernetes.io/docs/concepts/storage/persistent-volumes#binding */
  val claimRef: ObjectReference_core_v1_k8s1_20?
  /** CSI represents storage that is handled by an external CSI driver (Beta feature). */
  val csi: CSIPersistentVolumeSource_core_v1_k8s1_20?
  /** FC represents a Fibre Channel resource that is attached to a kubelet's host machine and then exposed to the pod. */
  val fc: FCVolumeSource_core_v1_k8s1_20?
  /** FlexVolume represents a generic volume resource that is provisioned/attached using an exec based plugin. */
  val flexVolume: FlexPersistentVolumeSource_core_v1_k8s1_20?
...
info: https://examples.k8s.io/volumes/glusterfs/README.md */
  val glusterfs: GlusterfsPersistentVolumeSource_core_v1_k8s1_20?
...
Provisioned by an admin. */
  val iscsi: ISCSIPersistentVolumeSource_core_v1_k8s1_20?
  /** Local represents directly-attached storage with node affinity */
  val local: LocalVolumeSource_core_v1_k8s1_20?
...
scheduling of pods that use this volume. */
  val nodeAffinity: VolumeNodeAffinity_core_v1_k8s1_20?
...
https://examples.k8s.io/volumes/rbd/README.md */
  val rbd: RBDPersistentVolumeSource_core_v1_k8s1_20?
  /** ScaleIO represents a ScaleIO persistent volume attached and mounted on Kubernetes nodes. */
  val scaleIO: ScaleIOPersistentVolumeSource_core_v1_k8s1_20?
...
info: https://examples.k8s.io/volumes/storageos/README.md */
  val storageos: StorageOSPersistentVolumeSource_core_v1_k8s1_20?
