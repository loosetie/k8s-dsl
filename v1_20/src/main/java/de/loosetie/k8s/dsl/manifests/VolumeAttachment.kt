...
@K8sDslMarker
interface VolumeAttachment_storage_k8s_io_v1_k8s1_20: K8sTopLevel, HasMetadata {
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
  ...
  val spec: Volumeattachmentspec_storage_k8s_io_v1_k8s1_20
  /** Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the
external-attacher. */
  val status: Volumeattachmentstatus_storage_k8s_io_v1_k8s1_20?
}