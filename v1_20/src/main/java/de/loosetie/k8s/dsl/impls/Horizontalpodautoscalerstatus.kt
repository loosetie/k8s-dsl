...
class Horizontalpodautoscalerstatus_autoscaling_v1_k8s1_20Impl(
  @JsonIgnore
  override val parent: K8sManifest? = null
)
: Horizontalpodautoscalerstatus_autoscaling_v1_k8s1_20, HasParent {
  ...
  override var lastScaleTime: Time_meta_v1_k8s1_20? = null
