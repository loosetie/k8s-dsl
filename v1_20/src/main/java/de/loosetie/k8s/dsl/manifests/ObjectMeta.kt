...
@K8sDslMarker
interface ObjectMeta_meta_v1_k8s1_20: K8sManifest {
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
  val creationTimestamp: Time_meta_v1_k8s1_20?
...
https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata */
  val deletionTimestamp: Time_meta_v1_k8s1_20?
...
that the workflow used when modifying the object. */
  val managedFields: List<ManagedFieldsEntry_meta_v1_k8s1_20>?
...
controller field set to true. There cannot be more than one managing controller. */
  val ownerReferences: List<OwnerReference_meta_v1_k8s1_20>?
