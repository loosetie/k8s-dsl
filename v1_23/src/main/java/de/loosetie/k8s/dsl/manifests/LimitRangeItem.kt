...
@K8sDslMarker
interface LimitRangeItem_core_v1: K8sManifest {
...
divided by request is less than or equal to the enumerated value; this represents the max burst for the named resource. */
  ...
  /** Type of resource that this limit applies to. Possible enum values: - `"Container"` Limit that applies to all containers
in a namespace - `"PersistentVolumeClaim"` Limit that applies to all persistent volume claims in a namespace - `"Pod"`
